 ...
 public static string MINofPO = "";
            ...
            try
            {
                ...
                else
                {
                    AddQuery = " and ledcodeDr='" + PurchaseAccount + "'";
                            ...
                            string ds =_Dbtask.ExecuteScalarAzureServer("select * from TblTransactionReceipt where ReptCode='" + PreIssuecode + "' and RecptType='" + TempVtype + "' " + AddQuery + "");
                if (ds != "")
                {
                    Ds2 = _Dbtask.ExecuteQueryAzureServer("select * from TblTransactionReceipt where ReptCode='" + PreIssuecode + "' and RecptType='" + TempVtype + "' " + AddQuery + "");
                ...
                if (Ds2.Tables[0].Rows.Count >0)
                {
                  ...
                  // }
                   ...
                   lblledgertext.Text = _Dbtask.znllString( CommonClass._Ledger.GetspecifField("mobile", _Dbtask.znllString(TxtAccount.textBox1.Tag)));
                    ...
                    string dsrecpt = _Dbtask.ExecuteScalarAzureServer("select * from TblReceiptDetails where RecptCode='" + PreIssuecode + "'and vtype='" + TempVtype + "' and ledcode='" + PurchaseAccount + "' order by slno asc");
                    if (dsrecpt !="")
                    {
                        Ds = _Dbtask.ExecuteQueryAzureServer("select * from TblReceiptDetails where RecptCode='" + PreIssuecode + "'and vtype='" + TempVtype + "' and ledcode='" + PurchaseAccount + "' order by slno asc");
                    ...
                    for (int i = 0; i < Ds.Tables[0].Rows.Count; i++)
                    {
                        ...
                        gridmain.Rows[i].Cells["clnitemname"].Value = _Dbtask.ExecuteScalarAzureServer("select itemname from tblitemmaster where itemid='" + tempitemid + "'");
                       }
                        else
                        {
        ...
        public void PreIssueTransactions(long vno, bool Isinenter, string TempVtype, bool Refilling)
        {
            ...
            if (Ds2.Tables[0].Rows.Count > 0)
            {
                ...
                string dsissue = _Dbtask.ExecuteScalarAzureServer("select * from tblissuedetails where issuecode='" + PreIssuecode + "'and vtype='" + TempVtype + "' " + Addquery2 + " order by slno asc");
                if (dsissue != "")
                {
                    Ds = _Dbtask.ExecuteQueryAzureServer("select * from tblissuedetails where issuecode='" + PreIssuecode + "'and vtype='" + TempVtype + "' " + Addquery2 + " order by slno asc");
        ...
        public void GetVno()
        {
            ...
            if (Vtype == "PI" || Vtype == "PO")
            {
                _TransactionReceipt.PVnoAzure(PurchaseAccount.ToString(), Vtype);
                if (_TransactionReceipt.pvno != "")
                {
                ...
                txtvno.Tag = _TransactionReceipt.IdPurchaseFuAzure(PurchaseAccount, Vtype);
                _ReceiptDetails.RcptCodeLng = Convert.ToInt64(txtvno.Tag);
                _TransactionReceipt.RcptCodeLng = Convert.ToInt64(txtvno.Tag);
                _Batch.Recptcode = Convert.ToString(txtvno.Tag); ;
                _Inventory.Vcode = txtvno.Tag.ToString();
            ...
            {
                _BusinessIssue.PVno2Server(PurchaseAccount.ToString(), "PR");
                if (_BusinessIssue.Pvno != "")
                {
                ...
                txtvno.Tag = _BusinessIssue.IdSalesFuAzure(PurchaseAccount, "PR");
                TxtRefName.Text = txtvno.Tag.ToString();
                _IssueDetails.IssueCodeLng = Convert.ToInt64(txtvno.Tag);
                _BusinessIssue.IssueCodeLng = Convert.ToInt64(txtvno.Tag);
                _Inventory.Vcode = txtvno.Tag.ToString();
        ...
        public void getmaxvnonumber()
        {
            ...
            if (Vtype == "PI")
            {
                ...
                CommonClass._GenF.checkmaxtableandparamvalAzure(CommonClass._Paramlist.GetParamvalueazure("MaxofPI"), vnoname);


                txtvno.Tag = CommonClass._Paramlist.GetParamvalueazure("MaxofPI");
                txtvno.Text = CommonClass._Paramlist.GetParamvalueazure("MaxofPI");
            ...
            {
                vnoname = "MaxofPR";
                CommonClass._GenF.checkmaxtableandparamvalAzure(CommonClass._Paramlist.GetParamvalueazure("MaxofPR"), vnoname);
                txtvno.Tag = CommonClass._Paramlist.GetParamvalueazure("MaxofPR");
                txtvno.Text = CommonClass._Paramlist.GetParamvalueazure("MaxofPR");
        ...
        public void NextgInitialize()
        {
                    ...
                    if (gridmain.Rows[i].Tag.ToString() == "1")
                    {
                        try
                        {
                           ...
                           if(StrSlno !="")
                            ...
                            drInv["Ledcode"] = PurchaseAccount;
                            drInv["freepre"] = free;

                            drInv["Slno"] = Slno;
                            drInv["UC"] = Convrt;
                            drInv["Exdate"] = DtEdate;
                            drInv["Vtype"] = Vtype;
                            ...
                            if (Vtype == "PI" || Vtype == "PR")
                            {
                                ...
                                {
                                    getmaxvnonumber();
                                    CommonClass._Paramlist.updateparamvalueVNOAzure(vnoname, Convert.ToInt32(txtvno.Tag));
                                }
                            ...
                            if (Vtype == "PI" || Vtype == "PO")
                            {
                                ...
                                drR["TaxRate"] = TaxRate;
                                drR["NetAMT"] = NetAmt;
                                drR["ItemNote"] = Itemnote;
                                drR["ItemNote1"] = Itemnote2;
                                drR["mandate"] = DtMdate;
                                drR["exdate"] = DtEdate;
                                drR["srate"] = Srate;
                                drR["crate"] = Srate;
                                ...
                                drR["mrp"] = Mrp;
                                drR["Ledcode"] = PurchaseAccount;
                                drR["vtype"] = Vtype;

                                drR["Taxper"] = Taxper;
                                drR["exciseduty"] = ExciseDuty;
                                drR["wrate"] = Wrate;


                                drR["billtot"] = _Dbtask.znullDouble(txtbillamount.Text); ;
                            ...
                            if (Vtype == "PR")
                            {
                                ...
                                dr["MultirateId"] = Convert.ToInt16(MRateid);
                                dr["Qty"] = qty;
                                ...
                                dr["NetAmt"] = NetAmt;
                                dr["Itemnote"] = "";
                                dr["Ledcode"] = PurchaseAccount;
                                dr["vtype"] = Vtype;

                                dr["lth"] = Length;
                                dr["wth"] = Width;
                                dr["Slnotracking"] = SlTracking;
                                dr["Exdate"] = DtEdate;
                                dr["Itemnote2"] = Itemnote2;
                                dr["billtot"] = Convert.ToDouble(txtbillamount.Text);
            ...
            BulkInsertTableToAzure(dtInventory, "tblinventory");
            if (Vtype == "PI" || Vtype == "PO")
            {
                BulkInsertTableToAzure(dtBulkReceipt, "tblreceiptdetails");
            }
            if (Vtype == "PR")
            {
                BulkInsertTableToAzure(dtBulk, "tblissuedetails");
            }
        ...
        public void BulkInsertTableToAzure(DataTable dt, string table)
        {
            _Dbtask.setconstr();
        ...
        public void DeleteVoucherAzure()
        {
            if (Vtype == "PI" || Vtype == "PO")
            {
                _Dbtask.ExecuteNonQueryAzureServer("delete from tblreceiptdetails where RecptCode='" + txtvno.Tag + "' and Ledcode='" + PurchaseAccount + "' and vtype='" + Vtype + "'");
                _Dbtask.ExecuteNonQueryAzureServer("delete from tbltransactionreceipt where Reptcode='" + txtvno.Tag + "' and vno='" + txtvno.Text + "' and Recpttype='" + Vtype + "' and LedcodeDr='" + PurchaseAccount + "' ");

                if (Vtype == "PI")
                {
                    

                    _Dbtask.ExecuteNonQueryAzureServer("delete from tblinventory where vcode='" + txtvno.Tag + "' and Ledcode='" + PurchaseAccount + "' and Purchase !=0");
                    _Dbtask.ExecuteNonQueryAzureServer("delete from tblgeneralledger where vtype='PI' and vno='" + txtvno.Text + "' and refno='" + PurchaseAccount.ToString() + "'");
                    /*For Batch */
                    /*For Agent*/
                    _Dbtask.ExecuteNonQueryAzureServer("delete from tblgeneralledger where vtype='PI' and vno='" + txtvno.Text + "' and Ledcode='" + agentid + "' and Refno='" + PurchaseAccount + "'");
                    /*For Employee*/
                    _Dbtask.ExecuteNonQueryAzureServer("delete from tblgeneralledger where vtype='PI' and vno='" + txtvno.Text + "' and Ledcode='" + StaffId + "' and Refno='" + PurchaseAccount + "'");

                    /*For Discount*/
                    _Dbtask.ExecuteNonQueryAzureServer("delete from tblgeneralledger where vtype='PI' and vno='" + txtvno.Text + "' and Ledcode='6' and Refno='" + PurchaseAccount + "'");
                    /*For VAT*/
                    _Dbtask.ExecuteNonQueryAzureServer("delete from tblgeneralledger where vtype='PI' and vno='" + txtvno.Text + "' and Ledcode='8' and Refno='" + PurchaseAccount + "'");
                    /*For CST*/
                    _Dbtask.ExecuteNonQueryAzureServer("delete from tblgeneralledger where vtype='PI' and vno='" + txtvno.Text + "' and Ledcode='25' and Refno='" + PurchaseAccount + "'");

                    _Dbtask.ExecuteNonQueryAzureServer("delete from tblgeneralledger where vtype='PI' and vno='" + txtvno.Text + "' and Ledcode='10' and Refno='" + PurchaseAccount + "'");


                 //   _Dbtask.ExecuteNonQueryAzureServer("delete from tblpurchasebillsett where vtype='PI' and vno='" + txtvno.Text + "' ");



                    Ds = _Dbtask.ExecuteQueryAzureServer("select * FROM TBLGENERALLEDGER where vtype='P' and slno='" + txtvno.Text + "'  and refno='" + PurchaseAccount + "' ");

                    if (Ds.Tables[0].Rows.Count > 0)
                    {

                        _Dbtask.ExecuteNonQueryAzureServer("delete FROM TBLGENERALLEDGER where vtype='P' and slno=" + txtvno.Text + " " +
            ...
            else if (Vtype == "PR")
            {
                ...
                _Dbtask.ExecuteNonQueryAzureServer("delete from tblinventory where vcode='" + txtvno.Tag + "' and " + tempinvvty + " !=0 and ledcode='" + PurchaseAccount + "'");
                _Dbtask.ExecuteNonQueryAzureServer("delete from tblissuedetails where issuecode='" + txtvno.Tag + "' and Ledcode='" + PurchaseAccount + "' and vtype='" + Vtype + "'");
                _Dbtask.ExecuteNonQueryAzureServer("delete from tblgeneralledger where vtype='" + Vtype + "' and vno='" + txtvno.Text + "' and Refno='" + PurchaseAccount + "'");

                _Dbtask.ExecuteNonQueryAzureServer("delete from tblbusinessissue where issuecode='" + txtvno.Tag + "' and vno='" + txtvno.Text + "' and issuetype='" + Vtype + "' and Ledcodecr='" + PurchaseAccount + "'");

                /*For Agent*/
                _Dbtask.ExecuteNonQueryAzureServer("delete from tblgeneralledger where vtype='" + Vtype + "' and vno='" + txtvno.Text + "' and Ledcode='" + agentid + "' and Refno='" + PurchaseAccount + "'");
                /*For Employee*/
                _Dbtask.ExecuteNonQueryAzureServer("delete from tblgeneralledger where vtype='" + Vtype + "' and vno='" + txtvno.Text + "' and Ledcode='" + StaffId + "' and Refno='" + PurchaseAccount + "'");

                /*For Other Expense*/
                _Dbtask.ExecuteNonQueryAzureServer("delete from tblgeneralledger where vtype='" + Vtype + "' and vno='" + txtvno.Text + "' and Ledcode='26' and Refno='" + PurchaseAccount + "'");
                /*For Discount*/
                _Dbtask.ExecuteNonQueryAzureServer("delete from tblgeneralledger where vtype='" + Vtype + "' and vno='" + txtvno.Text + "' and Ledcode='7' and Refno='" + PurchaseAccount + "'");
                /*For Tax*/
                _Dbtask.ExecuteNonQueryAzureServer("delete from tblgeneralledger where vtype='" + Vtype + "' and vno='" + txtvno.Text + "' and Ledcode='9' and Refno='" + PurchaseAccount + "'");
                /*For CST*/
                _Dbtask.ExecuteNonQueryAzureServer("delete from tblgeneralledger where vtype='" + Vtype + "' and vno='" + txtvno.Text + "' and Ledcode='24' and Refno='" + PurchaseAccount + "'");

              //  _Dbtask.ExecuteNonQueryAzureServer("delete from tblPRbillsett where vtype='PR' and vno='" + txtvno.Text + "' ");
