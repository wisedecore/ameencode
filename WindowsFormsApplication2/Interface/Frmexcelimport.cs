...
namespace WindowsFormsApplication2
{
    public partial class Frmexcelimport : Form
    {
        ...
        {
            _dbtask.ExecuteNonQueryAzureServer("delete from tblitemcategory");
            _dbtask.ExecuteNonQueryAzureServer("delete from tblitemmaster");
            _dbtask.ExecuteNonQueryAzureServer("delete from tblbatch");
            _dbtask.ExecuteNonQueryAzureServer("delete from tblinventory");
            _dbtask.ExecuteNonQueryAzureServer("delete from tblaccountgroup");
            _dbtask.ExecuteNonQueryAzureServer("delete from tblaccountledger");
            _dbtask.ExecuteNonQueryAzureServer("delete from tblparamlist");
            _dbtask.ExecuteNonQueryAzureServer("delete from tblbusinessissue");
            _dbtask.ExecuteNonQueryAzureServer("delete from tblissuedetails");
            _dbtask.ExecuteNonQueryAzureServer("delete from tblgeneralledger");
            _dbtask.ExecuteNonQueryAzureServer("delete from tblinventory");
            _dbtask.ExecuteNonQueryAzureServer("delete from tbltransactionreceipt");
            _dbtask.ExecuteNonQueryAzureServer("delete from tblreceiptdetails");
            _dbtask.ExecuteNonQueryAzureServer("delete from tbluserdetails");
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            deletefromAzure();
            _dbtask.setconstr();
            string sourceConnectionString = _dbtask._ConnectionString;

            // Azure SQL Database connection string
            string destinationConnectionString = _dbtask._ConnectionStringServer;

            // List of tables to transfer (source and destination table names assumed to be the same)
        ...
        {"tblitemcategory",
            ...
            foreach (string tableName in tablesToTransfer)
            {
                Console.WriteLine($"Transferring table: {tableName}");
                TransferTable(sourceConnectionString, destinationConnectionString, tableName);
            }

            MessageBox.Show("All tables transferred successfully.");
        }
        public void deletefromLocalSql()
        {
            _dbtask.ExecuteNonQuery("delete from tblitemcategory");
            _dbtask.ExecuteNonQuery("delete from tblitemmaster");
            _dbtask.ExecuteNonQuery("delete from tblbatch");
            _dbtask.ExecuteNonQuery("delete from tblinventory");
            _dbtask.ExecuteNonQuery("delete from tblaccountgroup");
            _dbtask.ExecuteNonQuery("delete from tblaccountledger");
            _dbtask.ExecuteNonQuery("delete from tblparamlist");
        ...
        private void btnimportserver_Click(object sender, EventArgs e)
        {
            deletefromLocalSql();
            _dbtask.setconstr();
            string sourceConnectionString = _dbtask._ConnectionStringServer;

            // Azure SQL Database connection string
            string destinationConnectionString = _dbtask._ConnectionString;
        ...
        {"tblitemcategory",
            ...
            MessageBox.Show("All tables imported successfully.");
        }

        private void transferchk_CheckedChanged(object sender, EventArgs e)
        {
            if (transferchk.Checked == true)
            {
