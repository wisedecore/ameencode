...
namespace WindowsFormsApplication2
{
    public partial class Frmcash : Form
    {
        ...
        public void GetVno()
        {
            ...
            _generalLedger.IdGeneralLedgerAzure(" where vtype='"+Vtype+"'");
        ...
        public void GetPreviousAzure(string Prevno)
        {
            try
            {
                if (Convert.ToInt64(Prevno) >= 1)
                {
                    ...
                    {
                        Isinotherwindow = true;
                        Ds = _Dbtask.ExecuteQueryAzureServer("select * from tblgeneralledger where vno='" + TempPrevno + "' and vtype='" + Vtype + "' and cramt='0' order by slno asc");

                        if (Ds.Tables[0].Rows.Count == 0 && Convert.ToInt32(Prevno) > 0)
                        {
                            Clear();
                            if (Convert.ToInt32(TempPrevno) < Convert.ToInt32(Generalfunction.getnextidAzure("vno", "tblgeneralledger where vtype='P'")))
                            {
                                txtvno.Text = TempPrevno;
                                EditMode = true;
                        ...
                        {
                            dtdate.Value = Convert.ToDateTime(_Dbtask.ExecuteScalarAzureServer("select vdate from tblgeneralledger where vno='" + TempPrevno + "' and vtype='" + Vtype + "' and dbamt='0' and ledcode !=7"));
                            ComLedger.SelectedValue = _Dbtask.ExecuteScalarAzureServer("select ledcode from  tblgeneralledger where vno='" + TempPrevno + "' and vtype='" + Vtype + "' and dbamt='0'");
                            txtvno.Text = TempPrevno;
                            string Emp = _Dbtask.ExecuteScalarAzureServer("select employee from tblgeneralledger where vno='" + TempPrevno + "' and vtype='" + Vtype + "' and dbamt='0'");
                            string RefNo = _Dbtask.ExecuteScalarAzureServer("select refno from tblgeneralledger where vno='" + TempPrevno + "' and vtype='" + Vtype + "' and dbamt='0'");
                            string Naration = _Dbtask.ExecuteScalarAzureServer("select naration from tblgeneralledger where vno='" + TempPrevno + "' and vtype='" + Vtype + "' and dbamt='0'");
                            string DiscAmt = _Dbtask.ExecuteScalarAzureServer("select cramt from  tblgeneralledger where vno='" + TempPrevno + "' and vtype='" + Vtype + "' and dbamt='0' and Ledcode='6'");
                    ...
                    {
                        Isinotherwindow = true;
                        Ds = _Dbtask.ExecuteQueryAzureServer("select * from tblgeneralledger where vno='" + TempPrevno + "' and vtype='" + Vtype + "' and Dbamt='0' order by slno asc");
                        if (Ds.Tables[0].Rows.Count == 0)
                        {
                            Clear();
                            if (Convert.ToInt32(TempPrevno) < Convert.ToInt32(Generalfunction.getnextidAzure("vno", "tblgeneralledger where vtype='R'")))
                            {
                                txtvno.Text = TempPrevno;
                                EditMode = true;
                        ...
                        {
                            dtdate.Value = Convert.ToDateTime(_Dbtask.ExecuteScalarAzureServer("select vdate from  tblgeneralledger where vno='" + TempPrevno + "' and vtype='" + Vtype + "' and cramt='0'"));
                            ComLedger.SelectedValue = _Dbtask.ExecuteScalarAzureServer("select ledcode from  tblgeneralledger where vno='" + TempPrevno + "' and vtype='" + Vtype + "' and cramt='0' and ledcode !=7");
                            txtvno.Text = TempPrevno;
                            string Emp = _Dbtask.ExecuteScalarAzureServer("select employee from  tblgeneralledger where vno='" + TempPrevno + "' and vtype='" + Vtype + "' and cramt='0'");
                            string RefNo = _Dbtask.ExecuteScalarAzureServer("select refno from  tblgeneralledger where vno='" + TempPrevno + "' and vtype='" + Vtype + "' and cramt='0'");
                            string Naration = _Dbtask.ExecuteScalarAzureServer("select naration from  tblgeneralledger where vno='" + TempPrevno + "' and vtype='" + Vtype + "' and cramt='0'");
                            string DiscAmt = _Dbtask.ExecuteScalarAzureServer("select dbamt from  tblgeneralledger where vno='" + TempPrevno + "' and vtype='" + Vtype + "' and cramt='0' and Ledcode='7'");
                            if (Emp != "")
                                ComStaff.SelectedValue = Emp;
                            TxtRefNo.Text = RefNo;
                            TxtNarration.Text = Naration;
        ...
        public void DeleteVoucherAzure()
        {
            if (EditMode == true)
            {
                if (CommonClass._UserDetails.Permited() == true)
                {
                    ...
                    _Dbtask.ExecuteNonQueryAzureServer("Delete from tblgeneralledger where vtype='" + Vtype + "' and vno='" + txtvno.Text + "'");
                    //_Dbtask.ExecuteNonQueryAzureServer("Delete from tblbillsett where vtype='" + Vtype + "' and vno='" + txtvno.Text + "'");
                    //_Dbtask.ExecuteNonQueryAzureServer("Delete from tblSRbillsett where vtype='" + Vtype + "' and vno='" + txtvno.Text + "'");

                    //_Dbtask.ExecuteNonQueryAzureServer("Delete from tblPRbillsett where vtype='" + Vtype + "' and vno='" + txtvno.Text + "'");
                    //_Dbtask.ExecuteNonQueryAzureServer("Delete from tblpurchasebillsett where vtype='" + Vtype + "' and vno='" + txtvno.Text + "'");
        ...
        private void CmdBack_Click(object sender, EventArgs e)
           ...
           // GetPrevious((Convert.ToInt64(txtvno.Text) - 1).ToString());
            GetPreviousAzure((Convert.ToInt64(txtvno.Text) - 1).ToString());
        }
        ...
        private void txtentervno_PreviewKeyDown(object sender, PreviewKeyDownEventArgs e)
        {
            try
            {
                if (e.KeyValue == 13)
                    ...
                    GetPreviousAzure(txtentervno.Text);
                }
            }
            catch
            {
