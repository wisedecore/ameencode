    ...
    class Clssales
    {
       /*For Settings*/
        ...
        public DataSet ShowSalesReport(string Where,string PVtype)
        {
            ...
            if (onlinecheck == true)
            {
                CommonClass.Ds1 = _Dbtask.ExecuteQueryAzureServer("SELECT     TblBusinessIssue.VNo, TblBusinessIssue.uid as 'User', TblBusinessIssue.IssueDate as Date, TblBusinessIssue.Tename as Party, TblBusinessIssue.IssueCode" +
