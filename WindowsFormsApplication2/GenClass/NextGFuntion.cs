...
namespace WindowsFormsApplication2
{
    class NextGFuntion
    {
      ...
      //  DateTimePicker DtS = new DateTimePicker();
        ...
        public bool KnowTableexstingAzureServer(string TableName)
        {
            Ds = _Dbtask.ExecuteQueryAzureServer("SELECT * " +
                    " FROM INFORMATION_SCHEMA.TABLES " +
                    " where  TABLE_NAME = '" + TableName + "'");
            if (Ds.Tables[0].Rows.Count > 0)
                return true;
        ...
        public bool KnowprocedureexistingAzureServer(string procedure)
        {
            DataSet dsProc = _Dbtask.ExecuteQueryAzureServer(
       "SELECT * FROM INFORMATION_SCHEMA.ROUTINES " +
       "WHERE ROUTINE_TYPE = 'PROCEDURE' AND ROUTINE_NAME = '" + procedure + "'");
        ...
        public void RefreshProcedureAzure()
        {
...
"(@cid,@cname) END";
 ...
 " END";
            ...
            sql = "alter   PROCEDURE [dbo].[InsertLedger]" +
                    ...
                    " @schemeID  nvarchar(500) ," +
                    " @StreetName nvarchar(500) ," +
                    " @AdditionalStreetName  nvarchar(500) ," +
                    " @BuildingNumber nvarchar(500) ," +
                    " @CountrySubentity nvarchar(500) ," +
                    " @CitySubdivisionName  nvarchar(500) ," +
                    " @IdentificationCode  nvarchar(500) ," +
                    " @RegistrationName  nvarchar(500) ," +
                    ...
                    " AS" +
                    " BEGIN" +
                    " insert into   TblAccountLedger (lid,Lname,LAliasName,AGroupId,Address,phone,mobile,DiscPer,TaxRegNo,Email,CreditDays,CreditLimit,Other,area,balance,commision,cplan,lstatus,lstatus2,cst,cpbalance,usecard,customercode,cityy,Lcountryname,postcode,LDistrict,schemeID,StreetName,AdditionalStreetName,BuildingNumber,CountrySubentity,CitySubdivisionName,IdentificationCode,RegistrationName,CompanyID) " +
                    "values (@Lid,@Lname,@LaliasName,@AGroupId,@Address,@Phone,@Mobile,@DiscPer,@TaxregNo,@email,@CreditDays,@CreditLimit,@Other,@area,@balance,@commision,@cplan,@lstatus,@lstatus2,@cst,@cpbalance,@usecard,@customercode,@cityy,@Lcountryname,@postcode,@LDistrict,@schemeID,@StreetName,@AdditionalStreetName,@BuildingNumber,@CountrySubentity,@CitySubdivisionName,@IdentificationCode,@RegistrationName,@CompanyID)" +
    ...
    " END";
            _Dbtask.ExecuteNonQueryAzureServer(sql);
            Ds = _Dbtask.ExecuteQueryAzureServer("select * from tblaccountgroup ");
            if (Ds.Tables[0].Rows.Count == 0)
            {
                DefInsertManAccount();
        ...
        public void DefInsertManAccount()
        {
            ...
            if (KnowTableexstingAzureServer("Tblaccountgroup") == true)
            {
                _AccountGroup.AccountGroupIDLng = 1;
                _AccountGroup.GroupNameStr = "Asset";
                _AccountGroup.UnderInt = 4;
                _AccountGroup.InsertAccountsGroupAzure();
            ...
            /*Account Ledger*/
            if (KnowTableexstingAzureServer("tblaccountledger") == true)
            {
                _Ledger.LidLng = 1;
                _Ledger.LNameStr = "Cash";
                _Ledger.GidLng = 25;
                _Ledger.InsertLedgerAzure();
        ...
        public void DefInsertParamlist()
        {
...
"(@cid,@cname) END";
 ...
 " END";
    ...
    " END";
        ...
        public void CreateColumnInTable(string TableName, string ColName, string DataType, string InitialValue)
       {
        ...
        public void CreateColumnInTableAzure(string TableName, string ColName, string DataType, string InitialValue)
        {
            sql = " SELECT count(*) AS [Column Exists] FROM SYSOBJECTS  " +
                  " INNER JOIN SYSCOLUMNS ON SYSOBJECTS.ID = SYSCOLUMNS.ID WHERE " +
                  " SYSOBJECTS.NAME = '" + TableName + "' AND SYSCOLUMNS.NAME = '" + ColName + "'";
            string ttemp = _Dbtask.ExecuteScalarAzureServer(sql);
            if (ttemp == "0")
            {
                _Dbtask.ExecuteNonQueryAzureServer("alter table " + TableName + " add " + ColName + " " + DataType);
                _Dbtask.ExecuteNonQueryAzureServer("Update  " + TableName + " Set " + ColName + " = " + InitialValue);
            }
        }
        public static bool IsValueFoundInTable(string Value, string Table, string Field)
       {
        ...
        public void RefreshDbAzureServer()
        {


            if (KnowTableexstingAzureServer("Tblunitsrates") == false)
            {
    ...
    ") ON [PRIMARY]";
            ...
            if (KnowTableexstingAzureServer("Tblcolor") == false)
            {
        ...
        "[cname] [nvarchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL " +
           " ) ON [PRIMARY]";
            ...
            if (KnowTableexstingAzureServer("TblPHASEtwocompanyprofile") == false)
            {
                sql = "CREATE TABLE [dbo].[TblPHASEtwocompanyprofile](" +
                                            "[Workingtype] [nvarchar](1000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL ," +
                                            "[OTP] [nvarchar](1000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL ," +
                                            "[CommonName] [nvarchar](1000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL ," +
                                            "[SerialNumber] [nvarchar](1000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL ," +
                                            "[firmname] [nvarchar](1000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL ," +
                                            "[Branchname] [nvarchar](1000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL ," +
                                            "[countrytext] [nvarchar](1000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL ," +
                                            "[vatnumber] [nvarchar](1000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL ," +
                                            "[location] [nvarchar](1000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL ," +
                                            "[Industry] [nvarchar](1000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL ," +
                                            "[CSR] [nvarchar](1000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL ," +
                                            "[PrtKEY] [nvarchar](1000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL ," +
                                            "[PblKEY] [nvarchar](1000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL ," +
                                            "[ScrtKEY] [nvarchar](1000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL " +
            ...
            if (KnowTableexstingAzureServer("TblAMCdetails") == false)
            {
            ...
            if (KnowTableexstingAzureServer("Tbltaillor") == false)
            {
 ...
 " ) ON [PRIMARY]";
            ...
            if (KnowTableexstingAzureServer("TbltaillorDetails") == false)
            {
           ...
           " ) ON [PRIMARY]";
            ...
            if (KnowTableexstingAzureServer("Tblicon") == false)
            {
     ...
     " ) ON [PRIMARY]";
            ...
            if (KnowTableexstingAzureServer("Tblarea") == false)
            {
       ...
       " ) ON [PRIMARY]";
            ...
            if (KnowTableexstingAzureServer("Tblcommision") == false)
            {
          ...
          " ) ON [PRIMARY]";
            ...
            /*For dress making*/
            if (KnowTableexstingAzureServer("Tbldressmaster") == false)
            {
            ...
            if (KnowTableexstingAzureServer("tblattendancemain") == false)
            {
            ...
            if (KnowTableexstingAzureServer("tblattendancedetail") == false)
            {
            ...
            /********************************************************/
            if (KnowTableexstingAzureServer("tblbillsett") == false)
            {
            ...
            if (KnowTableexstingAzureServer("Tblremainder") == false)
            {
            ...
            if (KnowTableexstingAzureServer("Tblpartyproject") == false)
            {
            ...
            if (KnowTableexstingAzureServer("Tblpricecode") == false)
            {
            ...
            if (KnowTableexstingAzureServer("Tblchqreceived") == false)
            {
            ...
            if (KnowTableexstingAzureServer("tblUnitcreation") == false)
            {
            ...
            if (KnowTableexstingAzureServer("tblbaseunit") == false)
            {
            ...
            /*For VoucherType*/
            if (KnowTableexstingAzureServer("tblVoucherType") == false)
            {
            ...
            /*For Repacking*/
            if (KnowTableexstingAzureServer("tblmenus") == false)
            {
            ...
            if (KnowTableexstingAzureServer("tblRepacking") == false)
            {
            ...
            /*For RepackingDetails*/
            if (KnowTableexstingAzureServer("TblRepackingDetails") == false)
            {
            ...
            /*For  /*For TempContacts */
            if (KnowTableexstingAzureServer("tbltempcontact") == false)
            {
...
") ON [PRIMARY]";
            ...
            //SerialNO Tracking*/
            if (KnowTableexstingAzureServer("tblslnotracking") == false)
            {
...
") ON [PRIMARY]";
            ...
            /*Size Master */
            if (KnowTableexstingAzureServer("tblcustomerpoint") == false)
            {
...
") ON [PRIMARY]";
            ...
            /*Size Master */
            if (KnowTableexstingAzureServer("Tblsizes") == false)
            {
            ...
            /*Size Detail */
            if (KnowTableexstingAzureServer("TblsizesDetail") == false)
            {
            ...
            if (KnowTableexstingAzureServer("Tblproductsett") == false)
            {
            ...
            if (KnowTableexstingAzureServer("Tblproductsettdetail") == false)
            {
            ...
            if (KnowTableexstingAzureServer("Tblissueproduct") == false)
            {
            ...
            if (KnowTableexstingAzureServer("Tblissueproductdetail") == false)
            {
            ...
            if (KnowTableexstingAzureServer("Tblreceivedproduct") == false)
            {
            ...
            if (KnowTableexstingAzureServer("Tblreceivedproductdetail") == false)
            {
            ...
            /*************************************************/
            /*Account Group*/
            if (KnowTableexstingAzureServer("TblAccountGroup") == false)
            {
...
//            if (KnowTableexstingAzureServer("CheckUser") == false)
//            {

//                sql = "CREATE TABLE [dbo].[CheckUser]" +
...
//            }
            /*Account Ledger*/
            if (KnowTableexstingAzureServer("TblAccountLedger") == false)
            {
...
"([Lid] ASC)WITH (PAD_INDEX  = OFF, IGNORE_DUP_KEY = OFF) ON [PRIMARY]) ON [PRIMARY]";
            ...
            /*Agent*/
            if (KnowTableexstingAzureServer("TblAgent") == false)
            {
    ...
    "[Post] [int] NULL) ON [PRIMARY]";
            ...
            if (KnowTableexstingAzureServer("TblBusinessIssue") == false)
            {
...
") ON [PRIMARY]";
            ...
            if (KnowTableexstingAzureServer("TblCompanyMaster") == false)
            {
    ...
    "[TRN] [nvarchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL" +
            ...
            if (KnowTableexstingAzureServer("TblDepartment") == false)
            {
            ...
            /*Depot*/
            if (KnowTableexstingAzureServer("TblDepot") == false)
            {
    ...
    "[Description] [nvarchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL) ON [PRIMARY]";
            ...
            /*Employeemaster*/
            if (KnowTableexstingAzureServer("TblEmployeemaster") == false)
            {
...
"	[Commi] [decimal](18, 5) NULL) ON [PRIMARY]";
            ...
            /*GeneralLedger*/
            if (KnowTableexstingAzureServer("TblGeneralLedger") == false)
            {
...
"   [RecvdAmt] decimal(18,5)" +
          "  ) ON [PRIMARY]";
            ...
            /*Internel Transfer*/
            if (KnowTableexstingAzureServer("TblInternelTransfer") == false)
            {
...
"	[Remarks] [nvarchar](200) COLLATE SQL_Latin1_General_CP1_CI_AS NULL) ON [PRIMARY]";
            ...
            /*Inventory*/
            if (KnowTableexstingAzureServer("TblInventory") == false)
            {
            ...
            if (KnowTableexstingAzureServer("TblIssuedetails") == false)
            {
...
" ) ON [PRIMARY]";
            ...
            if (KnowTableexstingAzureServer("TblItemCategory") == false)
            {
...
") ON [PRIMARY]";
            ...
            if (KnowTableexstingAzureServer("TblItemMaster") == false)
            {
...
") ON [PRIMARY]";
            ...
            if (KnowTableexstingAzureServer("TblManufacturer") == false)
            {
...
"	[Phone] [nvarchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL) ON [PRIMARY]";
            ...
            /*Multi Rates*/
            if (KnowTableexstingAzureServer("TblMultiRates") == false)
            {
...
") ON [PRIMARY]";
            ...
            if (KnowTableexstingAzureServer("TblMultiUnits") == false)
            {
...
") ON [PRIMARY]";
            ...
            if (KnowTableexstingAzureServer("Tblparamlist") == false)
            {
...
") ON [PRIMARY]";
            ...
            /*Product Rate*/
            if (KnowTableexstingAzureServer("TblProductRate") == false)
            {
...
") ON [PRIMARY]";
            ...
            if (KnowTableexstingAzureServer("TblProductUnits") == false)
            {
...
"	[MRP] [decimal](18, 5) NULL) ON [PRIMARY]";
            ...
            /*Receipt Details*/
            if (KnowTableexstingAzureServer("TblReceiptDetails") == false)
            {
...
" ) ON [PRIMARY]";
            ...
            if (KnowTableexstingAzureServer("TblSAGroup") == false)
            {
...
") ON [PRIMARY]";
            ...
            if (KnowTableexstingAzureServer("TblSlabmaster") == false)
            {
...
") ON [PRIMARY]";
            ...
            /*Transaction Receipt*/
            if (KnowTableexstingAzureServer("TblTransactionReceipt") == false)
            {
...
") ON [PRIMARY]";
            ...
            /*Transfer Details*/
            if (KnowTableexstingAzureServer("TblTransferDetails") == false)
            {
...
"	[SupCode] [nvarchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL) ON [PRIMARY]";
            ...
            /*User Details*/
            if (KnowTableexstingAzureServer("TblUserDetails") == false)
            {
...
") ON [PRIMARY]";
            ...
            /*Batch*/
            if (KnowTableexstingAzureServer("Tblbatch") == false)
            {
...
" ) ON [PRIMARY]";
            ...
            /*Mnu Settings*/
            if (KnowTableexstingAzureServer("Tblmnusettings") == false)
            {
...
" ) ON [PRIMARY]";
            ...
            if (KnowTableexstingAzureServer("tblauditlog") == false)
            {
      ...
      "Description varchar(200) DEFAULT NULL)";
            ...
            CreateColumnInTableAzure("Tblitemmaster", "itemnote", "nvarchar(500)", "''");
            CreateColumnInTableAzure("Tblitemmaster", "Bunit", "nvarchar(500)", "''");
            CreateColumnInTableAzure("tblitemmaster", "Usingmechine", "int", "0");
            CreateColumnInTableAzure("Tblitemmaster", "rackname", "nvarchar(500)", "''");
            CreateColumnInTableAzure("Tblbatch", "Lastrate", "Decimal(18,5)", "0");
            CreateColumnInTableAzure("TblBATCH", "baseU", "nvarchar(500)", "''");
            CreateColumnInTableAzure("tblbatch", "prateperc", "Decimal(18,5)", "0");
            CreateColumnInTableAzure("TBLBATCH", "ONtable", "nvarchar(50)", "'No'");
            CreateColumnInTableAzure("TblItemCategory", "Showinsummery", "nvarchar(50)", "'No'");
            CreateColumnInTableAzure("Tblaccountledger", "customercode", "nvarchar(250)", "''");
            CreateColumnInTableAzure("Tblaccountledger", "cityy", "nvarchar(500)", "''");
            CreateColumnInTableAzure("Tblaccountledger", "Lcountryname", "nvarchar(500)", "''");
            CreateColumnInTableAzure("Tblaccountledger", "postcode", "nvarchar(500)", "''");
            CreateColumnInTableAzure("Tblaccountledger", "LDistrict", "nvarchar(500)", "''");

            CreateColumnInTableAzure("Tblaccountledger", "schemeID", "nvarchar(500)", "''");
            CreateColumnInTableAzure("Tblaccountledger", "StreetName", "nvarchar(500)", "''");
            CreateColumnInTableAzure("Tblaccountledger", "AdditionalStreetName", "nvarchar(500)", "''");

            CreateColumnInTableAzure("Tblaccountledger", "BuildingNumber", "nvarchar(500)", "''");
            CreateColumnInTableAzure("Tblaccountledger", "CountrySubentity", "nvarchar(500)", "''");
            CreateColumnInTableAzure("Tblaccountledger", "CitySubdivisionName", "nvarchar(500)", "''");

            CreateColumnInTableAzure("Tblaccountledger", "IdentificationCode", "nvarchar(500)", "''");
            CreateColumnInTableAzure("Tblaccountledger", "RegistrationName", "nvarchar(500)", "''");
            CreateColumnInTableAzure("Tblaccountledger", "CompanyID", "nvarchar(500)", "''");




            CreateColumnInTableAzure("TblBUSINESSISSUE", "Tmobile", "nvarchar(20)", "''");
            CreateColumnInTableAzure("TblBUSINESSISSUE", "Taddres", "nvarchar(100)", "''");
            CreateColumnInTableAzure("TblBUSINESSISSUE", "Tvat", "nvarchar(50)", "''");
            CreateColumnInTableAzure("TblTRANSACTIONRECEIPT", "Agvno", "nvarchar(500)", "''");
            CreateColumnInTableAzure("TblTRANSACTIONRECEIPT", "Tmobile", "nvarchar(20)", "''");
            CreateColumnInTableAzure("TblTRANSACTIONRECEIPT", "Taddres", "nvarchar(100)", "''");
            CreateColumnInTableAzure("TblTRANSACTIONRECEIPT", "Tvat", "nvarchar(50)", "''");



            CreateColumnInTableAzure("Tblgeneralledger", "RPtaxperc", "Decimal(18,5)", "0");
            CreateColumnInTableAzure("Tblgeneralledger", "RPtaxamt", "Decimal(18,5)", "0");

            CreateColumnInTableAzure("Tblgeneralledger", "RPtaxperc", "Decimal(18,5)", "0");
            CreateColumnInTableAzure("Tblgeneralledger", "RPtaxamt", "Decimal(18,5)", "0");
            CreateColumnInTableAzure("TblBUSINESSISSUE", "vehiclenum", "nvarchar(50)", "''");
            CreateColumnInTableAzure("TblBUSINESSISSUE", "Mtrread", "nvarchar(50)", "''");
            CreateColumnInTableAzure("TblBUSINESSISSUE", "Twopayment", "nvarchar(50)", "''");
            CreateColumnInTableAzure("TblBUSINESSISSUE", "twopayAmt", "Decimal(18,5)", "0");
            CreateColumnInTableAzure("TblBUSINESSISSUE", "LBLaccnt", "nvarchar(500)", "''");
            CreateColumnInTableAzure("Tbltransactionreceipt", "LBLaccnt", "nvarchar(500)", "''");
            CreateColumnInTableAzure("Tbltransactionreceipt", "SIretvno", "nvarchar(500)", "''");
            CreateColumnInTableAzure("Tbltransactionreceipt", "SIretdate", "nvarchar(500)", "''");
            CreateColumnInTableAzure("TblINVENTORY", "Vtype", "nvarchar(50)", "''");
            CreateColumnInTableAzure("Tblbusinessissue", "vehiclename", "nvarchar(500)", "''");
            CreateColumnInTableAzure("Tblbusinessissue", "POnum", "nvarchar(500)", "''");

            CreateColumnInTableAzure("Tblbusinessissue", "Deliverynote", "nvarchar(500)", "''");


            CreateColumnInTableAzure("Tblbusinessissue", "Attention", "nvarchar(500)", "''");

            CreateColumnInTableAzure("Tblbusinessissue", "MRFPRnum", "nvarchar(500)", "''");
            CreateColumnInTableAzure("Tblbusinessissue", "Projcts", "nvarchar(500)", "''");
            CreateColumnInTableAzure("Tblbusinessissue", "Due", "nvarchar(500)", "''");
            CreateColumnInTableAzure("Tblbusinessissue", "Hascode", "nvarchar(500)", "''");
            CreateColumnInTableAzure("Tblbusinessissue", "SaleUID", "nvarchar(500)", "''");
            CreateColumnInTableAzure("tblgeneralledger", "Agvno", "nvarchar(500)", "''");
            CreateColumnInTableAzure("tblissuedetails", "Itemnote2", "nvarchar(50)", "''");
            CreateColumnInTableAzure("Tblissuedetails", "billtot", "Decimal(18,5)", "0");
            CreateColumnInTableAzure("Tblissuedetails", "billtime", "nvarchar(500)", "''");
            CreateColumnInTableAzure("Tblreceiptdetails", "billtot", "Decimal(18,5)", "0");

            RefreshProcedureAzure();
            ...
            RefreshDB()
        {
            try
            {
                ...
                if (CommonClass.temp != "master" && CommonClass.temp != null)
                {
                    ...
                    sql = "SELECT count(*) AS [Column Exists] FROM SYSOBJECTS  " +
                    " INNER JOIN SYSCOLUMNS ON SYSOBJECTS.ID = SYSCOLUMNS.ID WHERE " +
                    " SYSOBJECTS.NAME = 'TblPHASEtwocompanyprofile' AND SYSCOLUMNS.NAME = 'CRN'";
                    string ttemp0 = _Dbtask.ExecuteScalar(sql);
                    if (ttemp0 == "0")
                    {
                       // CreateColumnInTable("tblbusinessissue", "warranty", "[nvarchar](50)", " ");

                        CreateColumnInTable("TblPHASEtwocompanyprofile", "CRN", "[nvarchar](50)", "''");
                        CreateColumnInTable("TblPHASEtwocompanyprofile", "CStreet", "[nvarchar](50) ", "''");
                        CreateColumnInTable("TblPHASEtwocompanyprofile", "BuildingNo", "[nvarchar](50) ", "''");
                        CreateColumnInTable("TblPHASEtwocompanyprofile", "City", "[nvarchar](50) ", "''");
                        CreateColumnInTable("TblPHASEtwocompanyprofile", "PostelCode", "[nvarchar](50)", "''");
                        CreateColumnInTable("TblPHASEtwocompanyprofile", "SubDivision", "[nvarchar](50) ", "''");
                 ...
                 //   }
                  ...
                  " SYSOBJECTS.NAME = 'Tblchqreceived' AND SYSCOLUMNS.NAME = 'Agvno'";
                   ...
                   ") ON [PRIMARY]";
                    ...
                    CreateColumnInTable("Tblaccountledger", "schemeID", "nvarchar(500)", "''");
                    CreateColumnInTable("Tblaccountledger", "StreetName", "nvarchar(500)", "''");
                    CreateColumnInTable("Tblaccountledger", "AdditionalStreetName", "nvarchar(500)", "''");

                    CreateColumnInTable("Tblaccountledger", "BuildingNumber", "nvarchar(500)", "''");
                    CreateColumnInTable("Tblaccountledger", "CountrySubentity", "nvarchar(500)", "''");
                    CreateColumnInTable("Tblaccountledger", "CitySubdivisionName", "nvarchar(500)", "''");

                    CreateColumnInTable("Tblaccountledger", "IdentificationCode", "nvarchar(500)", "''");
                    CreateColumnInTable("Tblaccountledger", "RegistrationName", "nvarchar(500)", "''");
                    CreateColumnInTable("Tblaccountledger", "CompanyID", "nvarchar(500)", "''");
                   ...
                   ") ON [PRIMARY]";
                    ...
                    CreateColumnInTable("Tbltransactionreceipt", "SIretvno", "nvarchar(500)", "''");
                    CreateColumnInTable("Tbltransactionreceipt", "SIretdate", "nvarchar(500)", "''");
...
" END";
                  ...
                  if (CommonClass._Paramlist.IsParamNameExist("MINofPOS") == false)
                  {
                    ...
                    CreateColumnInTable("Tblbusinessissue", "Hascode", "nvarchar(500)", "''");
                    CreateColumnInTable("Tblbusinessissue", "SaleUID", "nvarchar(500)", "''");
                    ...
                    //phase2companyprofile

                    if (KnowTableexsting("TblPHASEtwocompanyprofile") == false)
                    {
                        sql = "CREATE TABLE [dbo].[TblPHASEtwocompanyprofile](" +
                                             "[Workingtype] [nvarchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL ," +
                                             "[OTP] [nvarchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL ," +
                                             "[CommonName] [nvarchar](1000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL ," +
                                             "[SerialNumber] [nvarchar](1000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL ," +
                                             "[firmname] [nvarchar](1000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL ," +
                                             "[Branchname] [nvarchar](1000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL ," +
                                             "[countrytext] [nvarchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL ," +
                                             "[vatnumber] [nvarchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL ," +
                                             ...
                                             "[CStreet] [nvarchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL ," +
                                             "[BuildingNo] [nvarchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL ," +
                                             "[City] [nvarchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL ," +
                                             "[PostelCode] [nvarchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL ," +
                                             "[SubDivision] [nvarchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL ," +
                                             "[ScrtKEY] [nvarchar](1000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL " +
                        ...
                        sql = "  CREATE PROCEDURE [dbo].[InsertPHASEtwocompanyprofile] " +
                            " @Workingtype [nvarchar](50) ," +
                            " @OTP [nvarchar](50) ," +
                            " @CommonName [nvarchar](1000) ," +
                            ...
                            " @CSR [nvarchar](1000) ," +
                            " @PrtKEY [nvarchar](1000) ," +
                            " @PblKEY [nvarchar](1000) ," +
                             " @CRN [nvarchar](50) ," +
                            " @CStreet [nvarchar](50) ," +
                            " @BuildingNo [nvarchar](50) ," +
                            " @City [nvarchar](50) ," +
                              " @PostelCode [nvarchar](50) ," +
                            " @SubDivision [nvarchar](50) ," +
                            " @ScrtKEY [nvarchar](1000)  " +


                             "  AS " +
                             "  BEGIN" +
                             "  insert into   TblPHASEtwocompanyprofile (Workingtype,OTP,CommonName,SerialNumber,firmname,Branchname,countrytext,vatnumber,location,Industry,CSR,PrtKEY,PblKEY,CRN,CStreet,BuildingNo,City,PostelCode,SubDivision,ScrtKEY)" +
                             "  values (@Workingtype,@OTP,@CommonName,@SerialNumber,@firmname,@Branchname,@countrytext,@vatnumber,@location,@Industry,@CSR,@PrtKEY,@PblKEY,@CRN,@CStreet,@BuildingNo,@City,@PostelCode,@SubDivision,@ScrtKEY)" +
                             "  RETURN " +
                             "  END";
                        _Dbtask.ExecuteNonQuery(sql);
