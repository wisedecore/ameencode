...
namespace WindowsFormsApplication2
{
    class ClsTwoinchThermalPurch
    {
        ...
        // Font and Color:------------------
        // Title Font
        private Font Arialnormal = new Font("Arial", 6, FontStyle.Regular);
        private Font ArialnormalItalic = new Font("Arial", 6, FontStyle.Italic);
        private Font Arialbold = new Font("Arial", 6, FontStyle.Bold);
        // Title Font height
        private int InvTitleHeight;
        // SubTitle Font
        private Font InvSubTitleFont = new Font("Arial", 6, FontStyle.Regular);
        ...
        private Font VerdanaBoldHeadingMain = new Font("Calibri", 10, FontStyle.Bold);
        private Font VerdanaBoldHeadingMain2 = new Font("Calibri", 8, FontStyle.Bold);

        private Font VerdanaBoldHeading = new Font("Verdana", 8, FontStyle.Bold);

        private Font VerdanaBold = new Font("Verdana", 6, FontStyle.Regular);
        //private Font VerdanaArabic = new Font("Microsoft Sans Serif", 10, FontStyle.Bold);
        private Font VerdanaArabic = new Font("Calibri", 6, FontStyle.Bold);
        private Font arbHead = new Font("Calibri", 9, FontStyle.Bold);
        private Font arbHead2 = new Font("Calibri", 9, FontStyle.Bold);


        private Font VerdanaBoldAddress = new Font("Verdana", 6, FontStyle.Bold);
        private Font CalibiRiItalic = new Font("Verdana", 6, FontStyle.Italic);
        private Font CalibiRiItalic2 = new Font("Comic Sans MS", 6, FontStyle.Bold);
        private Font CalibiRiItalic3 = new Font("Comic Sans MS", 6, FontStyle.Bold);

        private Font CalibiRiItalic4 = new Font("Comic Sans MS", 6, FontStyle.Bold);
        //Customer Detail MV Boli

        private Font BOLI = new Font("SimHei", 12, FontStyle.Regular);

        private Font Verdananormal = new Font("Verdana", 6, FontStyle.Regular);

        private Font Verdanaitalic = new Font("Verdana", 6, FontStyle.Regular);
        //Declaration Font
        private Font Declarationfont = new Font("Calibri", 6, FontStyle.Regular);

        private Font AmountInwordsfont = new Font("Calibri", 6, FontStyle.Regular);
        // Invoice Font height
        ...
        private void SetInvoiceHead(Graphics g)
        {
            ...
            if (System.IO.File.Exists(InvImage) && FormType != "Salesdaybookcount")
            {
                ...
                g.DrawImage(oInvImage, 0, 5,150,80);
            ...
            if (FormType == "Sales Return")/**/
            {
                ...
                hx = (200 - (int)g.MeasureString(InvSubTitle5, arbHead).Width) / 2;
            ...
            if (InvTitle != "" && FormType != "     SALES ORDER" && FormType != "Purchase Order" && FormType != "SALES QUATATION")/*For Company Heading*/
            {
                ...
                if (FormType != "Salesdaybookcount")
                {
                    hx = (200 - (int)g.MeasureString(InvTitle, arbHead).Width) / 2;
                    CurrentY = CurrentY + 5;
                    g.DrawString(InvTitle, arbHead, BlackBrush, hx - 15, CurrentY);
                    CurrentY = CurrentY + 20;
                }
            }
            if (NameInHome != "" && FormType != "Salesdaybookcount")
            {
                hx = (200 - (int)g.MeasureString(NameInHome, arbHead2).Width) / 2;
                g.DrawString(NameInHome, arbHead, BlackBrush, hx - 20, CurrentY);
                CurrentY = CurrentY + 20;
            }
            if (InvSubTitle1 != "" && FormType != "     SALES ORDER" && FormType != "Purchase Order" && FormType != "SALES QUATATION" && FormType != "Salesdaybookcount")/*For Address*/
            {
                ...
                hx = (200 - (int)g.MeasureString(InvSubTitle1, arbHead).Width) / 2;
                g.DrawString(InvSubTitle1, arbHead, BlackBrush, hx - 20, CurrentY);
                CurrentY = CurrentY + 7;
            }
            ...
            if (InvSubTitle11 != "" && FormType != "Salesdaybookcount" && FormType != "     SALES ORDER" && FormType != "Purchase Order" && FormType != "SALES QUATATION")/*For Address2*/
            {
                ...
                hx = (200 - (int)g.MeasureString(InvSubTitle11, AmountInwordsfont).Width) / 2;
                g.DrawString(InvSubTitle11, arbHead, BlackBrush, hx, CurrentY);
                CurrentY = CurrentY + 7;
            }
            if (InvSubTitle2 != "" && FormType != "Salesdaybookcount" && FormType != "Report" && FormType != "     SALES ORDER" && FormType != "Purchase Order" && FormType != "SALES QUATATION")/*For Phone*/
            {
                ...
                hx = (200 - (int)g.MeasureString(InvSubTitle2, arbHead2).Width) / 2;

                g.DrawString(InvSubTitle2, arbHead2, BlackBrush, hx - 20, CurrentY);
                CurrentY = CurrentY + 7;
            }
            ...
            {
                CurrentY = CurrentY + InvSubTitleHeight;
                hx = (200 - (int)g.MeasureString(InvSubTitle3, arbHead2).Width) / 2;

                g.DrawString(InvSubTitle3, arbHead2, BlackBrush, hx - 10, CurrentY);
                CurrentY = CurrentY + 7;
            }
            ...
            if (CommonClass._Menusettings.GetMnustatus("194") == "-1")
            {
               ...
               CurrentY = CurrentY +15;
                ...
                //CurrentY = CurrentY + InvSubTitleHeight;
                //hx = (200 - (int)g.MeasureString(InvSubTitle3, arbHead).Width) / 2;

                //g.DrawString("Simplified Tax Invoice", arbHead, BlackBrush, hx +10, CurrentY);
            ...
            {
                CurrentY = CurrentY + InvSubTitleHeight;
                g.DrawString(InvSubTitle6, Verdananormal, BlackBrush, 200, CurrentY);
            }
            if (InvSubTitle7 != "" && FormType != "Salesdaybookcount" && FormType == "Multi" && FormType != "Report")
            {
                CurrentY = CurrentY + InvSubTitleHeight;
                g.DrawString(InvSubTitle7, Verdananormal, BlackBrush, 200, CurrentY);
            }
            // Draw line:
        ...
        private void SetOrderData(Graphics g)
        {
            ...
            if (FormType != "Report" && FormType != "Salesdaybookcount")
            {
                ...
                g.DrawString(Billno, VerdanaBold, BlackBrush, 60, CurrentY);

                CurrentY = CurrentY + 16;
                FieldValue = "Date ";
                g.DrawString(FieldValue, VerdanaBold, BlackBrush, 3, CurrentY);
                g.DrawString(":" + BillDate.ToString("dd/MM/yyyy"), Verdananormal, BlackBrush, 30, CurrentY);

                 CurrentY = CurrentY + 16;


                g.DrawString("Time", VerdanaBold, BlackBrush, 3, CurrentY);
                g.DrawString(":" + BillDate.ToString("hh:mm:ss tt"), Verdananormal, BlackBrush, 30, CurrentY);
                CurrentY = CurrentY + 16;
                ...
                g.DrawString("Supplier : ", VerdanaBold, BlackBrush, 3, CurrentY);
                FieldValue = CName;
            ...
            if (FormType == "WHOLESALE" || FormType == "Sales")
            {
                ...
                {
                    g.DrawString(FieldValue, Verdananormal, BlackBrush, CurrentX - 5, CurrentY + 13);
                ...
                if (FormType != "Salesdaybookcount")
                {
                    ...
                    for (int i = TRowcounting; i < MainGrid.Rows.Count; i++)
                    {
                        ...
                        if (_Dbtask.znllString(MainGrid.Rows[i].Tag) == "1")
                        {
                            ...
                            int x = (170 - (int)g.MeasureString(SecondLanguage, VerdanaArabic).Width);
                            ...
                            FieldValue = String.Format("{0:0.00}", _Dbtask.gridnul(MainGrid.Rows[i].Cells["clnprate"]));
                            e.Graphics.DrawString(FieldValue, VerdanaArabic, BlackBrush, xRate, CurrentY, Str);
                            SumSrate = SumSrate + CommonClass._Dbtask.znlldoubletoobject(FieldValue);
           ...
           "Fifty", "Sixty", "Seventy", "Eighty", "Ninety" };
            ...
            public String ConvertAmount(double amount)
            {
                try
                {
                    ...
                    ClsTwoinchThermalPurch Frms = new ClsTwoinchThermalPurch();
        ...
        public void VatPrinting(Graphics g)
        {
            ...
            if (InvSubTitle5 == "       Report INVOICE" || FormType == "Salesdaybookcount")
            {
                if (InvSubTitle5 == "       Report INVOICE")
                {
                    ...
                    arbHead = new Font("Calibri", 10, FontStyle.Bold);
                    ...
                    g.DrawString(FieldValue + tot, arbHead, BlackBrush, xNetamt + 30, CurrentY, Str);
                    CurrentY = CurrentY + 18;
                    ...
                    g.DrawString(FieldValue + tottax, arbHead, BlackBrush, xNetamt, CurrentY, Str);
            ...
            else
            {
                ...
                if (FormType != "Salesdaybookcount")
                {
                    ...
                    {
                        FieldValue = "TOTAL";
                        g.DrawString(FieldValue, CalibiRiItalic2, BlackBrush, 45, CurrentY, Str);
                        CurrentY = CurrentY + 15;
                        FieldValue = "(مجموع)";
                        g.DrawString(FieldValue, CalibiRiItalic2, BlackBrush, 45, CurrentY, Str);
                        //string tottax = SumSrate.ToString();
                        FieldValue = TotalTaxable.ToString("0.00");
                        g.DrawString(FieldValue, arbHead, BlackBrush, 130, CurrentY, Str);
                        CurrentY = CurrentY + 18;
                        ...
                        FieldValue = "VAT 15%";
                        g.DrawString(FieldValue, CalibiRiItalic3, BlackBrush, 45, CurrentY, Str);
                        CurrentY = CurrentY + 15;
                        FieldValue = "(ضريبة)";
                        g.DrawString(FieldValue, CalibiRiItalic3, BlackBrush, 45, CurrentY, Str);
                    ...
                    g.DrawString(FieldValue, CalibiRiItalic3, BlackBrush, 70, CurrentY, Str);
                    CurrentY = CurrentY + 15;
                    //CurrentY = CurrentY + 18;//28
                    FieldValue = "(المجموع الإجمالي)";
                    g.DrawString(FieldValue, CalibiRiItalic3, BlackBrush, 70, CurrentY, Str);
                    g.DrawString(BillAmount, arbHead, BlackBrush, 140, CurrentY, Str);
        ...
        private void SetInvoiceTotal(Graphics g)
        {
            ...
            if (FormType != "Salesdaybookcount" && FormType != "Report")
            {
                CurrentY = CurrentY + 10;
            ...
            if (InvSubTitle5 != "       Report INVOICE" && FormType != "Salesdaybookcount")
            {
                ...
                if (qrshow == "1")
                {
                    ...
                    g.DrawImage(result, x-40, CurrentY );
                ...
                GETfooterLINES(g);
                x = (200 - (int)g.MeasureString("**-----شكراً لزيارتكم-----**", VerdanaArabic).Width) / 2;
                CurrentY = CurrentY + 15;
