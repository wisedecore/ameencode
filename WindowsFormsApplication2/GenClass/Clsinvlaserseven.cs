...
namespace WindowsFormsApplication2
{
    class Clsinvlaserseven
    {
        ...
        // Invoice Font height
        private int InvoiceFontHeight; public int itmcodecln = 0;
        // Blue Color
        ...
        private void ReadInvoiceHead()
            ...
            itmcodecln = Convert.ToInt32(CommonClass._Paramlist.GetParamvalue("itemcodeprintsize"));
            //if (langarab=="Arabic")
            //{
        ...
        private void SetInvoiceHead(Graphics g)
        {
            ...
            g.DrawRectangle(selpen, CurrentX, CurrentY, 770, 20);//x10
            ...
            //if (FormType == "     SALES ORDER")
            //{
            //    g.DrawString("(Saler Order)", VerdanaBold, BlackBrush,( leftlase+480), CurrentY);//142
            //}
            //if (FormType == "     SALES RETURN")
            //{
            //    g.DrawString("(Saler Return-مرتجع فاتورة)", VerdanaBold, BlackBrush, 550, CurrentY);//142
            //}
            //StrTaxinvoiceHeader = "فاتورة ضريبية مبسطة" + "  " + "Simplified Tax Invoice"; 
            g.DrawString(StrTaxinvoiceHeader, VerdanaBold, BlackBrush, ( leftlase+300), CurrentY);//142
            g.DrawString(ModeofPayment, VerdanaBold, BlackBrush,( leftlase+ 20), CurrentY);//142


            CurrentY = CurrentY + 26;//168
            g.DrawString("Invoice no.", Verdananormal, BlackBrush, leftlase, CurrentY);
            g.DrawString("Mobile", Verdananormal, BlackBrush, ( leftlase+ 381), CurrentY);
            ...
            CurrentY = CurrentY + 2;//170
            g.DrawRectangle(selpen2, ( leftlase+ 380), CurrentY, 395, 60);
            g.DrawLine(new Pen(Brushes.Black, 1),( leftlase+ 525), CurrentY,( leftlase+ 525), CurrentY + 60);
            g.DrawLine(new Pen(Brushes.Black, 1), ( leftlase+150), CurrentY, ( leftlase+150), CurrentY + 60);

            CurrentY = CurrentY + 2;//172
            g.DrawString(Billno, VerdanaBold, BlackBrush, ( leftlase+157), CurrentY);
            g.DrawString(cusmob, VerdanaBold, BlackBrush, ( leftlase+540), CurrentY);//CName


            CurrentY = CurrentY + 10;//182
            g.DrawString("رقم الفاتورة", Verdananormal, BlackBrush,  leftlase, CurrentY);
            g.DrawString(_Gen.FuReturnArabic("Mobile"), Verdananormal, BlackBrush, ( leftlase+381), CurrentY);


            CurrentY = CurrentY + 16;//198
            g.DrawLine(new Pen(Brushes.Black, 1),  leftlase, CurrentY, ( leftlase+372), CurrentY);

            g.DrawLine(new Pen(Brushes.Black, 1), leftlase, CurrentY, ( leftlase+778), CurrentY);
            g.DrawLine(new Pen(Brushes.Black, 1), ( leftlase+380), CurrentY, ( leftlase+772), CurrentY);
            CurrentY = CurrentY + 2;//200
            g.DrawString("Date.", Verdananormal, BlackBrush, leftlase, CurrentY);
            g.DrawString("Customer VAT", Verdananormal, BlackBrush, ( leftlase+381), CurrentY);
            g.DrawString(BillDate.ToString("dd/MM/yyyy") + "  Time:" + BillDate.ToString("hh:mm:ss"), VerdanaBold, BlackBrush,( leftlase+ 150), CurrentY);
            g.DrawString(CTin, VerdanaBold, BlackBrush, ( leftlase+540), CurrentY);

            CurrentY = CurrentY + 14;//214
            g.DrawString("تاريخ", Verdananormal, BlackBrush, leftlase, CurrentY);
            g.DrawString(_Gen.FuReturnArabic("Vat Cus"), Verdananormal, BlackBrush, ( leftlase+381), CurrentY);
            ...
            //g.DrawString("Date.", Verdananormal, BlackBrush, 10, 200);
           ...
           // g.DrawString(_Gen.FuReturnArabic("Mobile"), Verdananormal, BlackBrush, 381, 182);
            ...
            g.DrawRectangle(selpen2, leftlase, CurrentY, ( leftlase+770), 40);

            CurrentY = CurrentY + 2;//242
            g.DrawString("Customer " + _Gen.FuReturnArabic("Cus Name") + " : ", Verdananormal, BlackBrush,  leftlase, CurrentY);
            g.DrawString(CName, VerdanaBold, BlackBrush, ( leftlase+150), CurrentY);

            CurrentY = CurrentY + 18;//260
            g.DrawLine(new Pen(Brushes.Black, 1), leftlase, CurrentY, ( leftlase+775), CurrentY);
            g.DrawString(Address.Replace("\n", ""), VerdanaBold, BlackBrush, ( leftlase+150), CurrentY);
            //g.DrawString(cusmob, VerdanaBold, BlackBrush, ( leftlase+730), CurrentY, Str);



            CurrentY = CurrentY + 5;//265
            g.DrawString("Address " + _Gen.FuReturnArabic("Address"), Verdananormal, BlackBrush,  leftlase, CurrentY);

            CurrentY = CurrentY + 25;//290

            g.DrawRectangle(selpen, leftlase, CurrentY, 770, (630 - toplasr));
            g.DrawLine(new Pen(Brushes.Black, 1), ( leftlase+70), CurrentY,( leftlase+ 70), CurrentY + (630 - toplasr));

            g.DrawLine(new Pen(Brushes.Black, 1), (leftlase + 140 + itmcodecln), CurrentY, (leftlase + 140 + itmcodecln), CurrentY + (630 - toplasr));


            g.DrawLine(new Pen(Brushes.Black, 1),( leftlase+ 400), CurrentY, ( leftlase+400), CurrentY + (630 - toplasr));

            g.DrawLine(new Pen(Brushes.Black, 1), ( leftlase+450), CurrentY,( leftlase+ 450), CurrentY + (630 - toplasr));//789

            g.DrawLine(new Pen(Brushes.Black, 1),( leftlase+ 500), CurrentY,( leftlase+ 500), CurrentY + (630 - toplasr));
            g.DrawLine(new Pen(Brushes.Black, 1), ( leftlase+565), CurrentY, ( leftlase+565), CurrentY + (630 - toplasr));
            g.DrawLine(new Pen(Brushes.Black, 1),( leftlase+ 630), CurrentY,( leftlase+ 630), CurrentY + (630 - toplasr));
            //g.DrawLine(new Pen(Brushes.Gray, 1), 650, 290, 650, 725);
            g.DrawLine(new Pen(Brushes.Black, 1),( leftlase+ 685), CurrentY,( leftlase+ 685), CurrentY + (630 - toplasr));

            CurrentY = CurrentY + 10;//300
            g.DrawString("Slno", Verdananormal, BlackBrush, leftlase, CurrentY);
            g.DrawString("Itemcode", Verdananormal, BlackBrush, (leftlase + 75 ), CurrentY);
            g.DrawString("Itemname", Verdananormal, BlackBrush, (leftlase + 160 + itmcodecln), CurrentY);
            g.DrawString("Qty", Verdananormal, BlackBrush,( leftlase+ 410), CurrentY);
            g.DrawString("Unit", Verdananormal, BlackBrush, ( leftlase+455), CurrentY);
            g.DrawString("Unitprice", Verdananormal, BlackBrush, ( leftlase+505), CurrentY);
            g.DrawString("Gross", Verdananormal, BlackBrush, ( leftlase+578), CurrentY);
            g.DrawString("Tax15%", Verdananormal, BlackBrush,( leftlase+ 630), CurrentY);
            g.DrawString("Amount", Verdananormal, BlackBrush, ( leftlase+700), CurrentY);
           

            CurrentY = CurrentY + 12;//312
            g.DrawString(_Gen.FuReturnArabic("Slno"), Verdananormal, BlackBrush, leftlase, CurrentY);
            g.DrawString(_Gen.FuReturnArabic("Item Code"), Verdananormal, BlackBrush, (leftlase + 75 ), CurrentY);
            g.DrawString(_Gen.FuReturnArabic("Item Name"), Verdananormal, BlackBrush, (leftlase + 160 + itmcodecln), CurrentY);
            g.DrawString(_Gen.FuReturnArabic("Qty"), Verdananormal, BlackBrush, ( leftlase+410), CurrentY);
            g.DrawString(_Gen.FuReturnArabic("Unit"), Verdananormal, BlackBrush, ( leftlase+455), CurrentY);
            g.DrawString(_Gen.FuReturnArabic("Unit Rate"), Verdananormal, BlackBrush,( leftlase+ 505), CurrentY);
            g.DrawString(_Gen.FuReturnArabic("Gross"), Verdananormal, BlackBrush,( leftlase+ 578), CurrentY);
            g.DrawString(_Gen.FuReturnArabic("Tax 15%"), Verdananormal, BlackBrush,( leftlase+ 630), CurrentY);
            g.DrawString(_Gen.FuReturnArabic("Amount"), Verdananormal, BlackBrush, ( leftlase+700), CurrentY);



            CurrentY = CurrentY + 18;//330
            g.DrawLine(new Pen(Brushes.Black, 1),leftlase, CurrentY, ( leftlase+772), CurrentY);
            ...
            if (HF == 0 || HF == 2)
            {
               ...
               // if (System.IO.File.Exists(InvImagehead) && FormType != "ESTIMATE" && HeaderinPrint == true)
                if (System.IO.File.Exists(InvImagehead) && FormType != "ESTIMATE" )
                {
                    ...
                    ImageHeight = oInvImage.Height; // Get Image Height
                    ImageHeight = 0;
                    g.DrawImage(oInvImage, leftlase, 5, 750, 130);
                }
            }
           ...
           // if (System.IO.File.Exists(invimagefootr) && FormType != "ESTIMATE"&&HeaderinPrint==true)
                if (System.IO.File.Exists(invimagefootr) && FormType != "ESTIMATE" )
            {
                ...
                ImageHeight = oInvImage.Height; // Get Image Height
                ImageHeight = 0;
                g.DrawImage(oInvImage,( leftlase+ 29), 1010, 718, 60);
            }
                ...
                if (_Dbtask.znllString(MainGrid.Rows[i].Tag) == "1")
                {
                    if (TempRowcounting <RecordsPerPage)
                    {
                        if (isarbicdotprint == true)
                        {
                            ...
                            g.DrawString(FieldValue, Verdananormal, BlackBrush,( leftlase+ 40), CurrentY);
                            ...
                            if (ItemNote.Length > 10)
                            {
                                ItemNote = ItemNote.Substring(0, 9);
                            }
                            g.DrawString(ItemNote, Verdananormal, BlackBrush,( leftlase+ 70), CurrentY);
                            ...
                            if (Plangwise == 1 || Plangwise == 0)
                            {
                                if (Plangwise == 0)
                                {
                                    ...
                                    if (FieldValue != "")
                                    {
                                        g.DrawString(FieldValue, Verdananormal, BlackBrush, (leftlase + 140 + itmcodecln), CurrentY);
                                    }
                                }
                                if (Plangwise == 1)
                                {
                                    ...
                                    if (FieldValue != "")
                                    {
                                        ...
                                        g.DrawString(FieldValue, Verdananormal, BlackBrush, (leftlase + 390), CurrentY , Str);
                                    }
                                }
                        ...
                        if (InvSubTitle5 != "DELIVERY NOTE INVOICE")
                        {
                            if (isarbicdotprint == true)
                            {
                                ...
                                g.DrawString(FieldValue, Verdananormal, BlackBrush, ( leftlase+445), CurrentY, Str);
                                ...
                                g.DrawString(FieldValue, Verdananormal, BlackBrush,( leftlase+ 463), CurrentY);
                                ...
                                g.DrawString(FieldValue, Verdananormal, BlackBrush,( leftlase+ 560), CurrentY, Str);

                                FieldValue = String.Format("{0:0.00}", _Dbtask.gridnul(MainGrid.Rows[i].Cells["Clngross"].Value));
                                g.DrawString(FieldValue, Verdananormal, BlackBrush, ( leftlase+628), CurrentY, Str);

                                FieldValue = String.Format("{0:0.00}", _Dbtask.gridnul(MainGrid.Rows[i].Cells["Clntax"].Value));
                                g.DrawString(FieldValue, Verdananormal, BlackBrush, ( leftlase+680), CurrentY, Str);


                                FieldValue = String.Format("{0:0.00}", _Dbtask.gridnul(MainGrid.Rows[i].Cells["clnnettamount"].Value));
                                g.DrawString(FieldValue, Verdananormal, BlackBrush, ( leftlase+755), CurrentY, Str);
           ...
           "خمسون", "ستون", "سبعون", "ثمانون", "تسعين" };
            ...
            public String ConvertAmount(double amount)
            {
                try
                {
                    ...
                    Clsinvlaserseven Frms = new Clsinvlaserseven();
        ...
        public void PrintTotal(Graphics g)
        {
            ...
            g.DrawLine(new Pen(Brushes.Black, 1), leftlase, CurrentY,( leftlase+ 758), CurrentY);
            ...
            if (InvSubTitle5 != "DELIVERY NOTE INVOICE")
            {
                ...
                g.DrawString("Total", VerdanaBold, BlackBrush,( leftlase+ 150), CurrentY);
                g.DrawString(TotalQty, Verdananormal, BlackBrush,( leftlase+ 410), CurrentY);/*For Qty*///350
                g.DrawString(_Dbtask.SetintoDecimalpoint(TotalTaxable), Verdananormal, BlackBrush,( leftlase+ 628), CurrentY, Str);/*For Qty*///350
                //g.DrawString(_Dbtask.SetintoDecimalpoint(TotalItemDisc), Verdananormal, BlackBrush, xDiscount, CurrentY);/*For Discount*/
                //g.DrawString(_Dbtask.SetintoDecimalpoint(TotalTaxable), VerdanaBoldSmall, BlackBrush, xTaxable, CurrentY);/*For Taxable*/
                g.DrawString(_Dbtask.SetintoDecimalpoint(TotalTaxAmount), Verdananormal, BlackBrush,( leftlase+ 680), CurrentY, Str);/*For Tax*/
                g.DrawString(_Dbtask.SetintoDecimalpoint(TotalNetamount), Verdananormal, BlackBrush,( leftlase+ 755), CurrentY, Str);/*For Amount*/
                ...
                g.DrawRectangle(selpen,  leftlase, CurrentY, 150, 150);
                g.DrawRectangle(selpen, ( leftlase+300), CurrentY, 472, 150);
                g.DrawLine(new Pen(Brushes.Black, 1), ( leftlase+600), CurrentY, ( leftlase+600), CurrentY+150);
                g.DrawLine(new Pen(Brushes.Black, 1), ( leftlase+600), CurrentY, ( leftlase+600), CurrentY);
                ...
                CurrentY = CurrentY + 5;
                g.DrawString("Authorised Signatory ", Verdananormal, BlackBrush, ( leftlase+12), CurrentY);

                CurrentY = CurrentY + 10;//815
                g.DrawString("Discount   " + _Gen.FuReturnArabic("Discount") + "", Verdananormal, BlackBrush, ( leftlase+305), CurrentY);
                if (Convert.ToDouble(TDiscount) > 0)
                {
                    if (isarbicdotprint == true)
                    {
                        // g.DrawString(" خصم", ArialnormalItalic, BlackBrush, 300, CurrentY,Str);
                        xTotalValue = 750 - (int)g.MeasureString(TDiscount, ArialnormalItalic).Width;
                        g.DrawString(_Dbtask.SetintoDecimalpoint(_Dbtask.znlldoubletoobject(TDiscount)).ToString(), Arialboldbottm, BlackBrush, ( leftlase+750), CurrentY, Str);
                ...
                g.DrawString("المفوض بالتوقيع ", Verdananormal, BlackBrush,( leftlase+ 12), CurrentY);


                CurrentY = CurrentY + 15;//835
                g.DrawLine(new Pen(Brushes.Black, 1), ( leftlase+300), CurrentY,( leftlase+ 772), CurrentY);

                CurrentY = CurrentY + 10;//845

               // g.DrawLine(new Pen(Brushes.Black, 1), 300, 835, 762, 835);
                g.DrawString("Tot.Amount(exclusive vat)   " + _Gen.FuReturnArabic("Excl Vat") + "", Verdananormal, BlackBrush,( leftlase+ 305), CurrentY);
                g.DrawString(_Dbtask.SetintoDecimalpoint(TotalTaxable).ToString(), Arialboldbottm, BlackBrush, ( leftlase+750), CurrentY, Str);
                //
                CurrentY = CurrentY + 31;//876
                g.DrawLine(new Pen(Brushes.Black, 1), ( leftlase+300), 876, ( leftlase+772), 876);


                CurrentY = CurrentY + 9;//885

                g.DrawString("Total vat 15%   " + _Gen.FuReturnArabic("Total Vat") + "", Verdananormal, BlackBrush, ( leftlase+305), CurrentY);
                if (isarbicdotprint == true)
                {
                    g.DrawString(_Dbtask.SetintoDecimalpoint(TotalTaxAmount).ToString(), Arialboldbottm, BlackBrush, ( leftlase+750), CurrentY, Str);

                }


                CurrentY = CurrentY + 26;//911
                g.DrawLine(new Pen(Brushes.Black, 1), ( leftlase+300), CurrentY,( leftlase+ 770), CurrentY);

                CurrentY = CurrentY + 10;//921
                g.DrawString("Total Amount   " + _Gen.FuReturnArabic("Amount Total") + "", Verdananormal, BlackBrush,( leftlase+ 305), CurrentY);


                CurrentY = CurrentY + 39;//960
                g.DrawRectangle(selpen2, leftlase, CurrentY, 774, 40);


                CurrentY = CurrentY + 10;//970
                g.DrawString("Grand total in words", Verdananormal, BlackBrush,  leftlase, CurrentY);
        ...
        public void setqrtwo(Graphics g)
        {
            ...
            g.DrawImage(newbit, ( leftlase+180), CurrentY);
        ...
        private void SetInvoiceTotal(Graphics g)
        {
            ...
            if (FormType != "DELIVERY NOTE")
            {
                ...
                if (isarbicdotprint == true)
                {
                    ...
                    if (HeaderinPrint == true)
                    {
                        // g.DrawString(" " + AmountinWords + " only", AmountInwordsfont3, BlackBrush,( leftlase+ 180), CurrentY);
                        g.DrawString(" " + " فقط  " + AmountinWords, AmountInwordsfont3, BlackBrush, (leftlase + 180), CurrentY);
                    }
                    else
                    {
                        //arabic
                        ...
                        if (amtwrd == 0)
                        {
                            ...
                            //g.DrawString(" " + AmountinWords + " فقط" + ":  المبلغ بالكلمات", Arialboldarabicamt, BlackBrush, (leftlase + 180), CurrentY);//x180
                            CurrentY = CurrentY + 10;//985
                            g.DrawString("   :  مبلغا وقدرة", Verdananormal, BlackBrush, (leftlase + 750), CurrentY, Str);//x180  (leftlase + 180)
                            g.DrawString(" " + " فقط  " + AmountinWords, Verdananormal, BlackBrush, (leftlase + 330), CurrentY);
                        }
                        ...
                        if (amtwrd == 1)
                        {
                            ...
                            g.DrawString(" " + AmountinWords + " only", AmountInwordsfont3, BlackBrush, (leftlase + 330), CurrentY);


                            CurrentY = CurrentY + 10;//985
                            g.DrawString(_Gen.FuReturnArabic("Amount in words"), Verdananormal, BlackBrush, (leftlase + 750), CurrentY, Str);
                        }
                    
                        }
                    CurrentY = CurrentY - 64;//921
                    g.DrawString(_Dbtask.SetintoDecimalpoint(GrandTotal), VerdanaBoldHeading, BlackBrush, ( leftlase+750), CurrentY, Str);
                    grandamtt = _Dbtask.SetintoDecimalpoint(GrandTotal).ToString();
               ...
               // CurrentY = CurrentY + InvoiceFontHeight * 1;
                ...
                if (Pfooter != "")
                    g.DrawString(Pfooter, Arialbold, BlackBrush, ( leftlase+100), CurrentY);
            }
        }
        ...
        private void DisplayInvoice()
        {
            ...
            printPrvDlg.Document = this.prnDocument;
            printPrvDlg.ShowDialog(); // this shows the preview and then show the Printer Dlg below

            //printdlg.Document = this.prnDocument;

            //if (printdlg.ShowDialog() == DialogResult.OK)
            //{
            //    this.prnDocument.Print();
            //}
