    ...
    class ClsInvThermal
    {
      public  string FieldValue;
        ...
        private void SetOrderData(Graphics g)
        {
            ...
            // CurrentY = CurrentY + 16;
            FieldValue = "Date: ";
            g.DrawString(FieldValue, VerdanaBold, BlackBrush, 150, CurrentY);
            g.DrawString(BillDate.ToString("dd/MM/yyyy"), Verdananormal, BlackBrush, 200, CurrentY);
            ...
            g.DrawString("Time", VerdanaBold, BlackBrush, 150, CurrentY);
            g.DrawString(BillDate.ToString("hh:mm:ss"), Verdananormal, BlackBrush, 200, CurrentY);
            ...
            FieldValue = CName;
            g.DrawString(FieldValue, VerdanaBold, BlackBrush, 105, CurrentY);
        ...
        public void VatPrinting(Graphics g)
        {
            ...
            FieldValue = "VAT 5%";
            g.DrawString(FieldValue, VerdanaBoldHeadingMain2, BlackBrush, 100, CurrentY, Str);
            ...
            g.DrawString(TotalNetamount.ToString("0.00"), VerdanaBoldHeadingMain, BlackBrush, xNetamt, CurrentY-10, Str);
