...
namespace WindowsFormsApplication2
{
    class ClsProfitandloss
    {
     ...
     //           g.DrawString(InvSubTitle3, Arialbold, BlackBrush, xInvSubTitle1-20, CurrentY);
            ...
            if (FormType == "P&L Report" && head == false)
            {
                CurrentY = 10;
            ...
            if (FormType == "P&L Report")
            {
                ...
                g.DrawString("P&L Report", gothicfnt, BlackBrush, 300, CurrentY);
                CurrentY = CurrentY + 23;
       ...
       //     CurrentY = CurrentY + InvSubTitleHeight + 8;
        ...
        {// Set Invoice Table:
          ...
          //\ g.DrawString("SlNo", Verdananormal, BlackBrush, xSlno, CurrentY);
            ...
            {
                g.DrawString("Purticulars", VerdanaBold2, BlackBrush, 20, CurrentY);
                g.DrawString("Amount", VerdanaBold2, BlackBrush, 340, CurrentY,Str );
                g.DrawString("Purticulars", VerdanaBold2, BlackBrush, 350, CurrentY);
                //CurrentX = CurrentX + 10;
                g.DrawString("Amount", VerdanaBold2, BlackBrush, 780, CurrentY, Str);
                CurrentX = CurrentX + 80;
               
                //g.DrawString("Credit", VerdanaBold2, BlackBrush, 650, CurrentY,Str);
                //CurrentX = CurrentX + 10;

                //g.DrawString("Debit", VerdanaBold2, BlackBrush, 780, CurrentY,Str);
                //CurrentX = CurrentX + 10;
           ...
           //CurrentY = CurrentY + InvoiceFontHeight + 2;
            ...
            if (FormType == "P&L Report")
            {
                    ...
                    for (int i = TRowcounting; i <= MainGrid.Rows.Count - 1; i++)
                    {
                        ...
                        if (_dbtask.znllString(MainGrid.Rows[i].Cells["ClncAmount"].Value) != "" || _dbtask.znllString(MainGrid.Rows[i].Cells["Clndbamount"].Value) != "")
                        {
                        ...
                        if (TempRowcounting < RecordsPerPage)
                        {
                            ...
                            FieldValue = _dbtask.znllString(MainGrid.Rows[i].Cells["ClncPurticulars"].Value);
                            e.Graphics.DrawString(FieldValue, Verdananormalbld, BlackBrush, 20, CurrentY);

                            FieldValue = _dbtask.znllString(MainGrid.Rows[i].Cells["ClncAmount"].Value);
                            e.Graphics.DrawString(FieldValue, Verdananormalbld, BlackBrush,340, CurrentY,Str);

                            FieldValue = _dbtask.znllString(MainGrid.Rows[i].Cells["ClndPurticulars"].Value);
                            e.Graphics.DrawString(FieldValue, Verdananormalbld, BlackBrush, 350, CurrentY);

                            FieldValue = _dbtask.znllString(MainGrid.Rows[i].Cells["Clndbamount"].Value);
                            ...
                            //e.Graphics.DrawString(FieldValue, Verdananormalbld, BlackBrush, 670, CurrentY,Str);
                            ...
                            //g.DrawLine(new Pen(Brushes.Silver, 1), 0, CurrentY ,870, CurrentY);
           ...
           "Fifty", "Sixty", "Seventy", "Eighty", "Ninety" };
            ...
            public String ConvertAmount(double amount)
            {
                try
                {
                    ...
                    ClsProfitandloss Frms = new ClsProfitandloss();
