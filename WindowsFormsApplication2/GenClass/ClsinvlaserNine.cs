...
//Simplified Tax Invoice  فاتورة ضریبیة المبسطة
           ...
           // leftlase + 140+itmcodecln), CurrentY, (leftlase +140+ itmcodecln
            ...
            g.DrawString("Unitprice", Verdananormal, BlackBrush, (leftlase+503), CurrentY);
            g.DrawString("Gross", Verdananormal, BlackBrush, (leftlase+585), CurrentY);
            ...
            g.DrawString(_Gen.FuReturnArabic("Unit Rate"), Verdananormal, BlackBrush, (leftlase+503), CurrentY);

            g.DrawString(_Gen.FuReturnArabic("Gross"), Verdananormal, BlackBrush, (leftlase+585), CurrentY);
                    ...
                    if (TempRowcounting < RecordsPerPage)
                    {
                        ...
                        if (InvSubTitle5 != "DELIVERY NOTE INVOICE")
                        {
                            if (isarbicdotprint == true)
                            {
                                ...
                                g.DrawString(FieldValue, Verdananormal, BlackBrush,(leftlase+ 500), CurrentY, Str);
           ...
           "خمسون", "ستون", "سبعون", "ثمانون", "تسعين" };
            ...
            public String ConvertAmount(double amount)
            {
                try
                {
                    ...
                    ClsinvlaserNine Frms = new ClsinvlaserNine();
        ...
        public void PrintTotal(Graphics g)
        {
            ...
            if (InvSubTitle5 != "DELIVERY NOTE INVOICE")
            {
                ...
                g.DrawString(TotalQty, Verdananormal, BlackBrush, (leftlase+462), CurrentY);//770
