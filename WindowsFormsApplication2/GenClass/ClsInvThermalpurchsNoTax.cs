...
{
    class ClsInvThermalpurchsNoTax
    {
      ...
      public  string FieldValue;
        ...
        private void SetOrderData(Graphics g)
        {
            ...
            if (FormType != "Report" && FormType != "Salesdaybookcount")
            {
                ...
                if(Lid!="")
                {
                    CName = _dbtask.znllString(_Accountledger.GetspecifField("lname", Lid));
           ...
           "Fifty", "Sixty", "Seventy", "Eighty", "Ninety" };
            ...
            public String ConvertAmount(double amount)
            {
                try
                {
                    ...
                    ClsInvThermalpurchsNoTax Frms = new ClsInvThermalpurchsNoTax();
