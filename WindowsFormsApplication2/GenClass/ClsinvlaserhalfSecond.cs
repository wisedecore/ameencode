...
namespace WindowsFormsApplication2
{
    class ClsinvlaserhalfSecond
    {
        ...
        /*For Settings*///ClsinvlaserhalfSecond
        ...
        private Font Verdananormalsmall = new Font("Verdana", 7, FontStyle.Regular);

        private Font VerdanaBoldsmall = new Font("Verdana", 7, FontStyle.Bold);
        ...
        private void ReadInvoiceHead()
        {
            ...
            Toplaser = Convert.ToInt32(CommonClass._Paramlist.GetParamvalue("Toplaser"));
        ...
        private void SetInvoiceHead(Graphics g)
        {
            ...
            bool HEADER = false;
            g.DrawRectangle(selpens, 5, 5, 530, 792);
            // Draw Invoice image:
            if (System.IO.File.Exists(InvImage))
            {
                ...
                g.DrawImage(oInvImage, 20, 10,490,130);
           ...
           // CurrentY = CurrentY - 10;//10
            ...
            if (InvTitle != "" )/*For Company Heading*/
            {
               ...
               // g.DrawString(InvTitle, VerdanaBoldHeading, BlackBrush, 545, CurrentY,Str);
            ...
            if (InvSubTitle1 != "" )/*For Address*/
            {
               ...
               // g.DrawString(InvSubTitle1, VerdanaBold, BlackBrush, 545, CurrentY,Str);
               // CurrentY = CurrentY + 5;
            }
            ...
            if (InvSubTitle11 != "" )/*For Address2*/
            {
              //CurrentY = CurrentY + InvTitleHeight;
                ...
                //g.DrawString(InvSubTitle11, VerdanaBold, BlackBrush, 545, CurrentY,Str);
           ...
           // g.DrawString("vat:" + InvSubTitle3, VerdanaBold, BlackBrush, 15, CurrentY);/*CST Reg No*/
            //g.DrawString(InvSubTitle3 + ":vat", VerdanaBold, BlackBrush, 545, CurrentY, Str);/*CST Reg No*/
            if (InvSubTitle2 != "" )/*For Phone*/
            {
               ...
               // g.DrawString(InvSubTitle2, InvSubTitleFont, BlackBrush, 545, CurrentY,Str);
                //CurrentY = CurrentY + 5;
            }
            }
            if (InvSubTitle5 != "" && FormType != "ESTIMATE")/*For TaxRule*/
            {
                ...
                g.DrawString(InvSubTitle5, VerdanaBold, BlackBrush, CurrentX, CurrentY);
                CurrentY = CurrentY + 20;
                g.DrawString("فاتورة ضريبية", VerdanaBold, BlackBrush, CurrentX, CurrentY);
                //CurrentY = CurrentY + InvSubTitleHeight;
        ...
        private void SetOrderData(Graphics g)
        {
            ...
            CurrentY = CurrentY + 8;// 150;
            Pen selpen = new Pen(Color.LightGray);

            g.DrawRectangle(selpen, 10, CurrentY, 200, 60);
            g.DrawLine(new Pen(Brushes.LightGray, 1), 10, CurrentY + 20, 210, CurrentY + 20);
            ...
            FieldValue = "Bill no.&Date(مشروع قانون لا. & تاريخ)";
            g.DrawString(FieldValue, Verdananormal, BlackBrush, CurrentX, CurrentY);
            g.DrawString(BillDate.ToString("dd/MM/yyyy"), VerdanaBoldsmall, BlackBrush, 200, CurrentY+25,Str);
            g.DrawString(Billno, VerdanaBoldsmall, BlackBrush, CurrentX, CurrentY + 25);
            g.DrawString("Time(زمن) " , Verdananormalsmall, BlackBrush, CurrentX, CurrentY + 40);
            g.DrawString(time, Verdananormal, BlackBrush, 200, CurrentY + 40,Str);
            ...
            if (FormType == "WHOLESALE" || FormType == "Purchase Return" || SProject == false)
            {
                ...
                //g.DrawString(FieldValue + ":  VAT", Verdananormalsmall, BlackBrush, 530, CurrentY, Str);
                CurrentY = CurrentY + 15;
                FieldValue = _Accountledger.GetspecifField("mobile", Lid);
                g.DrawString(FieldValue + " :Mobile", Verdananormalsmall, BlackBrush, 530, CurrentY, Str);

                CurrentY = CurrentY + 15;
                FieldValue = _Accountledger.GetspecifField("phone", Lid);
                g.DrawString(FieldValue + " :Phone", Verdananormalsmall, BlackBrush, 530, CurrentY, Str);
        ...
        public void RowValidation(DataGridView gridmain)
        {
            try
            {
                ...
                {
                    if (gridmain.Rows[i].Cells["clnitemname"].Tag == null || Convert.ToDouble(gridmain.Rows[i].Cells["clnnetamount"].Value) == Convert.ToDouble(0))
                    {
        ...
        {// Set Invoice Table:
            ...
            CurrentY = CurrentY + 20;// 230;
            Cln = CurrentY;
            g.DrawLine(new Pen(Brushes.Gray, 1), 5, CurrentY, 540, CurrentY);
            g.DrawString("SlNo", Verdananormalsmall, BlackBrush, xSlno, CurrentY+5);
            g.DrawString("رقم", Verdananormalsmall, BlackBrush, xSlno, CurrentY + 20);
            ...
            if (InvSubTitle5 != "              ESTIMATE INVOICE" && InvSubTitle5 != "           SALES ORDER")
            {
                ...
                g.DrawString("Product Name", Verdananormalsmall, BlackBrush, xProductName, CurrentY + 5);
                g.DrawString("اسم العنصر", Verdananormalsmall, BlackBrush, xProductName, CurrentY + 20);
                ...
                g.DrawString("Qty", Verdananormalsmall, BlackBrush, xQty, CurrentY + 5);//XHsncode
                g.DrawString("الكمية", Verdananormalsmall, BlackBrush, xQty, CurrentY + 20);

                xRate = xQty + (int)g.MeasureString("Qty", Verdananormal).Width + 33;//10
                g.DrawString("Rate  ", Verdananormalsmall, BlackBrush, xRate, CurrentY + 5);//xQty
                g.DrawString("إجمالي", Verdananormalsmall, BlackBrush, xRate, CurrentY + 20);
                ...
                xTaxable = xRate + (int)g.MeasureString("Rate", Verdananormal).Width + 27;//25
                g.DrawString("Gross", Verdananormalsmall, BlackBrush, xTaxable, CurrentY + 5);//xRate
                g.DrawString("المبلغ", Verdananormalsmall, BlackBrush, xTaxable, CurrentY + 20);
                ...
                g.DrawString("Tax(15%)", Verdananormalsmall, BlackBrush, xTaxAmt-10, CurrentY + 5);//xTaxperc
                g.DrawString("ضريبة", Verdananormalsmall, BlackBrush, xTaxAmt, CurrentY + 20);
            }
            else
            {
            ...
            {
                xNetamt = xTaxAmt + (int)g.MeasureString("Tax", Verdananormal).Width + 30;//10
                g.DrawString("Amount", Verdananormalsmall, BlackBrush, xNetamt-15, CurrentY + 5);
                g.DrawString("كمية الشبكة", Verdananormalsmall, BlackBrush, xNetamt-15, CurrentY + 20);
           ...
           // g.DrawLine(new Pen(Brushes.Gray, 1), leftMargin, CurrentY, InvoiceWidth, CurrentY);
                    ...
                    if (TempRowcounting < RecordsPerPage)
                    {
                        ...
                        if (itemnotee == true)
                        {
                            ...
                            if (FieldValue != "")
                            {
                                ...
                                g.DrawString(FieldValue, Verdananormalsmall, BlackBrush, xProductName, CurrentY);
                                CurrentY = CurrentY + 20;
                        ...
                        if (InvSubTitle5 != "              ESTIMATE INVOICE" && InvSubTitle5 != "           SALES ORDER")
                        {
                            ...
                            // FieldValue = "";
                            g.DrawString(FieldValue, Verdananormalsmall, BlackBrush, XHsncode, CurrentY);
                        }
                        FieldValue = Convert.ToDouble(MainGrid.Rows[i].Cells["clnqty"].Value).ToString();
                        // FieldValue = _Dbtask.znllString(MainGrid.Rows[i].Cells["clnitemnote"].Value);
                        g.DrawString(FieldValue, Verdananormalsmall, BlackBrush, xQty + 20, CurrentY, Str);


                        FieldValue = String.Format("{0:0.00}", _Dbtask.gridnul(MainGrid.Rows[i].Cells["clnrate"].Value));
                        g.DrawString(FieldValue, Verdananormalsmall, BlackBrush, xRate + 46, CurrentY, Str);
                        ...
                        if (InvSubTitle5 != "              ESTIMATE INVOICE" && InvSubTitle5 != "           SALES ORDER")
                        {
                            ...
                            g.DrawString(FieldValue, Verdananormalsmall, BlackBrush, xTaxAmt + 30, CurrentY, Str);

                            FieldValue = String.Format("{0:0.00}", _Dbtask.gridnul(MainGrid.Rows[i].Cells["Clnamount"].Value));
                            g.DrawString(FieldValue, Verdananormalsmall, BlackBrush, xTaxable + 45, CurrentY, Str);
                        }
                        if (InvSubTitle5 == "              ESTIMATE INVOICE")
                        {
                            FieldValue = String.Format("{0:0.00}", _Dbtask.gridnul(MainGrid.Rows[i].Cells["clnnetamount"].Value));
                            g.DrawString(FieldValue, Verdananormal, BlackBrush, xNetamt + 460, CurrentY, Str);
                        }
                        else
                        {
                            FieldValue = String.Format("{0:0.00}", _Dbtask.gridnul(MainGrid.Rows[i].Cells["clnnetamount"].Value));
                            g.DrawString(FieldValue, Verdananormalsmall, BlackBrush, xNetamt + 20, CurrentY, Str);
                        }
           ...
           "Fifty", "Sixty", "Seventy", "Eighty", "Ninety" };
            ...
            public String ConvertAmount(double amount)
            {
                try
                {
                    ...
                    ClsinvlaserhalfSecond Frms = new ClsinvlaserhalfSecond();
        ...
        public void VatPrinting(Graphics g)
        {
                ...
                if (InvSubTitle5 != "              ESTIMATE INVOICE" && InvSubTitle5 != "           SALES ORDER")
                {
                    ...
                    g.DrawString(" Total Gross ( المجموع الإجمالي )" , VerdanaBold, BlackBrush, 260, CurrentY);
                    g.DrawString( _Dbtask.SetintoDecimalpoint(TotalTaxable), VerdanaBold, BlackBrush, 470, CurrentY);
                    
                    CurrentY = CurrentY + 16;

                    g.DrawString(" Total Discount ( إجمالي الخصم ) " , VerdanaBold, BlackBrush, 260, CurrentY);
                    g.DrawString( TDiscount, VerdanaBold, BlackBrush, 470, CurrentY);
                    
                    CurrentY = CurrentY + 16;

                    g.DrawString(" Total VAT(15%) ( مجموع الضريبة )" , VerdanaBold, BlackBrush, 260, CurrentY);
                    g.DrawString( _Dbtask.SetintoDecimalpoint(TotalTaxAmount), VerdanaBold, BlackBrush, 470, CurrentY);
                    
                    CurrentY = CurrentY + 16;
                    tcashrecvd =_Dbtask.znlldoubletoobject( _Dbtask.ExecuteScalar("select adamount from tblbusinessissue where vno='" + Billno + "' and ISSUEtype ='POS'")).ToString();
                    ...
                    string samplid = _Dbtask.ExecuteScalar("select agroupid from tblaccountledger where lID='" + Lid + "'");
                    if (samplid == "18" && PrintOldbalance == true)
                    {
                        ...
                        g.DrawString("Old Balance (التوازن القديم)", VerdanaBold, BlackBrush, 260, CurrentY);
                        g.DrawString(oldbalnce.ToString(), VerdanaBold, BlackBrush, 470, CurrentY);
                    ...
                    CurrentY = CurrentY + 16;
                    g.DrawString(" Total Billamount ( مبلغ الفاتورة )" , VerdanaBold, BlackBrush, 260, CurrentY);
                    g.DrawString( _Dbtask.znullDouble(BillAmount).ToString("0.00"), VerdanaBold, BlackBrush, 470, CurrentY);
        ...
        public void setqrtwo(Graphics g)
        {
            ...
            StrQrData = _Gen.FureturnQrValue(_Companymaster.GetspecifField("Sellersname"), _Companymaster.GetspecifField("TRN"), Billno, BillDate, vattot, BillAmount);
            ...
            g.DrawImage(newbit, 20, CurrentY-10);
        ...
        public void PrintTotal(Graphics g)
        {
           // CurrentY = 750;
            if (InvSubTitle5 == "              ESTIMATE INVOICE")
            {
                ...
                g.DrawString(TotalQty, VerdanaBold, BlackBrush, 200, CurrentY);
                g.DrawString(_Dbtask.SetintoDecimalpoint(TotalNetamount), VerdanaBold, BlackBrush, xNetamt + 460, CurrentY, Str);/*For Amount*/
                g.DrawLine(new Pen(Brushes.Black, 1), leftMargin, CurrentY+5, InvoiceWidth, CurrentY+5);
                CurrentY = CurrentY + 20;
            ...
            else
            {
                ...
                g.DrawLine(new Pen(Brushes.Gray, 1),5, CurrentY, 540, CurrentY);
                g.DrawString("Total", VerdanaBoldsmall, BlackBrush, 60, CurrentY);
            }

            if (InvSubTitle5 != "              ESTIMATE INVOICE" && InvSubTitle5 != "           SALES ORDER")
            {
                g.DrawString(TotalQty, VerdanaBoldsmall, BlackBrush, xQty + 20, CurrentY, Str);/*For Qty*///350
                //g.DrawString(TotalItemDisc.ToString(), VerdanaBold, BlackBrush, 490, CurrentY);/*For Discount*/
                g.DrawString(_Dbtask.SetintoDecimalpoint(TotalTaxable), VerdanaBoldsmall, BlackBrush, xTaxable + 45, CurrentY, Str);/*For Taxable*/
                g.DrawString(_Dbtask.SetintoDecimalpoint(TotalTaxAmount), VerdanaBoldsmall, BlackBrush, xTaxAmt + 30, CurrentY, Str);/*For Tax*/

                g.DrawLine(new Pen(Brushes.Gray, 1), 5, CurrentY + 15, 540, CurrentY + 15);

                g.DrawLine(new Pen(Brushes.LightGray, 1), 58, Cln, 58, CurrentY + 15);//230
                g.DrawLine(new Pen(Brushes.LightGray, 1), 250, Cln, 250, CurrentY + 15);
                g.DrawLine(new Pen(Brushes.LightGray, 1), 313, Cln, 313, CurrentY + 15);
                g.DrawLine(new Pen(Brushes.LightGray, 1), 370, Cln, 370, CurrentY + 15);
                g.DrawLine(new Pen(Brushes.LightGray, 1), 425, Cln, 425, CurrentY + 15);
                g.DrawLine(new Pen(Brushes.LightGray, 1), 480, Cln, 480, CurrentY + 15);
            ...
            if (InvSubTitle5 != "              ESTIMATE INVOICE" && InvSubTitle5 != "           SALES ORDER")
            {
                g.DrawString(_Dbtask.SetintoDecimalpoint(TotalNetamount), VerdanaBoldsmall, BlackBrush, xNetamt + 20, CurrentY, Str);/*For Amount*/
                CurrentY = CurrentY + 20;
            }
        }
        ...
        {// Set Invoice Total:
            ...
            CurrentY = CurrentY + (570 - CurrentY);
           // CurrentY = 570;
            string TotalValue;
            PrintTotal(g);
            // g.DrawLine(new Pen(Brushes.Black,1), leftMargin, CurrentY, rightMargin, CurrentY);
            ...
            if (FormType != "     ESTIMATE")
            {
                ...
                g.DrawString(TotalValue, Arialbold, BlackBrush, xTaxable, CurrentY);
            }
            ...
            if (FormType != "     ESTIMATE")
            {
                g.DrawString(TotalValue, Arialnormal, BlackBrush, xTaxable, CurrentY);
            }
            if(Pfooter!="")
