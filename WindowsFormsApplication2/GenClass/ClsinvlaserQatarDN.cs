...
namespace WindowsFormsApplication2
{
...

    {
        ...
        public string shipdate = ""; public string shipvia = "";
...
//      //Console.WriteLine(string.format("The Number: {0} is represented in arabic as: {1}", aNumber, theNumberAsArabicString));
        ...
        private void SetInvoiceHead(Graphics g)
        {
           ...
           //g.DrawString(Address.Replace("\n", ""), VerdanaBold, BlackBrush, (leftlase + 150 ), CurrentY);//x150
            ...
            g.DrawString("DELEVERY NOTE", Arialbold, BlackBrush, rightMargin - 15, CurrentY - 10, Str);//x10
           // g.DrawString("Project", xerofnt, sandlekBrush, 300, CurrentY - 10, Str);//x10
            ...
            g.DrawString("Date", xerofnt2, BlackBrush, 500, CurrentY);//x10
            g.DrawString(BillDate.ToString("dd/MM/yyyy"), xerotermhead, BlackBrush, rightMargin - 15, CurrentY, Str);//x10
            g.DrawString("Name/Address", xerofnt, BlackBrush, 5, CurrentY);//x10
            
            
            g.DrawString("SO No.", xerofnt2, BlackBrush, 500, CurrentY+20);//x10

            g.DrawString(Billno, xerotermhead, BlackBrush, rightMargin - 15, CurrentY+20, Str);//x10

            g.DrawString("Rep " + saleman, xerotermhead, BlackBrush, 500, CurrentY + 40);//x10
            g.DrawString(saleman, xerotermhead, BlackBrush, rightMargin - 15, CurrentY + 40, Str);//x10

            g.DrawString("P.O No. " + saleman, xerotermhead, BlackBrush, 500, CurrentY + 80);//x10
            g.DrawString("", xerotermhead, BlackBrush, rightMargin - 15, CurrentY + 80, Str);//x10

            g.DrawString("FOB " + saleman, xerotermhead, BlackBrush, 500, CurrentY + 100);//x10
            g.DrawString("", xerotermhead, BlackBrush, rightMargin - 15, CurrentY + 100, Str);//x10
           ...
           CurrentY = CurrentY + 15;
            ...
            else
            {
                ...
                CurrentY = CurrentY + 20;
                g.DrawString("Project", xeroleftfnt, BlackBrush, 100, CurrentY);
            Pen selpen = new Pen(Color.Black);
            //CurrentY =150;
            ...
            CurrentY = CurrentY + 20;
            string threestring="";
             threestring = "Ship Date " + shipdate + "                       " + "Ship via " + shipvia ;
           ...
           // CurrentY = CurrentY + 25;
            ...
            Pen selcln = new Pen(Color.Black);
            ...
            g.DrawString("Item", xerofnt, BlackBrush, 5, CurrentY);//x10

            g.DrawString("Description", Verdananormal, BlackBrush, 120, CurrentY);//x100
            g.DrawString("(العنصر)", Verdananormal, BlackBrush, 190, CurrentY);//x100


            g.DrawString("Ordered", xerofnt, BlackBrush, 460, CurrentY);//x451
            g.DrawString("( كمية )", Verdananormal, BlackBrush, 510, CurrentY);//x451

            //g.DrawString("Rate", xerofnt, sandlekBrush, 565, CurrentY);//x500
            //g.DrawString("( معدل )", Verdananormal, sandlekBrush, 600, CurrentY);//x500

            g.DrawString("U/M", xerofnt, BlackBrush, 690, CurrentY);//x700
            ...
            g.DrawLine(new Pen(Brushes.Gray, 1), 120, CurrentY, 120, 776);//758
            g.DrawLine(new Pen(Brushes.Gray, 1), 450, CurrentY, 450, 776);//758
            g.DrawLine(new Pen(Brushes.Gray, 1), 680, CurrentY, 680, 776);//758
        ...
        {// Set Invoice Table:
           ...
           // CurrentY = CurrentY + 400;
            ...
            Pen rowclr = new Pen(Color.Gainsboro );
           ...
           "خمسون", "ستون", "سبعون", "ثمانون", "تسعين" };
            ...
            public String ConvertAmount(double amount)
            {
                try
                {
                    ...
                    ClsinvlaserQatarDN Frms = new ClsinvlaserQatarDN();
        ...
        public void PrintTotal(Graphics g)
        {
            ...
            string lastterm = "";
            lastterm = "* Conﬁrm all the material recived are in good condition before signing.";
            g.DrawString(lastterm, xerotermhead, BlackBrush, 27, CurrentY );
            CurrentY = CurrentY + 15;
            lastterm = "* Conﬁrm the quantity mentioned in delivery note with phycical quantity.";
            g.DrawString(lastterm, xerotermhead, BlackBrush, 27, CurrentY);
            CurrentY = CurrentY + 30;
            lastterm = "For :";
            g.DrawString(lastterm, xerotermhead, BlackBrush, 27, CurrentY);
            ...
            lastterm = "Received Sign....................................";
            g.DrawString(lastterm, xerotermhead, BlackBrush, 550, CurrentY);
