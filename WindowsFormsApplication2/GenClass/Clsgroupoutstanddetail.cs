...
namespace WindowsFormsApplication2
{
    class Clsgroupoutstanddetail
    {
     ...
     //           g.DrawString(InvSubTitle3, Arialbold, BlackBrush, xInvSubTitle1-20, CurrentY);
            ...
            if (FormType == "GroupReportSummury" && head == false)
            {
                CurrentY = 10;
            ...
            if (FormType == "GroupReportSummury")
            {
                ...
                g.DrawString("GroupReportSummury", gothicfnt, BlackBrush, 300, CurrentY);
                CurrentY = CurrentY + 23;
       ...
       //     CurrentY = CurrentY + InvSubTitleHeight + 8;
        ...
        private void SetInvoiceData(Graphics g, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            int xProductName;
            int xRate;
            SolidBrush fillgry = new SolidBrush(Color.Aquamarine);
            Pen selcln = new Pen(Color.Aquamarine);
            ...
            {
                g.DrawString("Party", VerdanaBold2, BlackBrush, 10, CurrentY);
                g.DrawString("Debit", VerdanaBold2, BlackBrush, 450, CurrentY,Str );
                g.DrawString("Credit", VerdanaBold2, BlackBrush, 650, CurrentY);
            ...
            string ItemNote;
            SolidBrush grycln = new SolidBrush(Color.Aquamarine);
            Pen rowclr = new Pen(Color.Aquamarine);
            ...
            if (FormType == "GroupReportSummury")
            {
                    ...
                    for (int i = TRowcounting; i <= MainGrid.Rows.Count - 1; i++)
                    {
                        ...
                        if (TempRowcounting < RecordsPerPage)
                        {
                            ...
                            e.Graphics.DrawString(FieldValue, Verdananormalbld, BlackBrush,450, CurrentY,Str);

                            FieldValue = _dbtask.znllString(MainGrid.Rows[i].Cells["clncredit"].Value);
                            e.Graphics.DrawString(FieldValue, Verdananormalbld, BlackBrush, 650, CurrentY);
           ...
           "Fifty", "Sixty", "Seventy", "Eighty", "Ninety" };
            ...
            public String ConvertAmount(double amount)
            {
                try
                {
                    ...
                    Clsgroupoutstanddetail Frms = new Clsgroupoutstanddetail();
