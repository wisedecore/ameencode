...
{
    class ClsInvThermalSummury
    {
      public  string FieldValue;

      int xRate; bool head = false;
        ...
        private Font Headdetafnttwo = new Font("Lucida Fax", 10, FontStyle.Bold);
        ClsSalesBarcodePrint _BcodePrint = new ClsSalesBarcodePrint();
        private Font Headfnt = new Font("Broadway", 13, FontStyle.Regular);
        private Font Headdetafnt = new Font("Gabriola", 11, FontStyle.Bold);
        ...
        public void RowValidation(DataGridView gridmain)
        {
            try
            {
                ...
                for (int i = 0; i < gridmain.Rows.Count; i++)
                {
                    ...
                    if (InvSubTitle5 != "       Report INVOICE" && FormType != "Salesdaybookcount" && FormType != "Summury Report" && FormType != "Summury ReportA4" && FormType != "Receipt" && FormType != "Payment")
                    {
                    ...
                    {
                        if (FormType == "Salesdaybookcount" && FormType == "Summury Report" && FormType == "Summury ReportA4" && FormType == "Receipt" && FormType == "Payment")
                        {
        ...
        {// Set Invoice Table:
            ...
            if (FormType == "Summury Report" || FormType== "Summury ReportA4")
            {
                 ...
                 else
                 {
                     if (FormType == "Summury ReportA4")
                     {
                         ...
                         g.DrawString(TimeStr, VerdanaBold, BlackBrush, xProductName, CurrentY);
            ...
            if (InvSubTitle5 != "      ESTIMATE" && InvSubTitle5 != "       Report INVOICE" && FormType != "Salesdaybookcount" && FormType != "Summury Report" && FormType != "Summury ReportA4" && FormType != "Receipt" && FormType != "Payment" && FormType != "Salesdaybook")
            {
                xSlno = leftMargin;
                g.DrawString("Sl", VerdanaBold, BlackBrush, xSlno, CurrentY);
            ...
            else
            {
                ...
                //602
                //638
                if (InvSubTitle5 != "       Report INVOICE" && FormType != "Salesdaybookcount" && FormType != "Summury Report" && FormType != "Summury ReportA4" && FormType != "Receipt" && FormType != "Payment" && FormType != "Salesdaybook")
                {
                    xSlno = leftMargin;
                    g.DrawString("Sl", VerdanaBold, BlackBrush, xSlno, CurrentY);
            ...
            // Set Invoice Table:
            if (FormType != "Salesdaybookcount" && FormType != "Summury Report" && FormType != "Receipt" && FormType != "Payment" && FormType != "Salesdaybook" && FormType != "Summury ReportA4")
            {
            ...
            if (InvSubTitle5 == "       Report INVOICE")
            {
                ...
                if (FormType != "Salesdaybookcount" &&FormType !="Summury ReportA4"&& FormType != "Receipt" && FormType != "Payment" && FormType != "Salesdaybook")
                {
