...
namespace WindowsFormsApplication2
{
  ...
  public string LDistrict = "";
        ...
        public void InsertLedgerAzure()
        {
            ...
            _Dbtask.ExecuteNonQueryAzureServer_SP("InsertLedger", objArg);
            return;
        }
        ...
        public string GetspecifFieldAzure(string Field, string Lid)
        {
            SpecificField = _Dbtask.ExecuteScalarAzureServer("select " + Field + " from tblaccountledger where lid='" + Lid + "'");
            return SpecificField;
        }
