...
namespace WindowsFormsApplication2
{
...

    {
        ...
        public void CompanyCreate(string DataBaseNameStr, bool Bak)
        {
            ...
            CreateTableAzureServer();
            CreateProcedureAzureServer();
...
" @bankaccountno,@mstatus,@familydetails,@foodtype,@note,@noteofproof) RETURN END";
          ...
          "(@Uid,@Itemid,@Prate,@Srate,@Mrp,@Wrate,@Wrate1,@Wrate2,@wrate3)  END";
            ...
            sql = "  CREATE PROCEDURE [dbo].[InsertPHASEtwocompanyprofile] " +
                           ...
                           " @ScrtKEY [nvarchar](1000)  " +
                            ...
                            "  AS " +
                            "  BEGIN" +
                            "  insert into   TblPHASEtwocompanyprofile (Workingtype,OTP,CommonName,SerialNumber,firmname,Branchname,countrytext,vatnumber,location,Industry,CSR,PrtKEY,PblKEY,ScrtKEY)" +
                            "  values (@Workingtype,@OTP,@CommonName,@SerialNumber,@firmname,@Branchname,@countrytext,@vatnumber,@location,@Industry,@CSR,@PrtKEY,@PblKEY,@ScrtKEY)" +
                            "  RETURN " +
                            "  END";
            _Dbtask.ExecuteNonQuery(sql);
  ...
  " END";
       ...
       "WHERE ROUTINE_TYPE = 'PROCEDURE' AND ROUTINE_NAME = '" + procedure + "'");
        ...
        public void CreateTableAzureServer()
        {
...
" END";
            ...
            sql = "CREATE TABLE [dbo].[TblAccountLedger](" +
                ...
                "[LDistrict] [nvarchar](500) COLLATE SQL_Latin1_General_CP1_CI_AS NULL, " +
                 ...
                 " [schemeID]  [nvarchar](250) COLLATE SQL_Latin1_General_CP1_CI_AS NULL ," +
                " [StreetName] [nvarchar](250) COLLATE SQL_Latin1_General_CP1_CI_AS NULL ," +
                " [AdditionalStreetName] [nvarchar](250) COLLATE SQL_Latin1_General_CP1_CI_AS NULL ," +
                " [BuildingNumber] [nvarchar](250) COLLATE SQL_Latin1_General_CP1_CI_AS NULL ," +
                " [CountrySubentity] [nvarchar](250) COLLATE SQL_Latin1_General_CP1_CI_AS NULL ," +
                " [CitySubdivisionName]  [nvarchar](250) COLLATE SQL_Latin1_General_CP1_CI_AS NULL ," +
                " [IdentificationCode] [nvarchar](250) COLLATE SQL_Latin1_General_CP1_CI_AS NULL ," +
                " [RegistrationName]  [nvarchar](250) COLLATE SQL_Latin1_General_CP1_CI_AS NULL ," +
                " [CompanyID]  [nvarchar](250) COLLATE SQL_Latin1_General_CP1_CI_AS NULL  " +
        ...
        public void CreateProcedureAzureServer()
        {
            
            if (KnowprocedureexistingAzureServer("Insertunitssrates") == false)
            {
            ...
            if (KnowprocedureexistingAzureServer("Insertarea") == false)
            {
            ...
            if (KnowprocedureexistingAzureServer("InsertPHASEtwocompanyprofile") == false)
            {
            ...
            if (KnowprocedureexistingAzureServer("insertAMCdetails") == false)
            {
           ...
           "(@Amccdkey,@Amcproductid,@Amcregnumber)  END";
            ...
            if (KnowprocedureexistingAzureServer("Inserttaillor") == false)
            {
  ...
  " END";
            ...
            if (KnowprocedureexistingAzureServer("Inserttaillordetails") == false)
            {
            ...
            if (KnowprocedureexistingAzureServer("Insertcolor") == false)
            {
            ...
            if (KnowprocedureexistingAzureServer("Inserticon") == false)
            {
        ...
        "(@xvalue,@yvalue,@icon) END";
            ...
            if (KnowprocedureexistingAzureServer("Insertcommision") == false)
            {
                sql = "CREATE   PROCEDURE [dbo].[Insertcommision] @Cid float, @Cname [nvarchar](50) " +
            ",@Cperc  decimal(18, 5),@Cfromamount  decimal(18, 5), " +
            "@Ctoamount  decimal(18, 5),@Cfor [nvarchar](50) " +
            ...
            /*For Dress Making*/
            if (KnowprocedureexistingAzureServer("Insertdressmaster") == false)
            {
                sql = "CREATE   PROCEDURE [dbo].[Insertdressmaster] @vno float, @Customer float, " +
            "@Vdate datetime,@ddate datetime,@Chest  decimal(18, 5),@Waist  decimal(18, 5), " +
            "@Neck  decimal(18, 5),@Height  decimal(18, 5),@Shapping  decimal(18, 5), " +
            ...
            /*********************************************************/
            if (KnowprocedureexistingAzureServer("Insertattendancemain") == false)
            {
                sql = "create PROCEDURE [dbo].[Insertattendancemain]" +
             "@vno [nvarchar](50)," +
             "@amode float," +
            ...
            if (KnowprocedureexistingAzureServer("Insertattendancedetail") == false)
            {
                sql = "create PROCEDURE [dbo].[Insertattendancedetail]" +
             "@vno [nvarchar](50)," +
             "@slno [nvarchar](50)," +
            ...
            /****************************************************/
            if (KnowprocedureexistingAzureServer("InsertBillsett") == false)
            {
                sql = "create PROCEDURE [dbo].[InsertBillsett] @vno nvarchar (50), @vtype nvarchar (50), @ledcode float, " +
                    " @Dbamt decimal(18,5),@cramt decimal(18,5),@agvno nvarchar(50),@dt datetime,@Emp float " +
                    " AS BEGIN INSERT INTO tblbillsett(vno,vtype,ledcode,dbamt,cramt,agvno,Dt,Emp)  " +
            ...
            if (KnowprocedureexistingAzureServer("InsertRemainder") == false)
            {
                sql = "create PROCEDURE [dbo].[InsertRemainder]" +
                "@Rid float," +
                "@Rname [nvarchar](50)," +
            ...
            if (KnowprocedureexistingAzureServer("Insertpartyproject") == false)
            {
                sql = "create PROCEDURE [dbo].[Insertpartyproject]" +
                "@pid float," +
                "@pname [nvarchar](50)," +
            ...
            if (KnowprocedureexistingAzureServer("Insertpricecode") == false)
            {
                sql = "create PROCEDURE [dbo].[Insertpricecode]" +
                    "@field [nvarchar](50)," +
                    "@code [nvarchar](50)" +
            ...
            if (KnowprocedureexistingAzureServer("Insertchequereceived") == false)
            {
                sql = "create PROCEDURE [dbo].[Insertchequereceived]" +
                      "@Id float," +
                      "@Pdate datetime," +
            ...
            if (KnowprocedureexistingAzureServer("InsertUnitcreation") == false)
            {
                sql = "create PROCEDURE [dbo].[InsertUnitcreation]" +
               "@Id float," +
               "@Name nvarchar(200)," +
            ...
            if (KnowprocedureexistingAzureServer("InsertBaseunit") == false)
            {
                sql = "create PROCEDURE [dbo].[InsertBaseunit]" +
               "@Id float," +
               "@Name nvarchar(200)" +
            ...
            /*For VoucherType*/
            if (KnowprocedureexistingAzureServer("InsertVoucherType") == false)
            {
                sql = "create PROCEDURE [dbo].[InsertVoucherType]" +
                "@Vname nvarchar(200)," +
                "@UndrVouchr nvarchar(200)," +
            ...
            if (KnowprocedureexistingAzureServer("InsertMenus") == false)
            {
                sql = "create PROCEDURE [dbo].[InsertMenus]" +
            "@id float," +
            "@MenuName [nvarchar](200)" +
            ...
            if (KnowprocedureexistingAzureServer("Insertrepacking") == false)
            {
                sql = "create PROCEDURE [dbo].[Insertrepacking]" +
            "@VNo float," +
            "@VDate datetime," +
            ...
            /*For RepackingDetails*/
            /*For RepackingDetails*/
            if (KnowprocedureexistingAzureServer("Insertrepackingdetails") == false)
            {
                sql = "create PROCEDURE [dbo].[Insertrepackingdetails]" +
            "@Vno float," +
            "@SlNo nvarchar(50)," +
            ...
            /*For  /*For TempContacts */
            if (KnowprocedureexistingAzureServer("Inserttempcontact") == false)
            {
                sql = "create PROCEDURE [dbo].[Inserttempcontact]" +
        " @tid float," +
        " @tname nvarchar(50)," +
        ...
        " END";
            ...
            if (KnowprocedureexistingAzureServer("Insertslnotracking") == false)
            {
                sql = "CREATE PROCEDURE [dbo].[Insertslnotracking]" +
            " @itemid float," +
            " @Slno  nvarchar(50)," +
            ...
            /*For Customer Point*/
            if (KnowprocedureexistingAzureServer("Insertcustomerpoint") == false)
            {
                sql = "CREATE PROCEDURE [dbo].[Insertcustomerpoint]" +
            " @cpid float," +
            " @cardname  nvarchar(50)," +
            ...
            /*For Size Detail*/
            if (KnowprocedureexistingAzureServer("Insertsizesdetail") == false)
            {
                sql = "CREATE PROCEDURE [dbo].[Insertsizesdetail]" +
           " @ItemSizename nvarchar(50)," +
           " @Sname  nvarchar(50)" +
           ...
           " END";
            ...
            /*For Size*/
            if (KnowprocedureexistingAzureServer("Insertsizes") == false)
            {
                sql = "CREATE PROCEDURE [dbo].[Insertsizes]" +
            " @Sid float," +
            " @Sname  nvarchar(50)," +
            ...
            /*Production Product Sett*/
            if (KnowprocedureexistingAzureServer("Insertproductsett") == false)
            {
                sql = "CREATE PROCEDURE [dbo].[Insertproductsett]" +
            " @id float," +
            " @Bcode nvarchar(50)," +
            ...
            if (KnowprocedureexistingAzureServer("Insertproductsettdetail") == false)
            {
                sql = "CREATE PROCEDURE [dbo].[Insertproductsettdetail]" +
            " @id float," +
            " @slno float," +
            ...
            /*Production Issue Product*/
            if (KnowprocedureexistingAzureServer("Insertissueproduct") == false)
            {
                sql = "CREATE PROCEDURE [dbo].[Insertissueproduct]" +
            " @vno float," +
            " @employee float," +
            ...
            if (KnowprocedureexistingAzureServer("Insertissueproductdetail") == false)
            {
                sql = "CREATE PROCEDURE [dbo].[Insertissueproductdetail]" +
            " @issueid float," +
            " @slno float," +
            ...
            " END";
                ...
                if (KnowprocedureexistingAzureServer("Insertreceivedproductdetail") == false)
                {
                    sql = "CREATE PROCEDURE [dbo].[Insertreceivedproductdetail]" +
            " @id float," +
            " @slno float," +
            ...
            " END";
                ...
                /******************************************************************************/
                /*Insert AccountGroup*/
                if (KnowprocedureexistingAzureServer("InsertAccount") == false)
                {
                    sql = "CREATE PROCEDURE [dbo].[InsertAccount]" +
            " @AGroupId float," +
            " @AGroupName nvarchar(50)," +
            ...
            " END";
                ...
                if (KnowprocedureexistingAzureServer("InsertAgent") == false)
                {
                    sql = "CREATE PROCEDURE [dbo].[InsertAgent]" +
            " @Aid float," +
            " @Aname nvarchar (50)," +
            ...
            " END";
                ...
                //" @cpdiscount nvarchar(50)," +
                //" @Mpayment nvarchar(50)" +
                if (KnowprocedureexistingAzureServer("InsertBusinessIssue") == false)
                {
                    sql = "create PROCEDURE [dbo].[InsertBusinessIssue]" +
            " @opno int," +
            " @IssueCode float," +
            ...
            " END";
                ...
                /*Insert CompanyMaster*/
                if (KnowprocedureexistingAzureServer("Insertcompanymaster") == false)
                {
                    sql = "create  PROCEDURE [dbo].[Insertcompanymaster]" +
                           " @cname nvarchar(50)," +
                           " @tax int ," +
                ...
                /*Insert Department*/
                if (KnowprocedureexistingAzureServer("InsertDepartment") == false)
                {
                    sql = "CREATE PROCEDURE [dbo].[InsertDepartment]" +
            " @Depid float," +
            " @Depname nvarchar (50)" +
            ...
            " END";
                ...
                /*Insert Depot*/
                if (KnowprocedureexistingAzureServer("InsertDepot") == false)
                {
            ...
            " END";
                ...
                /*Insert Employeemaster*/
                if (KnowprocedureexistingAzureServer("InsertEmployeeMaster") == false)
                {
            ...
            " END";
                ...
                if (KnowprocedureexistingAzureServer("InsertGeneralLedger") == false)
                {
                    sql = "CREATE PROCEDURE [dbo].[InsertGeneralLedger]" +
            " @vdate datetime," +
            " @vtype nvarchar (50)," +
            ...
            " END";
                ...
                /*Insert Interneltransfer*/
                if (KnowprocedureexistingAzureServer("InsertInternelTransfer") == false)
                {
                    sql = "CREATE PROCEDURE [dbo].[InsertInternelTransfer]" +
            " @TCode float," +
            " @Dcodefrom int," +
            ...
            " END";
                ...
                /*Insert Inventory*/
                if (KnowprocedureexistingAzureServer("InsertInventory") == false)
                {
            ...
            " END";
                ...
                /*Insert Issuedetails*/
                if (KnowprocedureexistingAzureServer("InsertIssueDetails") == false)
                {
                    sql = "create PROCEDURE [dbo].[InsertIssueDetails]" +
            " @IssueCode float," +
            " @Slno float," +
            ...
            " END";
                ...
                /*Insert ItemCategory*/
                if (KnowprocedureexistingAzureServer("InsertItemCategory") == false)
                {
                    sql = "CREATE PROCEDURE [dbo].[InsertItemCategory]" +
            " @CategoryId float," +
            " @Category nvarchar(50)," +
            ...
            " END";
                ...
                /*Insert Itemmaster*/
                if (KnowprocedureexistingAzureServer("InsertItemMaster") == false)
                {
            ...
            " END";
                ...
                /*Insert Ledger*/
                if (KnowprocedureexistingAzureServer("InsertLedger") == false)
                {
                    sql = "create PROCEDURE [dbo].[InsertLedger]" +
            " @Lid float," +
            " @Lname nvarchar(150)," +
            ...
            " END";
                ...
                if (KnowprocedureexistingAzureServer("InsertManufacturer") == false)
                {
                    sql = "CREATE PROCEDURE [dbo].[InsertManufacturer]" +
            " @Mid float," +
            " @MName nvarchar (50)," +
            ...
            " END";
                ...
                if (KnowprocedureexistingAzureServer("InsertMultirates") == false)
                {
                    sql = "CREATE PROCEDURE [dbo].[InsertMultirates]" +
            " @RateId float," +
            " @Ratename nvarchar (50)," +
            ...
            " END";
                ...
                /*Insert multiUnit*/
                if (KnowprocedureexistingAzureServer("InsertMultiunits") == false)
                {
                    sql = "CREATE PROCEDURE [dbo].[InsertMultiunits]" +
            " @UnitId float," +
            " @Base nvarchar (50)," +
            ...
            " END";
                ...
                /*Insert ProductRate*/
                if (KnowprocedureexistingAzureServer("InsertProductrate") == false)
                {
                    sql = "CREATE PROCEDURE [dbo].[InsertProductrate]" +
            " @Pcode nvarchar(50)," +
            " @Unitid float," +
            ...
            " END";
                ...
                /*Insert Receipt Details*/
                if (KnowprocedureexistingAzureServer("InsertReceiptDetails") == false)
                {
                    sql = "Create PROCEDURE [dbo].[InsertReceiptDetails]" +
                           " @RecptCode float," +
                           " @Slno float," +
                ...
                /*Insert SAGroup*/
                if (KnowprocedureexistingAzureServer("InsertSagroup") == false)
                {
                    sql = "CREATE PROCEDURE [dbo].[InsertSagroup]" +
            " @Gid float," +
            " @Gname nvarchar (50)," +
            ...
            " END";
                ...
                if (KnowprocedureexistingAzureServer("InsertSlabMaster") == false)
                {
                    sql = "CREATE PROCEDURE [dbo].[InsertSlabMaster]" +
            " @Slid float," +
            " @Slname nvarchar(50)," +
            ...
            " END";
                ...
                if (KnowprocedureexistingAzureServer("InsertTransactionReceipt") == false)
                {
                    sql = "Create PROCEDURE [dbo].[InsertTransactionReceipt]" +
                   " @ReptCode float," +
                   " @Vno nvarchar(50)," +
                ...
                if (KnowprocedureexistingAzureServer("InsertTransferDetails") == false)
                {
                    sql = "CREATE PROCEDURE [dbo].[InsertTransferDetails]" +
            " @TCode float," +
            " @Slno int," +
            ...
            " END";
                ...
                if (KnowprocedureexistingAzureServer("InsertUserdetails") == false)
                {
                    sql = "CREATE PROCEDURE [dbo].[InsertUserdetails]" +
                "@userid float," +
                "@username nvarchar(50)," +
                ...
                if (KnowprocedureexistingAzureServer("InsertBatch") == false)
                {
                    sql = "create PROCEDURE [dbo].[InsertBatch] " +
                         " @bcode nvarchar(50), " +
                         " @itemid nvarchar (50)," +
                ...
                if (KnowprocedureexistingAzureServer("UpdateParamList") == false)
                {
                    sql = "CREATE PROCEDURE [dbo].[UpdateParamList]" +
             "  @paramname nvarchar(50)," +
             "  @paramtype nvarchar(50)," +
             ...
             "  END";
                ...
                if (KnowprocedureexistingAzureServer("InsertParamlist") == false)
                {
                    sql = "CREATE PROCEDURE [dbo].[InsertParamlist] " +
                 "  @paramname nvarchar(50)," +
                 "  @paramtype nvarchar(50)," +
                ...
                if (KnowprocedureexistingAzureServer("Insertmnusettings") == false)
                {
                    sql = "CREATE PROCEDURE [dbo].[Insertmnusettings]" +
                 "   @Menuid float," +
                 "	@MenuName nvarchar(50)," +
                ...
                if (KnowprocedureexistingAzureServer("Insertauditlog") == false)
                {
                    sql = "create PROCEDURE [Insertauditlog] @mdate datetime, @userid nvarchar (50), @computername nvarchar(50), " +
                "@actiontype nvarchar(30),@actiontype1 nvarchar(30), @mformname nvarchar(50), @description nvarchar(200)," +
                "@olddata nvarchar(200), @newdata nvarchar(200) " +
      ...
      //          _Dbtask.ExecuteNonQuery(sql);
      //      }
            sql = " SELECT count(*) from tbluserdetails";
