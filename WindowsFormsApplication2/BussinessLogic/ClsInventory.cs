...
namespace WindowsFormsApplication2
{
   ...
   //         _Dbtask.ExecuteNonQueryAzureServer_SP("InsertInventory", objArg);
        ...
        public void InsertInventoryAzureServer()
        {
            object[,] objArg = new object[28, 2]
        {
            {"@Dcode",DCodeStr},
        ...
        public DataTable GetInventoryDataTable()
        {
            ...
            dtInventory.Columns.Add("DCode", typeof(string));
            dtInventory.Columns.Add("InvDate", typeof(DateTime));
            dtInventory.Columns.Add("PCode", typeof(string));
            dtInventory.Columns.Add("Os", typeof(decimal));
            dtInventory.Columns.Add("Purchase", typeof(decimal));
            dtInventory.Columns.Add("Mr", typeof(decimal));
            dtInventory.Columns.Add("Sr", typeof(decimal));
            dtInventory.Columns.Add("Ireceipt", typeof(decimal));
            dtInventory.Columns.Add("bmr", typeof(decimal));
            dtInventory.Columns.Add("Sales", typeof(decimal));
            dtInventory.Columns.Add("ps", typeof(decimal));
            dtInventory.Columns.Add("dn", typeof(decimal));
            dtInventory.Columns.Add("pr", typeof(decimal));
            dtInventory.Columns.Add("iissue", typeof(decimal));
            dtInventory.Columns.Add("sh", typeof(decimal));
            dtInventory.Columns.Add("Dnr", typeof(decimal));
            dtInventory.Columns.Add("dmg", typeof(decimal));
            dtInventory.Columns.Add("bmi", typeof(decimal));
            dtInventory.Columns.Add("freepre", typeof(decimal));
            dtInventory.Columns.Add("freeiss", typeof(decimal));
            dtInventory.Columns.Add("Vcode", typeof(string));
            dtInventory.Columns.Add("Ledcode", typeof(string));
            dtInventory.Columns.Add("costcenter", typeof(string));
            dtInventory.Columns.Add("batchcode", typeof(string));
            dtInventory.Columns.Add("Slno", typeof(string));
            dtInventory.Columns.Add("UC", typeof(decimal));
            dtInventory.Columns.Add("Exdate", typeof(DateTime));
            dtInventory.Columns.Add("Vtype", typeof(string));
