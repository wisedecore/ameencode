    ...
    class ClsUserDetails
    {
       ...
       // public  DataSet Ds=new DataSet();
        ...
        public void InserUserAzure()
        {
            ...
            _Dbtask.ExecuteNonQueryAzureServer_SP("InsertUserdetails", objArg);
        }
        ...
        public long GetUserIdAzure()
        {
            UserId = Convert.ToInt64(Generalfunction.getnextidAzure("userid", "tbluserdetails"));
            return UserId;
        }
