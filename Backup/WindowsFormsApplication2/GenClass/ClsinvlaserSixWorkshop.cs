                    ...
                    if (TempRowcounting < RecordsPerPage)
                    {
                        ...
                        if (InvSubTitle5 != "DELIVERY NOTE INVOICE")
                        {
                            if (isarbicdotprint == true)
                            {
                                ...
                                g.DrawString(FieldValue, Verdananormal, BlackBrush, (leftlase + 490), CurrentY, Str);//x490
                                ...
                                g.DrawString(FieldValue, Verdananormal, BlackBrush, (leftlase + 560), CurrentY, Str);//x560
           ...
           "خمسون", "ستون", "سبعون", "ثمانون", "تسعين" };
            ...
            public String ConvertAmount(double amount)
            {
                try
                {
                    ...
                    ClsinvlaserSixWorkshop Frms = new ClsinvlaserSixWorkshop();
