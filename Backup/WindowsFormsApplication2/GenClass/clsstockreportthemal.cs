...
{
    class clsstockreportthemal
    {
        int hx = 5;
      public  string FieldValue;
      private string InvImageheadrr;
      int xRate; public string StrNaration = "";
        int xProductName = new int();
        public double SUmNetAmt = 0; public double SUmqty = 0;
        public double SumSrate = 0; public double Sumgrss = 0;
        int XGrossAmt;
        public bool PrintBarcodeLaser;
        /*For Settings*/
        string Cst = ""; public string saleNarration = "";
        ...
        string NameInHome = ""; public string headersett = "";
        ...
        private Font Fonthead = new Font("Broadway", 16, FontStyle.Regular);
        private Font Fontheadtwo = new Font("Goudy Old Style", 12, FontStyle.Bold);
        private Font Fontheadthree = new Font("French Script MT", 12, FontStyle.Bold);
        private Font Fontheadfour = new Font("Goudy Old Style", 10, FontStyle.Bold);
        private Font Fontheadfive = new Font("Goudy Old Style", 8, FontStyle.Bold);
        ...
        private Font VerdanaBoldHeadingMain3 = new Font("Open Sans ExtraBold", 13, FontStyle.Bold);
        ...
        private Font CalibiRiItalic = new Font("Verdana", 9, FontStyle.Italic);
        ...
        private void SetInvoiceHead(Graphics g)
        {
            ...
            if (System.IO.File.Exists(InvImage))
            {
                ...
                ImageHeight = 0;
                g.DrawImage(oInvImage, 10, 5, 750, 110);
            ...
            if (FormType == "StockReport A4")
            {
                ...
                {
                CurrentY = 0;
                SolidBrush silvry = new SolidBrush(Color.Silver);
                SolidBrush grycln = new SolidBrush(Color.Gainsboro);
                Pen rowclr = new Pen(Color.LightCyan);

                Rectangle rowrect = new Rectangle(0, CurrentY, 850, 40);
                g.DrawRectangle(rowclr, rowrect);
                g.FillRectangle(silvry, rowrect);




                g.DrawString(InvTitle, Fonthead, BlackBrush, 300, CurrentY + 10);
                CurrentY = CurrentY + 40;

                Rectangle rowrect1 = new Rectangle(0, CurrentY, 850, 22);
                g.DrawRectangle(rowclr, rowrect1);
                g.FillRectangle(grycln, rowrect1);


                g.DrawString(InvSubTitle1, Fontheadtwo, BlackBrush, 10, CurrentY);

                CurrentY = CurrentY + 25;
                Rectangle rowrect2 = new Rectangle(0, CurrentY, 400, 35);
                g.DrawRectangle(rowclr, rowrect2);
                g.FillRectangle(grycln, rowrect2);

                Rectangle rowrect3 = new Rectangle(403, CurrentY, 500, 35);
                g.DrawRectangle(rowclr, rowrect3);
                g.FillRectangle(grycln, rowrect3);


                g.DrawString(InvSubTitle3, Fontheadtwo, BlackBrush, 10, CurrentY + 10);

                FieldValue = _Companymaster.GetspecifField("Mobile");//Kerala
                g.DrawString("Mobile  : " + FieldValue, Fontheadtwo, BlackBrush, 750, CurrentY + 10, Str);


                CurrentY = CurrentY + 35;
                Rectangle rowrect4 = new Rectangle(0, CurrentY, 400, 30);
                g.DrawRectangle(rowclr, rowrect4);
                g.FillRectangle(grycln, rowrect4);

                Rectangle rowrect5 = new Rectangle(403, CurrentY, 500, 30);
                g.DrawRectangle(rowclr, rowrect5);
                g.FillRectangle(grycln, rowrect5);

                }
                CurrentY = CurrentY + 30;
                g.DrawString(DateStr, Fontheadtwo, BlackBrush, 10, CurrentY + 10);
                g.DrawString(TimeStr, Fontheadtwo, BlackBrush, 750, CurrentY + 10, Str);

                CurrentY = CurrentY + 30;
                g.DrawString("STOCK REPORT", VerdanaBoldHeadingMain, BlackBrush, 300, CurrentY);
                ...
                //if (InvTitle != "")
                //{
                //    g.DrawString(InvTitle, VerdanaBoldHeadingMain, BlackBrush, 300, CurrentY);
                ...
                //if (InvSubTitle1 != "")
                //{
                //    g.DrawString(InvSubTitle1, AmountInwordsfont, BlackBrush, 300, CurrentY);
                //    CurrentY = CurrentY + 23;
                
                //}
                //if (InvSubTitle3 != "")
                //{
                //    g.DrawString("VAT: " + InvSubTitle3, AmountInwordsfont, BlackBrush, 300, CurrentY);
                //    CurrentY = CurrentY + 23;
            ...
            if (FormType == "StockReport")
            {
                if (InvTitle != "")
                {
                   
                    g.DrawString(InvTitle, VerdanaBoldHeadingMain, BlackBrush, 20, CurrentY);

                    CurrentY = CurrentY + 23;
                }
                if (NameInHome != "")
                {
                    g.DrawString(NameInHome, VerdanaBold, BlackBrush, 20, CurrentY);
                    CurrentY = CurrentY + 23;
                }
                    if (InvSubTitle1 != "")
                    {
                g.DrawString(InvSubTitle1, AmountInwordsfont, BlackBrush, 20, CurrentY);
                CurrentY = CurrentY + 23;
                    ...
                    if (InvSubTitle3 != "")
                    {
                        g.DrawString("VAT: "+InvSubTitle3, AmountInwordsfont, BlackBrush, 20, CurrentY);
                        CurrentY = CurrentY + 23;
            ...
            if (InvTitle != "" && FormType != "     SALES ORDER" && FormType != "Purchase Order" && FormType != "SALES QUATATION")/*For Company Heading*/
            {
                ...
                //CurrentX = (300 - (int)g.MeasureString(InvTitle, VerdanaBoldHeadingMain).Width) / 2;
                //g.DrawString(InvTitle, VerdanaBoldHeadingMain, BlackBrush, CurrentX, CurrentY);
                //CurrentY = CurrentY + 23;
            }
            if (NameInHome != "")
            {
                //CurrentX = (300 - (int)g.MeasureString(NameInHome, VerdanaBoldHeadingMain).Width) / 2;
                //g.DrawString(NameInHome, VerdanaBoldHeadingMain, BlackBrush, CurrentX, CurrentY);
                //CurrentY = CurrentY + 25;
            }
                if (InvSubTitle1 != "" && FormType != "     SALES ORDER" && FormType != "Purchase Order" && FormType != "SALES QUATATION")/*For Address*/
            {

                CurrentX = (300 - (int)g.MeasureString(InvSubTitle1, AmountInwordsfont).Width) / 2;
                //g.DrawString(InvSubTitle1, AmountInwordsfont, BlackBrush, CurrentX, CurrentY);
                //CurrentY = CurrentY ;
            }
            ...
            if (InvSubTitle3 != "" && FormType != "     SALES ORDER" && FormType != "Purchase Order" && FormType != "SALES QUATATION")/*VAt Number*/
            {
            ...
            if (FormType == "Sales Return")
            {
                ...
                //CurrentX = (300 - (int)g.MeasureString(NameInHome, VerdanaBoldHeadingMain).Width) / 2;
                //g.DrawString(" عائد المبيعات ", VerdanaBoldHeadingMain, BlackBrush, CurrentX, CurrentY);
                //CurrentY = CurrentY + 10;
            }
            ...
            //g.DrawString("فاتورة ضریبیة المبسطة", arbHead, BlackBrush, 40, CurrentY);
            // CurrentY = CurrentY + 7;
            ...
            if (InvSubTitle5 != "")
            {
                //g.DrawString(InvSubTitle5, arbHead, BlackBrush, 40, CurrentY);
            }
            else
            {


                //g.DrawString("Simplified Tax Invoice", arbHead, BlackBrush, 40, CurrentY);
            }
        ...
        private void SetOrderData(Graphics g)
        {
            ...
            //FieldValue = ":رقم الفاتورة";
            //g.DrawString(FieldValue, VerdanaBold, BlackBrush, 100, CurrentY);
            //g.DrawString(Billno, VerdanaBold, BlackBrush, 3, CurrentY);

            // CurrentY = CurrentY + 16;
            //FieldValue = ":التاريخ";

            if (FormType != "Purchase A4" && FormType != "StockReport A4")
            {

                g.DrawString("STOCK REPORT", VerdanaBoldHeadingMain, BlackBrush, 60, CurrentY);
                CurrentY = CurrentY + 25;
                
                g.DrawString("Date: "+DateStr, VerdanaBold, BlackBrush, 0, CurrentY);
           
           CurrentY = CurrentY + 16;

            g.DrawString(TimeStr, VerdanaBold, BlackBrush, 0, CurrentY);
            ...
            if (FormType == "StockReport A4")
            {
                ...
                //g.DrawString("Date: " + DateStr, VerdanaBold, BlackBrush, 20, CurrentY);

               

               
            }
            //g.DrawString(BillDate.ToString("hh:mm:ss"), Verdananormal, BlackBrush, 170, CurrentY);

            //g.DrawString(":دفع", VerdanaBold, BlackBrush, 100, CurrentY);
            //g.DrawString(ModeofPayment, Verdananormal, BlackBrush, 3, CurrentY);
            //string CName = "";
            // CName = TempCust;
            //if (CName!="")
            //{
            //CurrentY = CurrentY + 15;
            //g.DrawString(CName + ":  "+"اسم", Verdananormal, BlackBrush, 270,CurrentY,Str);
            //}
            ...
            //{
            //    CurrentY = CurrentY + 15;
            //    g.DrawString(CTin + ":   " + "ظريبه الشراء", Verdananormal, BlackBrush, 270, CurrentY,Str);
            //}
            //string mob = "";
            ...
            //{
            //    CurrentY = CurrentY + 15;
            //    g.DrawString(mob + ":  " + "اتصال", Verdananormal, BlackBrush, 270, CurrentY,Str);
            //}
            //string email = "";
            ...
            //{
            //    CurrentY = CurrentY + 15;
            //    g.DrawString(email + ":   " + "عنوان الايميل", Verdananormal, BlackBrush, 270, CurrentY,Str);
            //}
            ...
            //{
            //    CurrentY = CurrentY + 15;
            //    g.DrawString("عنوان", Verdananormal, BlackBrush, 3, CurrentY);
            //}
           ...
           // CurrentY = CurrentY + 20;
            ...
            if (FormType == "Purchase")
            {
                ...
                g.DrawString("Vno", VerdanaBold, BlackBrush, 0, CurrentY);
                g.DrawString("Qty", VerdanaBold, BlackBrush, 120, CurrentY);
                g.DrawString("Tax", VerdanaBold, BlackBrush,170, CurrentY);
                g.DrawString("Amount", VerdanaBold, BlackBrush, 270, CurrentY,Str);
            ...
            if (FormType == "StockReport A4")
            {
                ...
                g.DrawString("Barcode", VerdanaBold, BlackBrush, 0, CurrentY-20);
                g.DrawString("Item Name", VerdanaBold, BlackBrush, 150, CurrentY-20);
                g.DrawString("Qty", VerdanaBold, BlackBrush, 400, CurrentY - 20);
                g.DrawString("Rate", VerdanaBold, BlackBrush, 600, CurrentY - 20, Str);
                g.DrawString("Amount", VerdanaBold, BlackBrush, 750, CurrentY - 20, Str);

                //g.DrawString("Rate", VerdanaBold, BlackBrush, 590, CurrentY);
                //g.DrawString("Amount", VerdanaBold, BlackBrush, 750, CurrentY, Str);
                //g.DrawString("QTY", VerdanaBold, BlackBrush, 270, CurrentY, Str);
            ...
            } if (FormType == "StockReport")
            {
                ...
                g.DrawString("Barcode", VerdanaBold, BlackBrush, 0, CurrentY);
                g.DrawString("Qty", VerdanaBold, BlackBrush, 120, CurrentY);
                g.DrawString("Rate", VerdanaBold, BlackBrush, 170, CurrentY);
                g.DrawString("Amount", VerdanaBold, BlackBrush, 270, CurrentY, Str);
            }
            if (FormType == "WHOLESALE")
            {
        ...
        public void RowValidation(DataGridView gridmain)
        {
            try
            {
                if (FormType != "StockReport" && FormType != "StockReport A4")
                {
                    ValidRecord = 0;
        ...
        {// Set Invoice Table:
           ...
           // CurrentY = CurrentY+10 ;
            ...
            if (InvSubTitle5 != "      ESTIMATE" && FormType != "Purchase" && FormType != "Purchase A4")
           
            {
                //xSlno = leftMargin;
                //xProductName = xSlno + (int)g.MeasureString("SlN", VerdanaBold).Width;
                //xQty = xProductName + (int)g.MeasureString("ProductName", VerdanaBold).Width + 35;
                //xRate = xQty + (int)g.MeasureString("Qty", VerdanaBold).Width + 30;
                //xNetamt = xRate + (int)g.MeasureString("Rate", VerdanaBold).Width + 35;
                ...
                xRate = 50;
                xNetamt = leftMargin;
                if ( _Dbtask.ExecuteScalar("select paramvalue from tblparamlist where paramname='language'").ToString() == "Arabic")
                {

                    g.DrawString("التسلسل", VerdanaBold, BlackBrush, 240, CurrentY);
                    g.DrawString("الصنف", VerdanaBold, BlackBrush, 200, CurrentY);
                    g.DrawString("الكمية", VerdanaBold, BlackBrush, 130, CurrentY);      //Qt
                    g.DrawString("السعر", VerdanaBold, BlackBrush, 50, CurrentY); //rate
                    g.DrawString("المجموع", VerdanaBold, BlackBrush, leftMargin + 5, CurrentY);
                ...
                else
                {
                  ...
                  //  g.DrawString("Barcode",VerdanaBold,);
            ...
            else
            {
                ...
                //602
                //638
                if (FormType != "Purchase" && FormType != "Purchase A4")
            ...
            if (FormType == "StockReport A4")
            {
                CurrentY = CurrentY;
                RecordsPerPage = 53;
                g.DrawLine(new Pen(Brushes.Black, 1), leftMargin, CurrentY-10, 800, CurrentY-10);
                CurrentY = CurrentY +  8;
                g.DrawLine(new Pen(Brushes.Black, 1), leftMargin, CurrentY, 800, CurrentY);
            }
            ...
            for (int i = TRowcounting; i <= MainGrid.Rows.Count - 1; i++)
            {
                ...
                if (_Dbtask.znllString(MainGrid.Rows[i].Cells["Barcode"].Value) != "")
                {
                    string colmn = "";

                    if (MainGrid.Columns[4].Name == "prate")
                    {
                        colmn = "prate";
                    }
                    if (MainGrid.Columns[4].Name == "crate")
                    {
                        colmn = "crate";
                    }
                    if (MainGrid.Columns[4].Name == "srate")
                    {
                        colmn = "srate";
                    }

                    FieldValue = _Dbtask.znllString(MainGrid.Rows[i].Cells["Barcode"].Value);
                        e.Graphics.DrawString(FieldValue, VerdanaBold, BlackBrush, xSlno, CurrentY);

                        

                    FieldValue = String.Format("{0:0.}", _Dbtask.gridnul(MainGrid.Rows[i].Cells["qty"].Value));
                    e.Graphics.DrawString(FieldValue, VerdanaArabic, BlackBrush, 120, CurrentY);
           SUmqty = SUmqty + CommonClass._Dbtask.znlldoubletoobject(FieldValue);




                    FieldValue = String.Format("{0:0.00}", _Dbtask.gridnul(MainGrid.Rows[i].Cells[colmn].Value));
                    e.Graphics.DrawString(FieldValue, VerdanaArabic, BlackBrush, 170, CurrentY);
                    SumSrate = SumSrate + CommonClass._Dbtask.znlldoubletoobject(FieldValue);



                    FieldValue = String.Format("{0:0.00}", _Dbtask.gridnul(MainGrid.Rows[i].Cells["Amount"].Value));
                    e.Graphics.DrawString(FieldValue, VerdanaArabic, BlackBrush, 270, CurrentY,Str);
                   SUmNetAmt = SUmNetAmt + CommonClass._Dbtask.znlldoubletoobject(FieldValue);
                    ...
                    //e.Graphics.DrawString(FieldValue, VerdanaBold, BlackBrush, 0, CurrentY);

                    FieldValue = _Dbtask.znllString(MainGrid.Rows[i].Cells["Item Name"].Value);
                    e.Graphics.DrawString(FieldValue, Declarationfont, BlackBrush, 270, CurrentY, Str);
                    ...
                    CurrentY = CurrentY + 8;//35
                    FieldValue = "------------------------------------------------";
                    e.Graphics.DrawString(FieldValue, CalibiRiItalic, BlackBrush, 0, CurrentY);
                    CurrentY = CurrentY + 15;
                    // * 2+4
                    ...
                    if (TempRowcounting < RecordsPerPage)
                    {
                        if (_Dbtask.znllString(MainGrid.Rows[i].Cells["Barcode"].Value) != "")
                        {
                          ...
                          //  FieldValue = FieldValue.Substring(0, 10);
                            ...
                            {
                                FieldValue = FieldValue.Substring(0, 44);
                            }
                            
                            e.Graphics.DrawString(FieldValue, VerdanaBold, BlackBrush,380, CurrentY,Str);


                            FieldValue = _Dbtask.znllString(MainGrid.Rows[i].Cells["Qty"].Value);
                            e.Graphics.DrawString(FieldValue, Declarationfont, BlackBrush, 400, CurrentY);
                            SUmqty = SUmqty + CommonClass._Dbtask.znlldoubletoobject(FieldValue);


                            FieldValue = String.Format("{0:0.00}", _Dbtask.gridnul(MainGrid.Rows[i].Cells[colmn].Value));
                            e.Graphics.DrawString(FieldValue, VerdanaArabic, BlackBrush, 600, CurrentY,Str);
                           // SUmqty = SUmqty + CommonClass._Dbtask.znlldoubletoobject(FieldValue);
                            ...
                            //FieldValue = String.Format("{0:0.00}", _Dbtask.gridnul(MainGrid.Rows[i].Cells["Amount"].Value));
                            //e.Graphics.DrawString(FieldValue, VerdanaArabic, BlackBrush,550, CurrentY,Str);
                            //SumSrate = SumSrate + CommonClass._Dbtask.znlldoubletoobject(FieldValue);


                            //FieldValue = String.Format("{0:0.00}", _Dbtask.gridnul(MainGrid.Rows[i].Cells["gross"].Value));
                            //e.Graphics.DrawString(FieldValue, VerdanaArabic, BlackBrush, 600, CurrentY);
                            //Sumgrss = Sumgrss + CommonClass._Dbtask.znlldoubletoobject(FieldValue);


                            FieldValue = String.Format("{0:0.00}", _Dbtask.gridnul(MainGrid.Rows[i].Cells["Amount"].Value));
                            e.Graphics.DrawString(FieldValue, VerdanaArabic, BlackBrush,750, CurrentY, Str);
                            SUmNetAmt = SUmNetAmt + CommonClass._Dbtask.znlldoubletoobject(FieldValue);
           ...
           "Fifty", "Sixty", "Seventy", "Eighty", "Ninety" };
            ...
            public String ConvertAmount(double amount)
            {
                try
                {
                    ...
                    clsstockreportthemal Frms = new clsstockreportthemal();
        ...
        public void VatPrinting(Graphics g)
        {
            ...
            g.DrawString(FieldValue, VerdanaBoldHeadingMain2, BlackBrush, xProductName, CurrentY, Str);

            FieldValue = TotalTaxable.ToString("0.00");
            g.DrawString(FieldValue, VerdanaBoldHeadingMain2, BlackBrush, xQty+10, CurrentY, Str);



            CurrentY = CurrentY + 13;//28
            ...
            FieldValue = "(١٥٪)";
            g.DrawString(FieldValue, VerdanaBoldHeadingMain2, BlackBrush, xProductName-55, CurrentY, Str);
             
            FieldValue = TotalTaxAmount.ToString("0.00"); ;
            g.DrawString(FieldValue, VerdanaBoldHeadingMain2, BlackBrush, xQty+10, CurrentY, Str);

            if(_Dbtask.znullDouble(TDiscount)>0)
            {
                CurrentY = CurrentY + 17;//28
                FieldValue = TDiscount.ToString() + "                         :  " + "خصم";
                g.DrawString(FieldValue, VerdanaBoldHeadingMain2, BlackBrush, xProductName, CurrentY, Str);

            }
            //CurrentY = CurrentY + 25;//28
            //FieldValue = "GRAND TOTAL ";
            //g.DrawString(FieldValue, VerdanaBoldHeadingMain2, BlackBrush, 160, CurrentY, Str);

            CurrentY = CurrentY + 23;//28
            FieldValue = "الإجمالي";
            g.DrawString(FieldValue, VerdanaBoldHeadingMain2, BlackBrush, xProductName, CurrentY, Str);
            ...
            g.DrawString(BillAmount, VerdanaBoldHeadingMain3, BlackBrush, xQty+10, CurrentY, Str);
            ...
            //if(_dbtask.znlldoubletoobject( deskbalnc)>0)
            //{
            CurrentY = CurrentY + 18;
        ...
        {// Set Invoice Total:
            ...
            if (FormType == "StockReport")
            {
                ...
                g.DrawString("Total", VerdanaBold, BlackBrush, 0, CurrentY);/*For Qty*///350
                g.DrawString(_Dbtask.SetintoDecimalpoint(SUmqty), VerdanaBold, BlackBrush,120, CurrentY);/*For Qty*///350
               
             //  g.DrawString(_Dbtask.SetintoDecimalpoint(SumSrate), VerdanaBold, BlackBrush, 190, CurrentY);/*For Taxable*/
               g.DrawString(_Dbtask.SetintoDecimalpoint(SUmNetAmt), VerdanaBold, BlackBrush, 270, CurrentY,Str);/*For Tax*/
            ...
            if (FormType == "StockReport A4")
            {
                ...
                g.DrawString("Total", VerdanaBold, BlackBrush, 0, CurrentY);/*For Qty*///350
                g.DrawString(_Dbtask.SetintoDecimalpoint(SUmqty), VerdanaBold, BlackBrush,400, CurrentY,Str);/*For Qty*///350

              //  g.DrawString(_Dbtask.SetintoDecimalpoint(SumSrate), VerdanaBold, BlackBrush,550, CurrentY,Str);/*For Taxable*/

               // g.DrawString(_Dbtask.SetintoDecimalpoint(Sumgrss), VerdanaBold, BlackBrush, 600, CurrentY);/*For Taxable*/
                g.DrawString(_Dbtask.SetintoDecimalpoint(SUmNetAmt), VerdanaBold, BlackBrush, 750, CurrentY, Str);/*For Tax*/
                CurrentY = CurrentY + 19;
                g.DrawLine(new Pen(Brushes.Black, 1), leftMargin, CurrentY, 800, CurrentY);
            ...
            if (FormType != "StockReport" && FormType != "Purchase A4" && FormType != "StockReport A4")
            {
            string TotalValue;
            PrintTotal(g);
            // g.DrawLine(new Pen(Brushes.Black,1), leftMargin, CurrentY, rightMargin, CurrentY);
           ...
           // CurrentY = CurrentY + 40;//35
            ...
            //g.DrawString(FieldValue, CalibiRiItalic, BlackBrush, 2, CurrentY);

            //CurrentY = CurrentY + 35;
            //FieldValue = CommonClass.CashDesk;
            //g.DrawString(FieldValue, VerdanaBold, BlackBrush, 2, CurrentY);
            ...
            g.DrawLine(new Pen(Brushes.Black, 1), leftMargin, CurrentY + 3, rightMargin, CurrentY + 3);
            CurrentY = CurrentY + InvoiceFontHeight;
           // g.DrawString("jjj", VerdanaBold, BlackBrush, 2, CurrentY, Str);

            CurrentY = CurrentY - 13;
            g.DrawString("المدفوع", VerdanaArabic, BlackBrush, 230, CurrentY);
            g.DrawString("=", VerdanaArabic, BlackBrush, 220, CurrentY);
            g.DrawString(_Dbtask.SetintoDecimalpoint(FrmCashDesk.TCash), VerdanaArabic, BlackBrush, 160, CurrentY);

            g.DrawString(",", VerdanaArabic, BlackBrush, 130, CurrentY);

            g.DrawString("الباقي", VerdanaArabic, BlackBrush, 100, CurrentY);
            g.DrawString("=", VerdanaArabic, BlackBrush, 90, CurrentY);
            g.DrawString(_Dbtask.SetintoDecimalpoint(FrmCashDesk.Balance), VerdanaArabic, BlackBrush, 40, CurrentY);
            CurrentY = CurrentY + 20;
           
            float xw = 5;
            string qrshow = "";
            qrshow = CommonClass._Dbtask.ExecuteScalar("select status from tblmnusettings where menuid='9000' and menuname ='QRshow'").ToString();
            ...
            if (qrshow == "1")
            {
                ...
                string StrQRCode;
               // StrQRCode ="Bill No"+Billno+","+ InvTitle.Replace(" ", "") + " VAT NO:" + InvSubTitle3 + " DATE:" + BillDate.ToString("dd/MM/yyyy") +
               //"  " + BillDate.ToString("hh:mm:ss tt") + " VAT TOTAL:" + Ttaxamount + " BILL TOTTAL:" + BillAmount;
                //StrQRCode = "تموينات السبهاني VAT#310306829500003   DATE:19-08-2021  TIME:06:50:27 PM  VAT TOTAL:3.90  BILL TOTTAL:29.90";
                  StrQRCode =CommonClass._Gen.FureturnQrValue(_Companymaster.GetspecifField("Sellersname"), _Companymaster.GetspecifField("TRN"), Billno, BillDate, Ttaxamount, BillAmount); 

                var result = new Bitmap(qr.Write(StrQRCode));

                xw = Convert.ToInt32((270 - result.Width) / 2);

                g.DrawImage(result, xw, CurrentY + 15);
           ...
           int x = (300 - (int)g.MeasureString("للتوصيل الرجاء مسح الباركود‎", VerdanaArabic).Width) / 2;
           // g.DrawString("للتوصيل الرجاء مسح الباركود‎", VerdanaArabic, BlackBrush, x, CurrentY);
           ...
           // CurrentY = CurrentY + 20;
            ...
            //CurrentY = CurrentY + 20;
            //g.DrawString("       الإستبدال خلال ثلاثة أيام والإسترجاع خلال يوم واحد فقط  *", VerdanaArabic, BlackBrush, leftMargin + 20, CurrentY);

            //CurrentY = CurrentY + 20;
            //g.DrawString(" الأشمغة والغتر والثياب لا ترد ولا تستبدل بعد الكوي أو الغسيل *", VerdanaArabic, BlackBrush, leftMargin+20, CurrentY);
           
            //CurrentY = CurrentY + 20;
            //g.DrawString(" الملابس الداخلية لا ترد ولا تستبدل بدون أكياس أو بعد تجربتها *", VerdanaArabic, BlackBrush, leftMargin+20, CurrentY);
            
            //CurrentY = CurrentY + 20;
            //g.DrawString(" تستبدل البضاعة وتسترجع إذا كانت سليمة بكراتينها وأكياسها  *", VerdanaArabic, BlackBrush, leftMargin+20, CurrentY);

            // CurrentY = CurrentY + 20;
            // g.DrawString(" بشرط إحضار الفاتورة ", VerdanaArabic, BlackBrush, leftMargin+170, CurrentY);
        ...
        public void GETfooterLINES(Graphics g)
        {
            ...
            postn = CommonClass._Dbtask.ExecuteScalar("select status from tblmnusettings where menuname='footerStart' and menuid='102030' ").ToString();
            mid = CommonClass._Dbtask.ExecuteScalar("select status from tblmnusettings where menuname='footermidd' and menuid='8000' ").ToString();
            string line = ""; int x = 5;
            ...
            //            g.DrawString(secnnme, VerdanaArabic, BlackBrush, leftMargin + 20, CurrentY);
