...
namespace WindowsFormsApplication2
{
    class Clsinvlaserhalf
    {
        ...
        private void SetInvoiceHead(Graphics g)
        {
            ...
            {
                InvSubTitle5 = "Sales Order";//, VerdanaBold, BlackBrush, 480, CurrentY);//142
            }
            if (FormType == "Sales Return")
            {
                InvSubTitle5 = "(Sales Return-مرتجع فاتورة)";//, VerdanaBold, BlackBrush, 550, CurrentY);//142
            }
            if (FormType == "Sales")
            {
                InvSubTitle5 = Scndhead;  //"Simplified Tax Invoice"+"  "+"فاتورة ضريبية مبسطة" ;
            }
        ...
        private void SetOrderData(Graphics g)
        {
            ...
            if (CName.ToLower() == "cash" || CName.ToLower() == "card" || CName.ToLower() == "bank")
            {
                if ( Tename != "")
                {
                    CName = Tename;
            ...
            CurrentY = CurrentY + 18;
            FieldValue = "Customer " + " " + "(اسم العميل) "  ;
           ...
           "Fifty", "Sixty", "Seventy", "Eighty", "Ninety" };
            ...
            public String ConvertAmount(double amount)
            {
                try
                {
                    ...
                    Clsinvlaserhalf Frms = new Clsinvlaserhalf();
