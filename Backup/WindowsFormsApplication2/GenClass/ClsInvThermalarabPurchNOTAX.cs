...
{
    class ClsInvThermalarabPurchNOTAX
    {
      public  string FieldValue;
        ...
        public double billdiscounts = 0;
        public static string SelPrint;
        public bool SProject;
        /***************/

        public double extrapaymnt = 0;
        ...
        private Font Verdanaarabline = new Font("Calibri", 12, FontStyle.Underline);
        ...
        private void ReadInvoiceHead()
            ...
            {
                 Scndhead = ""; InvSubTitle5 = "";
                //if (FormType == "Sales Quatation")
                //{
                //    InvSubTitle5 = "Sales Quatation";
                  
                //}
                 if (FormType == "Purchase Order")
                {
                    InvSubTitle5 = "Purchase Order";
                   
                }
                 if (FormType == "Purchase")
                {
                    InvSubTitle5 = "Purchase";
                    //Scndhead = "Simplified Tax Invoice";
                    
                }
                if (FormType == "Services")
                {
                   InvSubTitle5  = "نوع الجهاز";
                ...
                if (FormType == "Purchase Return")
                {
                    ...
                    //Scndhead = "Purchase Return";
                }
                //InvSubTitle5 = " فاتورة" + "" + FormType;
            }
        ...
        private void SetInvoiceHead(Graphics g)
        {
            ...
            if (System.IO.File.Exists(InvImage))
            {
                ...
                g.DrawImage(oInvImage, icostart, CurrentY, icoend, icosizze);//80
            ...
            //{
            //    Bitmap oInvImageH = new Bitmap(InvImageheadrr);
            //    // Set Image Left to center Image:
            //    int xImage = CurrentX + (InvoiceWidth - oInvImageH.Width) / 2;
            //    ImageHeight = oInvImageH.Height; // Get Image Height
            //    g.DrawImage(oInvImageH, xImage - 40, CurrentY);
            //}
            ...
            //    hx = (300 - (int)g.MeasureString(InvSubTitle5, AmountInwordsfont).Width) / 2;
            //    g.DrawString(InvSubTitle5, VerdanaBoldHeadingMain2, BlackBrush, hx - 20, CurrentY - 8);
            //    CurrentY = CurrentY + 23;
            //    if (Scndhead != "")
            //    {
            //        hx = (300 - (int)g.MeasureString(Scndhead, VerdanaBoldHeadingMain2).Width) / 2;
            //        g.DrawString(Scndhead, VerdanaBoldHeadingMain2, BlackBrush, hx - 20, CurrentY);
            //        CurrentY = CurrentY + 23;
            ...
            Font InvTitlefnt = new Font("Broadway", InvTitlefntsiz, FontStyle.Regular);
            Font InHomefnt = new Font("Broadway", InHomefntsiz, FontStyle.Regular);
            //Font SubTitle1fnt = new Font("Calibri", 12, FontStyle.Bold);
            ...
            if (InvTitle != "" && FormType != "     SALES ORDER" && FormType != "Purchase Order" && FormType != "SALES QUATATION")/*For Company Heading*/
            {
               // CurrentY = CurrentY +100;
                ...
                g.DrawString(InvTitle, InvTitlefnt, BlackBrush, hx - 20, CurrentY);
            ...
            if (InvSubTitle11 != "" && FormType != "     SALES ORDER" && FormType != "Purchase Order" && FormType != "SALES QUATATION")/*For Address2*/
            {
                ...
                hx = (300 - (int)g.MeasureString(InvSubTitle11, addphonefnt).Width) / 2;
                g.DrawString(InvSubTitle11, addphonefnt, BlackBrush, hx - 20, CurrentY);
                CurrentY = CurrentY + 7;
            }
            ...
            if (InvSubTitle5 != "")/*For InVoiceName*/
            {
                ...
                //g.DrawString(InvSubTitle5, VerdanaBoldHeadingMain2, BlackBrush, hx-20, CurrentY - 8);
                 ...
                 {
                     //CurrentY = CurrentY + InvSubTitleHeight;
                     //if (ModeofPayment == "CASH"||ModeofPayment =="السيولة النقدية")
                     //{
                     //    CurrentX = (300 - (int)g.MeasureString("CASH", VerdanaBold).Width) / 2;
                     //    //g.DrawString("السيولة النقدية", VerdanaBoldHeadingMain2, BlackBrush, 200, CurrentY-4,Str);
                     //}
                     //else if (ModeofPayment == "CREDIT" || ModeofPayment == "ائتمان")
                     //{
                     //    CurrentX = (300 - (int)g.MeasureString("CREDIT", VerdanaBold).Width) / 2;
                     //    //g.DrawString("ائتمان", VerdanaBoldHeadingMain2, BlackBrush, 200, CurrentY-4,Str);
                     //}
                     //else
                     //{
                     //    CurrentX = (300 - (int)g.MeasureString("CASH", VerdanaBold).Width) / 2;
                     //    //g.DrawString("بطاقة", VerdanaBoldHeadingMain2, BlackBrush, 200, CurrentY-4, Str);
                     //}
            ...
            /***********New Rule*******************/
            Font arbHead = new Font("Calibri", 12, FontStyle.Bold);
            Font arbHead2 = new Font("Calibri", 10, FontStyle.Bold);
           // CurrentY = CurrentY + InvSubTitleHeight + 5;
            ...
            {
                //g.DrawString("فاتورة ضریبیة المبسطة", arbHead, BlackBrush, hx - 5, CurrentY);
                // CurrentY = CurrentY + 7;
        ...
        private void SetOrderData(Graphics g)
        {
            ...
            g.DrawString(FieldValue, VerdanaBold, BlackBrush, 50, CurrentY);
            g.DrawString(Billno, VerdanaBold, BlackBrush, 3, CurrentY);

            // CurrentY = CurrentY + 16;
            FieldValue = ":التاريخ";
            g.DrawString(FieldValue, VerdanaBold, BlackBrush, 240, CurrentY);
            g.DrawString(BillDate.ToString("dd/MM/yyyy"), Verdananormal, BlackBrush, 170, CurrentY);
            ...
            g.DrawString(":الوقت", VerdanaBold, BlackBrush, 240, CurrentY);
            ...
            if (CommonClass._Menusettings.GetMnustatus("199").ToString() == "1")
            {
                if (vehicle != "")
                {
                    ...
                    g.DrawString(":رقم لوحة السيارة", VerdanaBold, BlackBrush, 270, CurrentY, Str);
                    g.DrawString(vehicle, VerdanaBold, BlackBrush, 180, CurrentY, Str);
            ...
            if (CommonClass._Menusettings.GetMnustatus("200").ToString() == "1")
            {
                ...
                {
                    CurrentY = CurrentY + 18;
                    g.DrawString(":رقم عداد السيارة", VerdanaBold, BlackBrush, 270, CurrentY, Str);
                    g.DrawString(mtrread, VerdanaBold, BlackBrush, 180, CurrentY, Str);
            ...
            //g.DrawString("زبون", VerdanaBold, BlackBrush, 3, CurrentY);
            if (employee != "")
            {
                CurrentY = CurrentY + 10;
                g.DrawString(employee + ":  الموظف ", VerdanaBold, BlackBrush, 270, CurrentY, Str);
                CurrentY = CurrentY + 18;
            }
            if (CName != "")
            {
                CurrentY = CurrentY + 18;
                FieldValue = CName + "   :  المورد";
                g.DrawString("  اسم العميل ", Verdananormal, BlackBrush, 270, CurrentY, Str);
                g.DrawString(CName + " : ", Verdananormal, BlackBrush, 220, CurrentY, Str);
                ...
                {
                    CurrentY = CurrentY + 18;
                    g.DrawString("   :    العنوان", Verdananormal, BlackBrush, 270, CurrentY, Str);
                    //CurrentY = CurrentY + 18;
                }
                ...
                //    if (c == '\n')
                //    {
                //        g.DrawString(FieldValue, VerdanaBold, BlackBrush, 250, CurrentY , Str);
                //       CurrentY= CurrentY + 18 * kk;
                //        kk++;
                //        FieldValue = "";
                //    }
                //    count++;
                ...
                if (Address != "")
                {
                    if (Address.Length <= 35)
                    {
                        ...
                        g.DrawString(Address, VerdanaBold, BlackBrush, 220, CurrentY, Str);
                    }
                    else
                    {
                        string realadd = Address;
                        int reallength = 0; reallength =Convert.ToInt32( Address.Length);
                        Address = Address.Substring(0,34);
                        g.DrawString(Address, VerdanaBold, BlackBrush, 220, CurrentY, Str);
                        CurrentY = CurrentY + 18;
                        Address = realadd.Substring(35);
                        g.DrawString(Address, VerdanaBold, BlackBrush, 270, CurrentY, Str);
                    }
                        kk++;
                }
            }
            ...
            if (FormType == "WHOLESALE" || FormType == "Sales" || FormType == "مبيعات")
            {
                //if (CName != "")
                //{
                   // string CTinn = _Accountledger.GetspecifField("Taxregno", Lid);
                
                
                
                if (CTin != "" && CTin != "0.00")
                {  
                FieldValue = CTin + ": " + "رقم الضريبي العميل ";
                    
                        CurrentY = CurrentY + 22;
                        //g.DrawString(FieldValue, Verdananormal, BlackBrush, 270, CurrentY,Str);

                    }
                //}
                if (cusmob != "" && cusmob != "0.00")
                {
                    Tmob = cusmob;
                }
                if (Tmob != "")
                {
                    CurrentY = CurrentY + 18;
                    FieldValue = Tmob;
                    g.DrawString(FieldValue + ": " + " جوال ", Verdananormal, BlackBrush, 270, CurrentY, Str);
                    CurrentY = CurrentY + 20;
                }
        ...
        {// Set Invoice Table:
            ...
            if (InvSubTitle5 != "      ESTIMATE")
            {
                ...
                g.DrawString("الرقم", VerdanaBold, BlackBrush, 245, CurrentY);
                g.DrawString("الصنف", VerdanaBold, BlackBrush, 160, CurrentY);
                g.DrawString("الكمية", VerdanaBold, BlackBrush, 90, CurrentY);      //Qt
            ...
            // Set Invoice Table:
            g.DrawLine(new Pen(Brushes.Black, 1), leftMargin, CurrentY - 3, rightMargin, CurrentY);
            CurrentY = CurrentY + InvoiceFontHeight + 8;
            g.DrawLine(new Pen(Brushes.Black, 1), leftMargin, CurrentY, rightMargin, CurrentY);
            //CurrentY = CurrentY + InvoiceFontHeight + 8;
            ...
            for (int i = TRowcounting; i <= MainGrid.Rows.Count-1 ; i++)
            {
                ...
                if (_Dbtask.znllString(MainGrid.Rows[i].Tag) == "1")
                {
                    ...
                    //{
                        ...
                        FieldValue = CommonClass._Item.SpecificField(Itemid, "itemnote");
                        msr = (int)g.MeasureString(FieldValue, VerdanaArabic).Width;
                        if (FieldValue != "")
                        {
                            e.Graphics.DrawString(FieldValue, VerdanaArabic, BlackBrush, 230, CurrentY);
                        }

                        FieldValue = CommonClass._Item.SpecificField(Itemid, "itemname");

                        int msr1;
                        // MainGrid.Columns["clnitemname"].DefaultCellStyle.Font = new System.Drawing.Font("Kerala Lite", 10F);
                        if (FieldValue.Length > 22)
                            FieldValue = FieldValue.Substring(0, 21);

                        msr1 = (int)g.MeasureString(FieldValue + CommonClass._Item.SpecificField(Itemid, "itemnote"), VerdanaArabic).Width;
                        msr1 = (int)g.MeasureString(FieldValue, VerdanaArabic).Width;

                        e.Graphics.DrawString(FieldValue, VerdanaArabic, BlackBrush, 250 - msr1, CurrentY);
                       ...
                       // e.Graphics.DrawString(FieldValue, CalibiRiItalic, BlackBrush, xProductName, CurrentY);
                        ...
                        CurrentY = CurrentY + InvoiceFontHeight + 18;//35
                        // * 2+4
           ...
           "Fifty", "Sixty", "Seventy", "Eighty", "Ninety" };
            ...
            public String ConvertAmount(double amount)
            {
                try
                {
                    ...
                    ClsInvThermalarabPurchNOTAX Frms = new ClsInvThermalarabPurchNOTAX();
        ...
        public void VatPrinting(Graphics g)
        {
            ...
            if (InvSubTitle5 != "      ESTIMATE")
            {
                ...
                //if (billdiscounts > 0 && FormType != "Services" && FormType != "نوع الجهاز")
                //{
                //    g.DrawString( " : خصم", VerdanaBoldHeadingMain2, BlackBrush, 225, CurrentY, Str);
                //    g.DrawString(_Dbtask.SetintoDecimalpoint(billdiscounts).ToString(), VerdanaBoldHeadingMain2, BlackBrush, 100, CurrentY, Str);
                //    //_Dbtask.SetintoDecimalpoint(billdiscounts).ToString() +
                //    CurrentY = CurrentY + 16;
                //}
            ...
            //    g.DrawString("التوازن القديم", VerdanaBoldHeadingMain2, BlackBrush, 200, CurrentY, Str);
            //    //        //xTotalValue = 750 - (int)g.MeasureString(BillAmount, Arialbold).Width;
            //    g.DrawString(oldbalnce.ToString(), VerdanaBoldHeadingMain2, BlackBrush, 50, CurrentY);
            //    CurrentY = CurrentY + 15;
            ...
            //    g.DrawString("الرصيد الحالي", VerdanaBoldHeadingMain2, BlackBrush, 260, CurrentY, Str);
            //    //        //xTotalValue = 750 - (int)g.MeasureString(BillAmount, Arialbold).Width;
            //    g.DrawString(currentblnce.ToString(), VerdanaBoldHeadingMain2, BlackBrush, 50, CurrentY);
            //    CurrentY = CurrentY + 16;
            ...
            {
                if (complaint.Length <= 38)
                {
                    //CurrentY = CurrentY + 20;
                    if (FormType == "Sales" || FormType == "عائد المبيعات" || FormType == "Sales return" || FormType == "مبيعات" || FormType == "مبيعات  اقتباس" || FormType == "Sales Quatation" || FormType == "Sales Order" || FormType == "طلب المبيعات")
                    {
                        //g.DrawString( saleNarration, BOLI, BlackBrush, 2, CurrentY);

                        g.DrawString("العطل", VerdanaBoldHeadingMain2, BlackBrush, 250, CurrentY, Str);
                        g.DrawString("=============================", BOLI, BlackBrush, 250, CurrentY + 14, Str);
                        //warrantyStr +"    "+
                        g.DrawString(saleNarration, VerdanaBoldHeadingMain2, BlackBrush, 250, CurrentY + 27, Str);
                ...
                else
                {
                    ...
                    {
                        //stdy
                        //string one = complaint.Substring(0, 24).ToString();
                        //string two = complaint.Substring(24).ToString();




                        saleNarration = complaint.Substring(0, 38).ToString();
                        g.DrawString("العطل", VerdanaBoldHeadingMain2, BlackBrush, 250, CurrentY, Str);
                        //g.DrawLine(new Pen(Brushes.Black, 1), leftMargin, CurrentY + 17, rightMargin, CurrentY + 17);
                        g.DrawString("=============================", BOLI, BlackBrush, 250, CurrentY + 14, Str);


                        g.DrawString(saleNarration, VerdanaBoldHeadingMain2, BlackBrush, 250, CurrentY + 26, Str);

                        CurrentY = CurrentY + 40;
                        saleNarration = complaint.Substring(38).ToString();
                        g.DrawString(saleNarration, VerdanaBoldHeadingMain2, BlackBrush, 250, CurrentY, Str);
            ...
            if (FormType != "Services" && FormType != "نوع الجهاز")
            {
                xProductName = 250;
                xQty = 70;
                if (CommonClass._Menusettings.GetMnustatus("194") != "1")
                {
                    FieldValue = "المجموع قبل الضريبه";
                    ...
                    //g.DrawString(FieldValue, VerdanaBoldHeadingMain2, BlackBrush, xQty, CurrentY, Str);
                ...
                if (billdiscounts > 0)
                {
                    ...
                    FieldValue = bfrdis.ToString("0.00");
                    g.DrawString(FieldValue, VerdanaBoldHeadingMain2, BlackBrush, xQty, CurrentY, Str);


                    CurrentY = CurrentY + 25;
                    g.DrawString(" : خصم", VerdanaBoldHeadingMain2, BlackBrush, xProductName, CurrentY, Str);
                    g.DrawString(_Dbtask.SetintoDecimalpoint(billdiscounts).ToString(), VerdanaBoldHeadingMain2, BlackBrush, xQty, CurrentY, Str);
                    //_Dbtask.SetintoDecimalpoint(billdiscounts).ToString() +
                    //CurrentY = CurrentY + 16;
                }
                ...
                FieldValue = "الإجمالي";
                g.DrawString(FieldValue, VerdanaBoldHeadingMain2, BlackBrush, xProductName, CurrentY, Str);
                g.DrawString(BillAmount, VerdanaBoldHeadingMain2, BlackBrush, xQty, CurrentY, Str);

            }
            //CurrentY = CurrentY + 15;
            //g.DrawString("Total QTY", VerdanaBoldHeadingMain2, BlackBrush, 260, CurrentY, Str);
            //g.DrawString(TotalQty, VerdanaBoldHeadingMain2, BlackBrush, 10, CurrentY);
            string samplid = _Dbtask.ExecuteScalar("select agroupid from tblaccountledger where lname='" + TempCust + "'");
            if (samplid == "18" && PrintOldbalance == true)
            {
            ...
            if (FormType == "Services" || FormType == "نوع الجهاز")
            {
                ...
                FieldValue = "الإجمالي";
                g.DrawString(FieldValue, VerdanaBoldHeadingMain2, BlackBrush, xProductName, CurrentY, Str);
                g.DrawString(TotalNetamount.ToString("0.00"), VerdanaBoldHeadingMain2, BlackBrush, xQty, CurrentY, Str);

                CurrentY = CurrentY + 18;
                FieldValue = "المبلغ الذي تسلمه";
                g.DrawString(FieldValue, VerdanaBoldHeadingMain2, BlackBrush, xProductName, CurrentY, Str);

                //FieldValue = ;
                //g.DrawString(FieldValue, VerdanaBoldHeadingMain2, BlackBrush, xProductName - 55, CurrentY, Str);

                FieldValue = _Dbtask.SetintoDecimalpoint(paided).ToString();
                g.DrawString(FieldValue, VerdanaBoldHeadingMain2, BlackBrush, xQty, CurrentY, Str);
                //CurrentY = CurrentY + 25;
                if (billdiscounts > 0)
                {
                ...
                CurrentY = CurrentY + 25;
                double netty =_Dbtask.znlldoubletoobject( TotalNetamount);
                double balancee = (netty - billdiscounts) - paided ;

                FieldValue = ": توازن  ";
                g.DrawString(FieldValue, VerdanaBoldHeadingMain2, BlackBrush, xProductName, CurrentY, Str);
                g.DrawString(_Dbtask.SetintoDecimalpoint(balancee), VerdanaBoldHeadingMain2, BlackBrush, xQty, CurrentY, Str);
            }
            ...
            //http://www.tgredh-sa.com
            
               // CurrentY = CurrentY + 18;
            //}
            if (warrantyStr != null && warrantyStr != "")
            {
                g.DrawString(":  ضمان ", VerdanaBoldHeadingMain2, BlackBrush, 250, CurrentY + 25, Str);
                //warrantyStr +"    "+
                g.DrawString(warrantyStr, VerdanaBoldHeadingMain2, BlackBrush, 30, CurrentY + 25);
            }
        ...
        public void PrintTotal(Graphics g)
        {
            ...
            //CurrentY = CurrentY + 8;
            //g.DrawString("المبلغ الإجمالي", VerdanaArabic, BlackBrush, 260, CurrentY, Str);

            //g.DrawString(TotalQty, VerdanaBold, BlackBrush, 110, CurrentY);
            //g.DrawString(_Dbtask.SetintoDecimalpoint(TotalTaxAmount), VerdanaBold, BlackBrush, 60, CurrentY);/*For Tax*/
            //g.DrawString(_Dbtask.SetintoDecimalpoint(SUmNetAmt), VerdanaBold, BlackBrush, 0, CurrentY);
        ...
        {// Set Invoice Total:
           ...
           // g.DrawString("jjj", VerdanaBold, BlackBrush, 2, CurrentY, Str);
            ...
            double totalpaided = 0;
            totalpaided = (FrmCashDesk.TCash) +( FrmCashDesk.Otherpayamt);
            g.DrawString(_Dbtask.SetintoDecimalpoint(totalpaided), VerdanaArabic, BlackBrush, 160, CurrentY);
         ...
         //  ---------------------
            ...
            //        int xImage = CurrentX + (InvoiceWidth - oInvImageF.Width) / 2;
            //        ImageHeightT = oInvImageF.Height; // Get Image Height
            //        g.DrawImage(oInvImageF, 90, CurrentY + 10, FX, FY);
            //    }


            //    //web
            //    string web = "www.tgredh-sa.com";
            //    g.DrawString(web, VerdanaBoldHeadingMain2, BlackBrush, 60, CurrentY + 110);
            ...
            //if (FormType != "Services" && FormType != "نوع الجهاز")
            //{
            //    g.DrawImage(BImage, x, CurrentY + 35);
            //    x = (300 - (int)g.MeasureString("شكرا لشرائك من تغريدة للاتصالات! نتمنى أنها كانت رحلة تسوق سعيدة.", VerdanaArabic).Width) / 2;
            ...
            //    g.DrawString("شكرا لشرائك من تغريدة للاتصالات! نتمنى أنها كانت رحلة تسوق سعيدة.", VerdanaArabic, BlackBrush, x, CurrentY + 20);
        ...
        private void PrintReport()
        {
            try
            {
                ...
                prnDocument.PrintPage += new System.Drawing.Printing.PrintPageEventHandler(prnDocument_PrintPage);
                ReadInvoice = false;
                prnDocument.PrinterSettings.PrinterName = PSelect;
