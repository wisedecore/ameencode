...
namespace WindowsFormsApplication2
{
    class Clsreceiptpaymentreport
    {
     ...
     //           g.DrawString(InvSubTitle3, Arialbold, BlackBrush, xInvSubTitle1-20, CurrentY);
            ...
            if (FormType == "Payment and Receipt Report" && head == false)
            {
            ...
            if (FormType == "Payment and Receipt Report")
            {
                ...
                g.DrawString("Payment and Receipt Report", gothicfnt, BlackBrush, 300, CurrentY);
                CurrentY = CurrentY + 23;
       ...
       //     CurrentY = CurrentY + InvSubTitleHeight + 8;
        ...
        {// Set Invoice Table:
          ...
          //\ g.DrawString("SlNo", Verdananormal, BlackBrush, xSlno, CurrentY);
            ...
            if ("Payment and Receipt Report" == "Payment and Receipt Report")

            {
                ...
                g.DrawString("Party", VerdanaBold2, BlackBrush, 60, CurrentY);
                CurrentX = CurrentX + 80;
               
                g.DrawString("Amount", VerdanaBold2, BlackBrush, 305, CurrentY);
                CurrentX = CurrentX + 10;
           ...
           //CurrentY = CurrentY + InvoiceFontHeight + 2;
            ...
            if (FormType == "Payment and Receipt Report")
            {
                    ...
                    for (int i = TRowcounting; i <= MainGrid.Rows.Count - 1; i++)
                    {
                        ...
                        if (_dbtask.znllString(MainGrid.Rows[i].Cells["clnramount"].Value) != "" &&_dbtask.znllString( MainGrid.Rows[i].Cells["clnpamount"].Value )!= "")
                        {
                        ...
                        if (TempRowcounting < RecordsPerPage)
                        {
                            ...
                            FieldValue = _dbtask.znllString(MainGrid.Rows[i].Cells["clnrvno"].Value);
                            ...
                            FieldValue = _dbtask.znllString(MainGrid.Rows[i].Cells["clnreceipt"].Value);
           ...
           "Fifty", "Sixty", "Seventy", "Eighty", "Ninety" };
            ...
            public String ConvertAmount(double amount)
            {
                try
                {
                    ...
                    Clsreceiptpaymentreport Frms = new Clsreceiptpaymentreport();
