...
namespace WindowsFormsApplication2
{
...

    {
        ...
        public string HeaderinPrint="";
        public string vehiname = "";

        public string vehclenum = "";
        public string metrread = "";
...
//      //Console.WriteLine(string.format("The Number: {0} is represented in arabic as: {1}", aNumber, theNumberAsArabicString));
        ...
        private void SetInvoiceHead(Graphics g)
        {
            ...
            CurrentX = Convert.ToInt32(CommonClass._Paramlist.GetParamvalue("Leftleser"));
             ...
             if (HF == 0 || HF == 2)
             {
                 InvImagehead = Application.StartupPath + @"\Images\" + "InvPicsecond.jpg";
                 if (System.IO.File.Exists(InvImagehead) && FormType != "ESTIMATE")
                 {
                     ...
                     ImageHeight = 0;
                     g.DrawImage(oInvImage, (leftlase), 0, 750, 1160);//x10
                 }
             }
            ...
            if (FormType == "     SALES RETURN")
            {
                StrTaxinvoiceHeader = "(Sale Return- عرض السعر )";
                //StrTaxinvoiceHeader ="(Saler Return-مرتجع فاتورة)";//, VerdanaBold, BlackBrush, 550, CurrentY);//142
            }
            if (FormType == "     SALES")
            {
                StrTaxinvoiceHeader = " INVOICE "; //StrTaxinvoiceHeader;// "فاتورة ضريبية مبسطة" + "  " + "Simplified Tax Invoice";
            }
            ...
            g.DrawString("Invoice no.", Verdananormal, BlackBrush, (leftlase+2), CurrentY);//x10
           ...
           // g.DrawLine(new Pen(Brushes.Black, 1), 525, 170, 525, 230);
            ...
            //CurrentY = CurrentY +20;//290
            //g.DrawRectangle(selpen2, leftlase, CurrentY,770, 50);//380
            //g.DrawString("Vehicle No.         :  " + vehclenum, Verdananormal, BlackBrush, (leftlase + 10), CurrentY);//x10


            //g.DrawLine(new Pen(Brushes.Black, 1), (leftlase + 400), CurrentY, (leftlase + 400), CurrentY + 25);//260 x10


            //g.DrawString("Vehicle Name:  " + vehiname, Verdananormal, BlackBrush, (leftlase + 400), CurrentY);//x10


            //CurrentY = CurrentY + 25;
            //g.DrawLine(new Pen(Brushes.Black, 1), (leftlase), CurrentY, ((leftlase + 775) - 5), CurrentY);//260 x10
            //g.DrawString("Meter reading      :  " + metrread, Verdananormal, BlackBrush, (leftlase + 10), CurrentY);//x10

            
            CurrentY = CurrentY +35;//290


            g.DrawRectangle(selpen, leftlase , CurrentY, 770, (580 - toplasr));//x10

            g.DrawLine(new Pen(Brushes.Black, 1), (leftlase + 70), CurrentY, (leftlase + 70), CurrentY + (580 - toplasr));//x70

            //g.DrawLine(new Pen(Brushes.Gray, 1), 400, 290, 400, 789);

            //g.DrawLine(new Pen(Brushes.Black, 1), (leftlase + 450), CurrentY, (leftlase + 450), CurrentY + (530 - toplasr));//x1 x2 450

            //g.DrawLine(new Pen(Brushes.Black, 1), (leftlase + 500), CurrentY, (leftlase + 500), CurrentY + (530 - toplasr));//x1x2 500
            //g.DrawLine(new Pen(Brushes.Black, 1), (leftlase + 565), CurrentY, (leftlase + 565), CurrentY + (530 - toplasr));//x1x2 565
            //g.DrawLine(new Pen(Brushes.Black, 1), (leftlase + 630), CurrentY, (leftlase + 630), CurrentY + (530 - toplasr));//x1x2 630



            //g.DrawLine(new Pen(Brushes.Black, 1), (leftlase + 450), CurrentY, (leftlase + 450), CurrentY + (530 - toplasr));//x1 x2 450

            g.DrawLine(new Pen(Brushes.Black, 1), (leftlase + 500), CurrentY, (leftlase + 500), CurrentY + (580 - toplasr));//x1x2 500
            //g.DrawLine(new Pen(Brushes.Black, 1), (leftlase + 565), CurrentY, (leftlase + 565), CurrentY + (530 - toplasr));//x1x2 565
            g.DrawLine(new Pen(Brushes.Black, 1), (leftlase + 580), CurrentY, (leftlase + 580), CurrentY + (580 - toplasr));//x1x2 630
            //g.DrawLine(new Pen(Brushes.Gray, 1), 650, 290, 650, 725);
            g.DrawLine(new Pen(Brushes.Black, 1), (leftlase + 685), CurrentY, (leftlase + 685), CurrentY + (580 - toplasr));//x1x2 685
           ...
           // g.DrawString(Billno, VerdanaBold, BlackBrush, 157, 172);
            ...
            g.DrawString("slno", Verdananormal, BlackBrush, (leftlase + 10), CurrentY);//x10
            g.DrawString("Itemname", Verdananormal, BlackBrush, (leftlase + 100 ), CurrentY);//x100

            //g.DrawString("Qty", Verdananormal, BlackBrush, (leftlase + 451), CurrentY);//x451
            //g.DrawString("Unitprice", Verdananormal, BlackBrush, (leftlase + 500), CurrentY);//x500


            g.DrawString("Qty", Verdananormal, BlackBrush, (leftlase +500 ), CurrentY);//x451
            g.DrawString("Unitprice", Verdananormal, BlackBrush,( leftlase + 580 ), CurrentY);//x500
            //g.DrawString("Gross", Verdananormal, BlackBrush, (leftlase + 568 ), CurrentY);//x568
            //g.DrawString("Tax15%", Verdananormal, BlackBrush, (leftlase + 630 ), CurrentY);//x630
            g.DrawString("Amount", Verdananormal, BlackBrush, (leftlase + 700), CurrentY);//x700
           ...
           // g.DrawString("slno", Verdananormal, BlackBrush, 10, 300);
            ...
            g.DrawString(_Gen.FuReturnArabic("Qty"), Verdananormal, BlackBrush, (leftlase + 500 ), CurrentY);//x451
         ...
         g.DrawString(_Gen.FuReturnArabic("Unit Rate"), Verdananormal, BlackBrush, (leftlase + 580 ), CurrentY);//x500
           ...
           /* g.DrawRectangle(selpen, 10, 800, 150, 150);
            ...
            HeaderinPrint = _Dbtask.znllString(CommonClass._Menusettings.GetMnustatus("205"));
           
            // Draw Invoice image:
            if (HF == 1 || HF == 2)
            {
                if (System.IO.File.Exists(InvImage) && FormType != "ESTIMATE" && HeaderinPrint == "1")
                {
            ...
            if (HF == 0 || HF == 2)
            {
                ...
                if (System.IO.File.Exists(InvImagehead) && FormType != "ESTIMATE")
                {
                    ...
                    ImageHeight = oInvImage.Height; // Get Image Height
                    ImageHeight = 0;
                    g.DrawImage(oInvImage, (leftlase ), 5, 750, 130);//x10
                }
            }
            ...
            if (System.IO.File.Exists(invimagefootr) && FormType != "ESTIMATE")
            {
                ...
                ImageHeight = oInvImage.Height; // Get Image Height
                ImageHeight = 0;
                g.DrawImage(oInvImage, (leftlase + 29), 1010, 718, 60);//29
            }
                    ...
                    if (TempRowcounting < RecordsPerPage)
                    {
                        if (isarbicdotprint == true)
                        {
                            ...
                            if (Plangwise == 1 || Plangwise == 0)
                            {
                                if (Plangwise == 0)
                                {
                                    ...
                                    if (FieldValue != "")
                                    {
                                        g.DrawString(FieldValue, Verdananormal, BlackBrush, (leftlase + 70), CurrentY);//x70
                                    }
                                }
                                if (Plangwise == 1)
                                {
                                    ...
                                    if (FieldValue != "")
                                    {
                                        ...
                                        g.DrawString(FieldValue, Verdananormal, BlackBrush, (leftlase + 420), CurrentY, Str);//x420
                                    }
                                }
                            }
                        ...
                        if (InvSubTitle5 != "DELIVERY NOTE INVOICE")
                        {
                            if (isarbicdotprint == true)
                            {
                                ...
                                g.DrawString(FieldValue, Verdananormal, BlackBrush, (leftlase + 520), CurrentY);//x490
                                ...
                                g.DrawString(FieldValue, Verdananormal, BlackBrush, (leftlase + 580), CurrentY);//x560
                               ...
                               // g.DrawString(FieldValue, Verdananormal, BlackBrush, (leftlase + 628), CurrentY, Str);//x628
                                ...
                                g.DrawString(FieldValue, Verdananormal, BlackBrush, (leftlase + 755), CurrentY, Str);//x755
           ...
           "خمسون", "ستون", "سبعون", "ثمانون", "تسعين" };
            ...
            public String ConvertAmount(double amount)
            {
                try
                {
                    ...
                    ClsinvlaserSixitemNOTAX Frms = new ClsinvlaserSixitemNOTAX();
        ...
        public void PrintTotal(Graphics g)
        {
            ...
            //CurrentY = CurrentY + 16;
            //CurrentY = CurrentY + 420;//750
            g.DrawLine(new Pen(Brushes.Black, 1), (leftlase), CurrentY,((leftlase  + 758)-5), CurrentY);//x10
           ...
           // g.DrawLine(new Pen(Brushes.Black, 1), 600, 800, 600, 950);
            ...
            //g.DrawString("Discount   " + _Gen.FuReturnArabic("Discount") + "", Verdananormal, BlackBrush, 305, 815);
                ...
                g.DrawString("Tot.Amount   " + "", Verdananormal, BlackBrush,(leftlase  + 305), CurrentY);//x305
                ...
                if (isarbicdotprint == true)
                {
                    ...
                    g.DrawString(_Dbtask.SetintoDecimalpoint(TotalTaxable).ToString(), Arialboldbottm, BlackBrush, (leftlase  +750), CurrentY, Str);//x750
                    //g.DrawString(_Dbtask.SetintoDecimalpoint(TotalTaxAmount).ToString(), Arialboldbottm, BlackBrush, 750, 885, Str);
                }
