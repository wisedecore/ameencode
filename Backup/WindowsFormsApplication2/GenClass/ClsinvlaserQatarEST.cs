...
namespace WindowsFormsApplication2
{
...

    {
        ...
        public string BrandD = ""; public string modell = "";
        public string slnoest = "";
        ...
        private Font STRT = new Font("Javanese Text", 8, FontStyle.Regular);
        ...
        private SolidBrush brwnkBrush = new SolidBrush(Color.Firebrick);
        private SolidBrush sandlekBrush = new SolidBrush(Color.SaddleBrown);
...
//      //Console.WriteLine(string.format("The Number: {0} is represented in arabic as: {1}", aNumber, theNumberAsArabicString));
        ...
        private void SetInvoiceHead(Graphics g)
        {
           ...
           //g.DrawString(Address.Replace("\n", ""), VerdanaBold, BlackBrush, (leftlase + 150 ), CurrentY);//x150
            ...
            string saleman = "";
            saleman = CommonClass._Employee.GetspecifField("Empname", EmployeeId);

            g.DrawString("Quotation-Estimate job Report", xerofnt, sandlekBrush, rightMargin - 15, CurrentY - 10, Str);//x10
            g.DrawString("Project", xerofnt, sandlekBrush, 300, CurrentY - 10, Str);//x10
            CurrentY = CurrentY + 5;
            g.DrawLine(new Pen(Brushes.SaddleBrown, 1), 5, CurrentY, 300, CurrentY);
            CurrentY = CurrentY + 5;

            SolidBrush fillgblk = new SolidBrush(Color.Pink);
            SolidBrush fillgain = new SolidBrush(Color.White);
            Pen selpen2 = new Pen(Color.SaddleBrown);
            Rectangle invrectd = new Rectangle(480, CurrentY,300, 20);
            g.DrawRectangle(selpen2, invrectd);
            g.FillRectangle(fillgblk, invrectd);



            g.DrawString("Date", xerofnt2, BlackBrush, 490, CurrentY);//x10
            g.DrawString("Estimate No.", xerofnt2, BlackBrush, rightMargin - 15, CurrentY, Str);//x10

            g.DrawString("Name/Address", xerofnt, BlackBrush, 5, CurrentY);//x10


            CurrentY = CurrentY + 20;
            Rectangle invrectd1 = new Rectangle(480, CurrentY, 300, 17);
            g.DrawRectangle(selpen2, invrectd1);
            //g.FillRectangle(fillgain, invrectd1);

            g.DrawString(BillDate.ToString("dd/MM/yyyy"), xerotermhead, BlackBrush, 490, CurrentY);//x10
            g.DrawString(Billno, xerotermhead, BlackBrush, rightMargin - 18, CurrentY, Str);//x10

            g.DrawString("Pyment method - " + ModeofPayment, xerotermhead, BlackBrush, 480, CurrentY + 20);//x10
            g.DrawString("Rep " + saleman, xerotermhead, BlackBrush, rightMargin - 15, CurrentY + 20, Str);//x10
            g.DrawString("Due date " , xerofnt2, BlackBrush, rightMargin - 15, CurrentY + 45, Str);//x10
            ...
            Rectangle rectW = new Rectangle(200, 200, CurrentY, 600);

            // Draw ellipse to screen.
            //g.DrawEllipse(selpen2, rectW);
           ...
           CurrentY = CurrentY + 15;
            ...
            Rectangle rect = new Rectangle(500, CurrentY, 300,36);
             string threestring="";
             threestring = "BRAND " + BrandD + "                       " + "MODEL " + modell + "                       " + "SL NO " + slnoest;

            g.DrawString(threestring, xeroleftfnt, BlackBrush,100, CurrentY);
            
            //SATRT
            CurrentY = CurrentY + 15;
            string Start = "";
            Start = "Dear Sir / Madam";
            g.DrawString(Start, STRT, BlackBrush, 5, CurrentY);
            
            CurrentY = CurrentY +9;
            Start = "Thanks for your valuable inquiry.";
            g.DrawString(Start, STRT, BlackBrush, 5, CurrentY);
            
            CurrentY = CurrentY + 9;
            Start = "As we descussed please find the maintenance for printers/copiers with special price,All details are in the qoutation, If any clarification please do call";
            g.DrawString(Start, STRT, BlackBrush, 5, CurrentY);
            
            CurrentY = CurrentY + 9;
           
            Start = "and let me know the status.";
            g.DrawString(Start, STRT, BlackBrush, 5, CurrentY);
           ...
           //300
            ...
            Pen selcln = new Pen(Color.Brown);
            Rectangle rect8 = new Rectangle(5, CurrentY, rightMargin, 20);
            g.DrawRectangle(selcln, rect8);
            g.FillRectangle(fillgblk, rect8);




            g.DrawString("MPN", xerofnt, sandlekBrush, 5, CurrentY);//x10

            g.DrawString("Description", Verdananormal, sandlekBrush, 120, CurrentY);//x100
            g.DrawString("(العنصر)", Verdananormal, sandlekBrush, 190, CurrentY);//x100


            g.DrawString("Qty", xerofnt, sandlekBrush, 460, CurrentY);//x451
            g.DrawString("( كمية )", Verdananormal, sandlekBrush, 480, CurrentY);//x451

            g.DrawString("Rate", xerofnt, sandlekBrush, 565, CurrentY);//x500
            g.DrawString("( معدل )", Verdananormal, sandlekBrush, 600, CurrentY);//x500

            g.DrawString("Total", xerofnt, sandlekBrush, 690, CurrentY);//x700
            g.DrawString("(مقدار )", Verdananormal, sandlekBrush, rightMargin-10, CurrentY, Str);//x700
            Rectangle rectitem = new Rectangle(5, CurrentY, rightMargin, 440);
            g.DrawRectangle(selcln, rectitem);

            g.DrawLine(new Pen(Brushes.Brown, 1), 120, CurrentY, 120, 780);//758
        ...
        {// Set Invoice Table:
           ...
           // CurrentY = CurrentY + 400;
            ...
            SolidBrush grycln = new SolidBrush(Color.LavenderBlush);
            Pen rowclr = new Pen(Color.LightPink );
                ...
                if (_Dbtask.znllString(MainGrid.Rows[i].Tag) == "1")
                {
                    if (TempRowcounting < RecordsPerPage)
                    {
                        if (isarbicdotprint == true)
                        {
                            ...
                            if ( (i%2) != 0)
                            {
                                Rectangle rowrect = new Rectangle(5, CurrentY, rightMargin, 20);
                            ...
                            //g.DrawString(ItemNote, Verdananormal, BlackBrush, 90, CurrentY,Str );
                                ...
                                if (FieldValue != "")
                                {
                                    g.DrawString(FieldValue, Verdananormal, BlackBrush,125, CurrentY);//x70
                                }
                        ...
                        if (InvSubTitle5 != "DELIVERY NOTE INVOICE")
                        {
                            if(isarbicdotprint==true)
                            {
                                ...
                                //}
                                g.DrawString(FieldValue, Verdananormal, BlackBrush,650, CurrentY,Str);//x560
           ...
           "خمسون", "ستون", "سبعون", "ثمانون", "تسعين" };
            ...
            public String ConvertAmount(double amount)
            {
                try
                {
                    ...
                    ClsinvlaserQatarEST Frms = new ClsinvlaserQatarEST();
        ...
        public void PrintTotal(Graphics g)
        {
            ...
            //CurrentY = CurrentY + 420;//750
            CurrentY = 780;
            Rectangle totrect = new Rectangle(530, CurrentY+3, 275, 23);
            Pen Totpen = new Pen(Color.SaddleBrown);
            g.DrawRectangle(Totpen, totrect);
            //g.FillRectangle(yeltot, totrect);
            g.DrawString("Total ", xerofnt, BlackBrush, 530, CurrentY+4);
            g.DrawString("( المجموع )", Verdananormal, BlackBrush, 570, CurrentY+4);
            g.DrawString(_Dbtask.SetintoDecimalpoint(_Dbtask.znlldoubletoobject(BillAmount)).ToString(), VerdanaBold, BlackBrush, rightMargin - 15, CurrentY+4, Str);//x750

            CurrentY = CurrentY + 17;

            //g.DrawLine(new Pen(Brushes.Silver, 1), 26, CurrentY, rightMargin, CurrentY);//x10
            string lastterm = "";
            lastterm = "Deiiveryﬂ-IO days normal working days ,After conformed LPO";
            g.DrawString(lastterm, xerotermhead, BlackBrush, 27, CurrentY );
            CurrentY = CurrentY + 10;
            lastterm = "Payment : CASH or PDC (Management approved for the credit terms)";
            g.DrawString(lastterm, xerotermhead, BlackBrush, 27, CurrentY);
            CurrentY = CurrentY + 10;
            lastterm = "Warrenty : 30 days in serivice of the pans ,Notbe coverd the of the consumables items ,";
            g.DrawString(lastterm, xerotermhead, BlackBrush, 27, CurrentY);
            CurrentY = CurrentY + 10;
            lastterm = "Validity: 15 days estimated will valid , If not approved lpaid with in 15 days will not be valid , re-estimate will be charged .";
            g.DrawString(lastterm, xerotermhead, BlackBrush, 27, CurrentY);
            CurrentY = CurrentY + 25;
            lastterm = "We trust you will ﬁnd our offer compentitve and look forwerd to hearing from at the ealist .";
            g.DrawString(lastterm, xerotermhead, BlackBrush, 27, CurrentY);
            CurrentY = CurrentY + 10;
            lastterm = "Thanking you assuring you of the our best attention all.";
            g.DrawString(lastterm, xerotermhead, BlackBrush, 27, CurrentY);
            CurrentY = CurrentY + 35;
            lastterm = "Best Regards,";
            g.DrawString(lastterm, xerotermhead, BlackBrush, 27, CurrentY);
            CurrentY = CurrentY + 15;
            lastterm = "XEROCARE TRADING & SERVICES WLL";
            g.DrawString(lastterm, xerotermhead, BlackBrush, 27, CurrentY);
            CurrentY = CurrentY + 10;
            lastterm = "P.O.BOX 37494";
            g.DrawString(lastterm, xerotermhead, BlackBrush, 27, CurrentY);
            CurrentY = CurrentY + 10;
            lastterm = "DOHA QATAR";
            g.DrawString(lastterm, xerotermhead, BlackBrush, 27, CurrentY);
            CurrentY = CurrentY + 10;
            lastterm = "MOB:7071 7282";
            g.DrawString(lastterm, xerotermhead, BlackBrush, 27, CurrentY);
            CurrentY = CurrentY + 10;
            
         CurrentY = CurrentY + 10;
            g.DrawString("Customer Sign .......................................................", xerofnt, BlackBrush, 550, CurrentY);
