...
namespace WindowsFormsApplication2
{
    class ClsinvlaserSimple
    {
        ...
        private void SetInvoiceHead(Graphics g)
        {
            ...
            if (FormType == "OutstandingReportsummery" && head == false)
            {
            ...
            {
                CurrentY = CurrentY + 43;
                g.DrawString("Outstanding Report summery", VerdanaBold, BlackBrush, 300, CurrentY);
                CurrentY = CurrentY + 8;
...
//g.DrawString(FieldValue, Verdananormal, BlackBrush, CurrentX + 590, CurrentY);
        ...
        public void RowValidation(DataGridView gridmain)
        {
            try
            {
                ...
                {
                    if (gridmain.Rows[i].Cells["clnparty"].Value == "" )
                    {
        ...
        {// Set Invoice Table:
            ...
            g.DrawString("VAT", Verdananormal, BlackBrush, 450, CurrentY);
            ...
            if (InvSubTitle5 != "      ESTIMATE" && InvSubTitle5 != "       OutstandingReportsummery INVOICE")
            {
            ...
            else
            {
                ...
                //602
                //638
                if( InvSubTitle5 != "       OutstandingReportsummery INVOICE")
                {
            ...
            for (int i = TRowcounting; i <= MainGrid.Rows.Count - 1; i++)
            {
                ...
                if (_Dbtask.znllString(MainGrid.Rows[i].Tag) == "1" && MainGrid.Rows[i].Cells["clnparty"].Value!= null)
                {
                    if (TempRowcounting < RecordsPerPage)
                    {
                        ...
                        g.DrawString(FieldValue, Verdananormal, BlackBrush, 650, CurrentY);
                        TotalNetamount =TotalNetamount+  _Dbtask.znlldoubletoobject(FieldValue);
           ...
           "Fifty", "Sixty", "Seventy", "Eighty", "Ninety" };
            ...
            public String ConvertAmount(double amount)
            {
                try
                {
                    ...
                    ClsinvlaserSimple Frms = new ClsinvlaserSimple();
        ...
        public void PrintTotal(Graphics g)
        {
            ...
            {
                g.DrawString(TotalNetamount.ToString(), VerdanaBold, BlackBrush, 650, CurrentY);/*For Qty*/
            }
        ...
        {// Set Invoice Total:
            ...
            if (FormType == "WHOLESALE" || FormType == "SALES RETURN" || FormType == "DELIVERY NOTE" || FormType == "Purchase Return" && InvSubTitle5 != "       OutstandingReportsummery INVOICE")
            {
