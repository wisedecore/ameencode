    ...
    class ClsTwoinchThermal
    {
        ...
        private void SetInvoiceHead(Graphics g)
        {
            ...
            if (CommonClass._Menusettings.GetMnustatus("194") == "-1")
            {
                ...
                g.DrawString("فاتورة ضریبیة المبسطة", arbHead, BlackBrush, hx -20, CurrentY);
                // CurrentY = CurrentY + 7;

                CurrentY = CurrentY + InvSubTitleHeight;
                hx = (200 - (int)g.MeasureString(InvSubTitle3, arbHead).Width) / 2;

                g.DrawString(headsett, arbHead, BlackBrush, hx - 20, CurrentY);
           ...
           "Fifty", "Sixty", "Seventy", "Eighty", "Ninety" };
            ...
            public String ConvertAmount(double amount)
            {
                try
                {
                    ...
                    ClsTwoinchThermal Frms = new ClsTwoinchThermal();
