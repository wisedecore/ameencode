...
{
    class clsPurchasetaxHorizontal
    {
        int hx = 5;
      ...
      int xRate; public string StrNaration = "";
        ...
        private Font Lucida = new Font("Lucida Bright", 8, FontStyle.Bold);
        private Font LucidaTWO = new Font("Lucida Bright", 9, FontStyle.Bold);
        private Font Segoe = new Font("Segoe Print", 9, FontStyle.Bold);
        ...
        {
            Str.FormatFlags = StringFormatFlags.DirectionVertical;
            ReadInvoiceHead();
            ...
            if (System.IO.File.Exists(InvImage))
            {
               ...
               //g.DrawImage(oInvImage, 60, CurrentY, 130, 120);
            ...
            if (FormType == "Purchasetax")
            {
                ...
                if (InvTitle != "")
                {
                   ...
                   // strFormat1.FormatFlags = StringFormatFlags.DirectionVertical;
                    ...
                    g.DrawString(InvTitle, VerdanaBoldHeadingMain, BlackBrush, 800, 500, Str);

                    //g.DrawString(objs
                    //g.DrawString(ObjStationRepository.FindBy(i => i.Id == t.StationId).First().Description, new Font("B Nazanin", 18), Brushes.White, t.XLocation + 70, t.YLocation + 80);
                ...
                if (InvSubTitle3 != "")
                {
                    g.DrawString("VAT: " + InvSubTitle3, AmountInwordsfont, BlackBrush, 750, 500, Str);
                    //CurrentY = CurrentY + 23;
        ...
        private void SetOrderData(Graphics g)
        {
            ...
            if (FormType == "Purchasetax")
            {
            g.DrawString("Date: "+DateStr, VerdanaBold, BlackBrush,  CurrentX, 500,Str);

            CurrentX = CurrentX - 20;

            g.DrawString(TimeStr, VerdanaBold, BlackBrush, CurrentX, 500, Str);

            CurrentX = CurrentX - 20;

            g.DrawString("PURCHASE TAX REPORT", VerdanaBoldHeadingMain, BlackBrush, CurrentX, 500, Str);
        }
            if (FormType == "Sales A4")
            {

                CurrentY = 80;
                g.DrawString("SALES REPORT", VerdanaBoldHeadingMain, BlackBrush, 300, CurrentY);
           ...
           // CurrentY = CurrentY + 20;
            ...
            {
                CurrentX = CurrentX - 20;
                g.DrawLine(new Pen(Brushes.Black, 1), CurrentX, 0, CurrentX, 1100);
                CurrentX = CurrentX - 18;

                g.DrawString("Date", LucidaTWO, BlackBrush, CurrentX,110, Str);
                g.DrawString("Vno", LucidaTWO, BlackBrush, CurrentX, 190, Str);

                g.DrawString("Invoice.No", LucidaTWO, BlackBrush, CurrentX, 300, Str);
                g.DrawString("Party", LucidaTWO, BlackBrush, CurrentX, 550, Str);
                g.DrawString("Vat", LucidaTWO, BlackBrush, CurrentX, 650, Str);

                g.DrawString("Tot.Tax", LucidaTWO, BlackBrush, CurrentX, 750, Str);
                g.DrawString("0%Taxable", LucidaTWO, BlackBrush, CurrentX, 850, Str);
                g.DrawString("14.5%Tax", LucidaTWO, BlackBrush, CurrentX, 950, Str);
                //g.DrawString("Tot.Tax", VerdanaBold, BlackBrush, CurrentX, 950, Str);
                //g.DrawString("0Taxable", VerdanaBold, BlackBrush, CurrentX, 1050, Str);

               // g.DrawString("Taxable", VerdanaBold, BlackBrush, CurrentX, 950, Str);
                g.DrawString("NetAmount", LucidaTWO, BlackBrush, CurrentX, 1100, Str);
        ...
        public void RowValidation(DataGridView gridmain)
        {
            try
            {
                if (FormType != "Purchasetax" && FormType != "Sales A4")
                {
                    ValidRecord = 0;
        ...
        {// Set Invoice Table:
           ...
           // CurrentY = CurrentY+10 ;
            ...
            if (InvSubTitle5 != "      ESTIMATE" && FormType != "Purchasetax" && FormType != "Sales A4")
            ...
            for (int i = TRowcounting; i <= MainGrid.Rows.Count - 1; i++)
            {
                ...
                if (_Dbtask.znllString(MainGrid.Rows[i].Cells["vno"].Value) != "")
                {
                    ...
                    e.Graphics.DrawString(FieldValue, VerdanaArabic, BlackBrush, 190, CurrentY);
                ...
                for (int i = TRowcounting; i <= MainGrid.Rows.Count - 1; i++)
                {
                    if (TempRowcounting < RecordsPerPage)
                    {
                        if (_Dbtask.znllString(MainGrid.Rows[i].Cells["clndate"].Value) != "")
                        {
                            ...
                            if (_Dbtask.znllString(MainGrid.Rows[i].Cells["clndate"].Tag) == "EXB")
                            {



                                e.Graphics.DrawString(FieldValue, Segoe, BlackBrush, CurrentX, 110, Str);
                            }

                            else
                            {
                                e.Graphics.DrawString(FieldValue, Lucida, BlackBrush, CurrentX, 70, Str);
                            }
                            FieldValue = _Dbtask.znllString(MainGrid.Rows[i].Cells["clnvno"].Value);

                            if (_Dbtask.znllString(MainGrid.Rows[i].Cells["clnvno"].Tag) == "EXB")
                            {

                                e.Graphics.DrawString(FieldValue, Segoe, BlackBrush, CurrentX,210, Str);
                            }
                            else
                            {
                                e.Graphics.DrawString(FieldValue, Lucida, BlackBrush, CurrentX, 210, Str);
                            }

                            FieldValue = _Dbtask.znllString(MainGrid.Rows[i].Cells["clnvnoT"].Value);
                            e.Graphics.DrawString(FieldValue, Lucida, BlackBrush, CurrentX,270, Str);



                            FieldValue = _Dbtask.znllString(MainGrid.Rows[i].Cells["clnparty"].Value);

                            if (_Dbtask.znllString(MainGrid.Rows[i].Cells["clnparty"].Tag) == "EXB")
                            {

                                e.Graphics.DrawString(FieldValue, Segoe, BlackBrush, CurrentX, 550, Str);
                            }
                            else
                            {
                                e.Graphics.DrawString(FieldValue, Declarationfont, BlackBrush, CurrentX, 550, Str);
                            }

                            FieldValue = _Dbtask.znllString(MainGrid.Rows[i].Cells["clntin"].Value);
                            e.Graphics.DrawString(FieldValue, Declarationfont, BlackBrush, CurrentX, 650, Str);




                            FieldValue = String.Format("{0:0.}", _Dbtask.gridnul(MainGrid.Rows[i].Cells["clnttax"].Value));//clnttax
                            e.Graphics.DrawString(FieldValue, VerdanaArabic, BlackBrush, CurrentX, 750, Str);
                            SUmqty = SUmqty + CommonClass._Dbtask.znlldoubletoobject(FieldValue);



                            //FieldValue = String.Format("{0:0.00}", _Dbtask.gridnul(MainGrid.Rows[i].Cells["cln14taxableamt"].Value));

                            FieldValue = String.Format("{0:0.00}", _Dbtask.gridnul(MainGrid.Rows[i].Cells["cln0taxableamt"].Value));
                            e.Graphics.DrawString(FieldValue, VerdanaArabic, BlackBrush, CurrentX, 850, Str);
                            SumSrate = SumSrate + CommonClass._Dbtask.znlldoubletoobject(FieldValue);


                            FieldValue = String.Format("{0:0.00}", _Dbtask.gridnul(MainGrid.Rows[i].Cells["cln14tax"].Value));
                            e.Graphics.DrawString(FieldValue, VerdanaArabic, BlackBrush, CurrentX, 950, Str);
                            Sumgrss = Sumgrss + CommonClass._Dbtask.znlldoubletoobject(FieldValue);


                            //FieldValue = String.Format("{0:0.00}", _Dbtask.gridnul(MainGrid.Rows[i].Cells["clnttaxable"].Value));
                            //e.Graphics.DrawString(FieldValue, VerdanaArabic, BlackBrush, CurrentX, 950, Str);
                            //SumSrate = SumSrate + CommonClass._Dbtask.znlldoubletoobject(FieldValue);
                            ...
                            FieldValue = String.Format("{0:0.00}", _Dbtask.gridnul(MainGrid.Rows[i].Cells["clnnetamt"].Value));
                            e.Graphics.DrawString(FieldValue, VerdanaArabic, BlackBrush, CurrentX, 1100, Str);
                            SUmNetAmt = SUmNetAmt + CommonClass._Dbtask.znlldoubletoobject(FieldValue);
           ...
           "Fifty", "Sixty", "Seventy", "Eighty", "Ninety" };
            ...
            public String ConvertAmount(double amount)
            {
                try
                {
                    ...
                    clsPurchasetaxHorizontal Frms = new clsPurchasetaxHorizontal();
        ...
        {// Set Invoice Total:
            ...
            if (FormType == "Sales")
            {
                ...
                g.DrawString(_Dbtask.SetintoDecimalpoint(SUmqty), VerdanaBold, BlackBrush,70, CurrentY);/*For Qty*///350
               
               g.DrawString(_Dbtask.SetintoDecimalpoint(SumSrate), VerdanaBold, BlackBrush, 150, CurrentY);/*For Taxable*/
