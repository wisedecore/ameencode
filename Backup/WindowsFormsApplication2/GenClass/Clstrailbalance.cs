...
namespace WindowsFormsApplication2
{
    class Clstrailbalance
    {
     ...
     //           g.DrawString(InvSubTitle3, Arialbold, BlackBrush, xInvSubTitle1-20, CurrentY);
            ...
            if (FormType == "trailbalance" && head == false)
            {
                CurrentY = 10;
            ...
            if (FormType == "trailbalance")
            {
                ...
                g.DrawString("Trailbalance", gothicfnt, BlackBrush, 300, CurrentY);
                CurrentY = CurrentY + 23;
        ...
        {// Set Invoice Table:
          ...
          //\ g.DrawString("SlNo", Verdananormal, BlackBrush, xSlno, CurrentY);
...

            {
                ...
                g.DrawString("Purticulars", VerdanaBold2, BlackBrush, 30, CurrentY);
                CurrentX = CurrentX + 80;
               
                g.DrawString("Credit", VerdanaBold2, BlackBrush, 350, CurrentY);
                CurrentX = CurrentX + 10;

                g.DrawString("Debit", VerdanaBold2, BlackBrush, 640, CurrentY);
                CurrentX = CurrentX + 10;
           ...
           //CurrentY = CurrentY + InvoiceFontHeight + 2;
            ...
            if (FormType == "trailbalance")
            {
                    ...
                    for (int i = TRowcounting; i <= MainGrid.Rows.Count - 1; i++)
                    {
                        ...
                        if (_dbtask.znllString(MainGrid.Rows[i].Cells["clnpurticulars"].Value) != "" )
                        {
                        ...
                        if (TempRowcounting < RecordsPerPage)
                        {
                            ...
                            //e.Graphics.DrawString(FieldValue, Verdananormalbld, BlackBrush, 400, CurrentY);
                            ...
                            SUMNETCR = SUMNETCR + _dbtask.znlldoubletoobject(FieldValue);
                            ...
                            e.Graphics.DrawString(FieldValue, Verdananormalbld, BlackBrush, 680, CurrentY,Str);
                            SUMNETDB = SUMNETDB + _dbtask.znlldoubletoobject(FieldValue);
            ...
            CurrentY = CurrentY + 20;
            e.Graphics.DrawString(SUMNETCR.ToString(), Verdananormalbld, BlackBrush, 350, CurrentY);
            e.Graphics.DrawString(SUMNETDB.ToString(), Verdananormalbld, BlackBrush, 680, CurrentY, Str);
            e.Graphics.DrawString("Total  ", Verdananormalbld, BlackBrush, 30, CurrentY);
            CurrentY = CurrentY + 8;
            
            g.DrawLine(new Pen(Brushes.Gray, 1), 0, CurrentY + 5, 870, CurrentY + 5);
            g.DrawLine(new Pen(Brushes.Gray, 1), 0, CurrentY + 13, 870, CurrentY + 13);
            //for (int i = TRowcounting; i < MainGrid.Rows.Count - 1; i++)
            //{
           ...
           "Fifty", "Sixty", "Seventy", "Eighty", "Ninety" };
            ...
            public String ConvertAmount(double amount)
            {
                try
                {
                    ...
                    Clstrailbalance Frms = new Clstrailbalance();
