    ...
    class ClsinvlaserFivePURCHS
    {
        ...
        private void SetInvoiceHead(Graphics g)
        {
           ...
           // StrTaxinvoiceHeader = "";
            ...
            {
                StrTaxinvoiceHeader = "Purchase Invoice";// "فاتورة ضريبية مبسطة" + "  " + "Simplified Tax Invoice";
            }
            ...
            g.DrawString(Billno, VerdanaBold, BlackBrush, 157, CurrentY);
            ...
            g.DrawLine(new Pen(Brushes.Black, 1), 10, CurrentY, 778, CurrentY);

            CurrentY = CurrentY + 2;//200
            g.DrawString(BillDate.ToString("dd/MM/yyyy") + "  Time:" + BillDate.ToString("hh:mm:ss"), VerdanaBold, BlackBrush, 150, CurrentY);
            //g.DrawString(cusmob, VerdanaBold, BlackBrush, 540, 172);//CName
            g.DrawString(CTin, VerdanaBold, BlackBrush, 540, CurrentY);
            g.DrawString("Date.", Verdananormal, BlackBrush, 10, CurrentY);
            g.DrawString("Supplier VAT", Verdananormal, BlackBrush, 381, CurrentY);


            CurrentY = CurrentY + 14;//214
            g.DrawString("تاريخ", Verdananormal, BlackBrush, 10, CurrentY);
            g.DrawString(_Gen.FuReturnArabic("Vat Cus"), Verdananormal, BlackBrush, 381, CurrentY);


            CurrentY = CurrentY + 26;//240
            g.DrawRectangle(selpen2, 10, CurrentY, 770, 40);

            CurrentY = CurrentY + 2;//242
            g.DrawString(CName, VerdanaBold, BlackBrush, 150, CurrentY);
            g.DrawString("Supplier " + _Gen.FuReturnArabic("Supplier") + " : ", Verdananormal, BlackBrush, 10, CurrentY);
            ...
            g.DrawRectangle(selpen, 10, CurrentY, 770, (630 - toplasr));
            g.DrawLine(new Pen(Brushes.Black, 1), 70, CurrentY, 70, CurrentY + (630 - toplasr));
            g.DrawLine(new Pen(Brushes.Black, 1), 400, CurrentY, 400, CurrentY + (630 - toplasr));
            g.DrawLine(new Pen(Brushes.Black, 1), 450, CurrentY, 450, CurrentY + (630 - toplasr));
            g.DrawLine(new Pen(Brushes.Black, 1), 500, CurrentY, 500, CurrentY + (630 - toplasr));
            g.DrawLine(new Pen(Brushes.Black, 1), 565, CurrentY, 565, CurrentY + (630 - toplasr));
            g.DrawLine(new Pen(Brushes.Black, 1), 630, CurrentY, 630, CurrentY + (630 - toplasr));
            //g.DrawLine(new Pen(Brushes.Gray, 1), 650, 290, 650, 725);
            g.DrawLine(new Pen(Brushes.Black, 1), 685, CurrentY, 685, CurrentY + (630 - toplasr));


            CurrentY = CurrentY + 10;//300
            g.DrawString("Slno", Verdananormal, BlackBrush, 10, CurrentY);
            g.DrawString("Itemname", Verdananormal, BlackBrush, 100, CurrentY);
           ...
           // g.DrawRectangle(selpen2, 380, 170, 380, 60);
            ...
            g.DrawString(_Gen.FuReturnArabic("Item Name"), Verdananormal, BlackBrush, 100, CurrentY);
           ...
           // if (System.IO.File.Exists(invimagefootr) && FormType != "ESTIMATE"&&HeaderinPrint==true)
            if (System.IO.File.Exists(invimagefootr) && FormType != "ESTIMATE" )
            {
                ...
                //g.DrawImage(oInvImage, 29, 1010, 718, 60);
            }
           ...
           "خمسون", "ستون", "سبعون", "ثمانون", "تسعين" };
            ...
            public String ConvertAmount(double amount)
            {
                try
                {
                    ...
                    ClsinvlaserFivePURCHS Frms = new ClsinvlaserFivePURCHS();
        ...
        public void PrintTotal(Graphics g)
        {
            ...
            if (InvSubTitle5 != "DELIVERY NOTE INVOICE")
            {
                ...
                g.DrawLine(new Pen(Brushes.Black, 1), 10, CurrentY, 755, CurrentY);
                ...
                g.DrawLine(new Pen(Brushes.Black, 1), 300, 835, 780, CurrentY);

                CurrentY = CurrentY + 10;//845
                g.DrawString("Tot.Amount(exclusive vat)   " + _Gen.FuReturnArabic("Excl Vat") + "", Verdananormal, BlackBrush, 305, CurrentY);
                if (isarbicdotprint == true)
                {
                ...
                g.DrawLine(new Pen(Brushes.Black, 1), 300, CurrentY, 780, CurrentY);

                CurrentY = CurrentY + 9;//885

                g.DrawString("Total vat 15%   " + _Gen.FuReturnArabic("Total Vat") + "", Verdananormal, BlackBrush, 305, CurrentY);
                if (isarbicdotprint == true)
                {
                    xTotalValue = 750 - (int)g.MeasureString(BillAmount, Arialbold).Width;
                    //g.DrawString(_Dbtask.SetintoDecimalpoint(TotalTaxable).ToString(), Arialboldbottm, BlackBrush, 750, CurrentY, Str);
                ...
                g.DrawLine(new Pen(Brushes.Black, 1), 300, CurrentY, 779, CurrentY);
                ...
                g.DrawRectangle(selpen2, 10, CurrentY, 774, 40);
