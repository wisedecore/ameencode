...
namespace WindowsFormsApplication2
{
    class ClsinvlaserNineNoTAX
    {
        ...
        private void SetInvoiceHead(Graphics g)
        {
            ...
            g.DrawRectangle(selpen, CurrentX, CurrentY, 770, 20);
            ...
            if (FormType == "     SALES")
            {
                StrTaxinvoiceHeader = "SALES INVOICE"; //StrTaxinvoiceHeader; //"فاتورة ضريبية مبسطة" + "  " + "Simplified Tax Invoice";
            }
...
//Simplified Tax Invoice  فاتورة ضریبیة المبسطة
            //if (FormType == "     SALES ORDER")
            //{
            ...
            //if (FormType == "     SALES RETURN")
            //{
            //    g.DrawString("(Saler Return-مرتجع فاتورة)", VerdanaBold, BlackBrush, (leftlase+550), CurrentY);//142
            //}
            ...
            g.DrawRectangle(selpen2, leftlase, CurrentY, 380, 60);
            ...
            g.DrawRectangle(selpen2, (leftlase + 380), CurrentY, 390, 60);//172
            g.DrawString(Billno, VerdanaBold, BlackBrush, (leftlase+157), CurrentY);
            g.DrawString(cusmob, VerdanaBold, BlackBrush,(leftlase+ 540), CurrentY);



            CurrentY = CurrentY + 10;//182
            g.DrawString("رقم الفاتورة", Verdananormal, BlackBrush, leftlase, CurrentY);//182
            g.DrawString(_Gen.FuReturnArabic("Mobile"), Verdananormal, BlackBrush, (leftlase+381), CurrentY);//182


            CurrentY = CurrentY + 16;//198
            g.DrawLine(new Pen(Brushes.Black, 1), leftlase, CurrentY, (leftlase+372), CurrentY);//198
            g.DrawLine(new Pen(Brushes.Black, 1), leftlase, CurrentY, (leftlase+772), CurrentY);
            g.DrawLine(new Pen(Brushes.Black, 1), (leftlase+380), CurrentY, (leftlase+766), CurrentY);
            ...
            g.DrawRectangle(selpen2, (leftlase), CurrentY, 770, 40);//240
            ...
            g.DrawLine(new Pen(Brushes.Black, 1), leftlase, CurrentY, (leftlase+772), CurrentY);//260
            ...
            //if (FormType == "     SALES ORDER")
            //{
            //    g.DrawString("(Saler Order)", VerdanaBold, BlackBrush, 480, 142);
            //}
            //if (FormType == "     SALES RETURN")
            //{
            //    g.DrawString("(Saler Return-مرتجع فاتورة)", VerdanaBold, BlackBrush, 550, 142);
            //}

            //g.DrawString(StrTaxinvoiceHeader, VerdanaBold, BlackBrush, 300, 142);
            ...
            //g.DrawString("Customer " + _Gen.FuReturnArabic("Cus Name") + " : ", Verdananormal, BlackBrush, 10, 242);
            //g.DrawString("Address " + _Gen.FuReturnArabic("Address"), Verdananormal, BlackBrush, 10, 265);


            CurrentY = CurrentY + 25;//290
            g.DrawRectangle(selpen, (leftlase), CurrentY, 770, (630 - toplasr));
            //codeline
            //g.DrawLine(new Pen(Brushes.Black, 1), (leftlase + itmcodecln), CurrentY, (leftlase + itmcodecln), CurrentY + (630 - toplasr));
            g.DrawLine(new Pen(Brushes.Black, 1), (leftlase + 70), CurrentY, (leftlase + 70), CurrentY + (630 - toplasr));


            g.DrawLine(new Pen(Brushes.Black, 1), (leftlase + 190+itmcodecln), CurrentY, (leftlase +190+ itmcodecln), CurrentY + (630 - toplasr));

           // g.DrawLine(new Pen(Brushes.Black, 1), (leftlase + 140), CurrentY, (leftlase + 140), CurrentY + (630 - toplasr));
            //g.DrawLine(new Pen(Brushes.Gray, 1), 400, 290, 400, 789);  itmcodecln
            //g.DrawLine(new Pen(Brushes.Gray, 1), 400, 290, 400, 789);

            //g.DrawLine(new Pen(Brushes.Black, 1), (leftlase + 450 ), CurrentY, (leftlase + 450 ), CurrentY + (630 - toplasr));
            ...
            g.DrawLine(new Pen(Brushes.Black, 1), (leftlase+660), CurrentY, (leftlase+660), CurrentY + (630 - toplasr));
            ...
            g.DrawString("Itemcode", Verdananormal, BlackBrush, (leftlase+70), CurrentY);
            g.DrawString("Itemname", Verdananormal, BlackBrush, (leftlase+190+itmcodecln), CurrentY);
           // leftlase + 140+itmcodecln), CurrentY, (leftlase +140+ itmcodecln
           // g.DrawString("Qty", Verdananormal, BlackBrush, (leftlase+461), CurrentY);
            g.DrawString("  Qty ", Verdananormal, BlackBrush, (leftlase + 503), CurrentY);
            g.DrawString("Unitprice", Verdananormal, BlackBrush, (leftlase+585), CurrentY);
            //g.DrawString("Tax15%", Verdananormal, BlackBrush, (leftlase+632), CurrentY);
            ...
            g.DrawString(_Gen.FuReturnArabic("Item Code"), Verdananormal, BlackBrush, (leftlase+70), CurrentY);

            g.DrawString(_Gen.FuReturnArabic("Item Name"), Verdananormal, BlackBrush, (leftlase + 190 + itmcodecln), CurrentY);


           // g.DrawString(_Gen.FuReturnArabic("Qty"), Verdananormal, BlackBrush,(leftlase+ 461), CurrentY);
            //g.DrawString("unit", Verdananormal, BlackBrush, 450, 300);
            //g.DrawString("وحدة", Verdananormal, BlackBrush, 450, 312);

            g.DrawString(_Gen.FuReturnArabic(" Qty   "), Verdananormal, BlackBrush, (leftlase + 503), CurrentY);

            g.DrawString(_Gen.FuReturnArabic("Unit Rate"), Verdananormal, BlackBrush, (leftlase+585), CurrentY);

            //g.DrawString(_Gen.FuReturnArabic("Tax 15%"), Verdananormal, BlackBrush, (leftlase+632), CurrentY);
            ...
            g.DrawLine(new Pen(Brushes.Gray, 1), (leftlase), CurrentY, (leftlase + 772), CurrentY);
                    ...
                    if (TempRowcounting < RecordsPerPage)
                    {
                        if (isarbicdotprint == true)
                        {
                            ...
                            if (Plangwise == 1 || Plangwise == 0)
                            {
                                ...
                                if (Plangwise == 0)
                                {
                                    ...
                                    if (FieldValue != "")
                                    {
                                        g.DrawString(FieldValue, Verdananormal, BlackBrush, (leftlase + 190 + itmcodecln), CurrentY);
                                    }
                                }
                                if (Plangwise == 1)
                                {
                                    ...
                                    if (FieldValue != "")
                                    {
                                        ...
                                        g.DrawString(FieldValue, Verdananormal, BlackBrush, (leftlase + 500), CurrentY + 10, Str);

                                        //g.DrawString(FieldValue, Verdananormal, BlackBrush, (leftlase + 420), CurrentY + 10, Str);
                                    }
                                }
                        ...
                        if (InvSubTitle5 != "DELIVERY NOTE INVOICE")
                        {
                            if (isarbicdotprint == true)
                            {
                                ...
                                // OLDg.DrawString(FieldValue, Verdananormal, BlackBrush,(leftlase+ 500), CurrentY, Str);
                                ...
                                //OLD g.DrawString(FieldValue, Verdananormal, BlackBrush, (leftlase+560), CurrentY, Str);
           ...
           "خمسون", "ستون", "سبعون", "ثمانون", "تسعين" };
            ...
            public String ConvertAmount(double amount)
            {
                try
                {
                    ...
                    ClsinvlaserNineNoTAX Frms = new ClsinvlaserNineNoTAX();
        ...
        public void PrintTotal(Graphics g)
        {
            ...
            if (InvSubTitle5 != "DELIVERY NOTE INVOICE")
            {
                ...
                g.DrawString("Total", VerdanaBold, BlackBrush, (leftlase+150), CurrentY);//770
                g.DrawString(TotalQty, Verdananormal, BlackBrush, (leftlase+492), CurrentY);//770
                //g.DrawString(_Dbtask.SetintoDecimalpoint(TotalTaxable), Verdananormal, BlackBrush, (leftlase+628), CurrentY, Str);//770

                //g.DrawString(_Dbtask.SetintoDecimalpoint(TotalTaxAmount), Verdananormal, BlackBrush, (leftlase+680), CurrentY, Str);//770

                g.DrawString(_Dbtask.SetintoDecimalpoint(TotalNetamount), Verdananormal, BlackBrush, (leftlase+755), CurrentY, Str);//770
                ...
                g.DrawRectangle(selpen, (leftlase), CurrentY, 160, 150);

                g.DrawLine(new Pen(Brushes.Black, 1), (leftlase), CurrentY, (leftlase+755), CurrentY);
                ...
                CurrentY = CurrentY + 5;
                g.DrawString("Authorised Signatory ", Verdananormal, BlackBrush, (leftlase+12), CurrentY);//805
              ...
              //g.DrawString("Discount   " + _Gen.FuReturnArabic("Discount") + "", Verdananormal, BlackBrush, 305, 815);
                ...
                //g.DrawLine(new Pen(Brushes.Black, 1), (leftlase+300), CurrentY, (leftlase+772), CurrentY);//762
                ...
                //g.DrawString(TotalQty, Verdananormal, BlackBrush, 471, 770);/*For Qty*///350
            ...
            if (FormType != "DELIVERY NOTE")
            {
                ...
                if (isarbicdotprint == true)
                {
                    ...
                    if (amtwrd == 1)
                    {
                        ...
                        CurrentY = CurrentY + 10;//985
                        g.DrawString(_Gen.FuReturnArabic("Amount in words"), Verdananormal, BlackBrush, (leftlase), CurrentY);
                    } 
                    ...
                    //g.DrawString(_Dbtask.SetintoDecimalpoint(GrandTotal), VerdanaBoldHeading, BlackBrush, 750, 921, Str);
                    //grandamtt = _Dbtask.SetintoDecimalpoint(GrandTotal).ToString();
