...
namespace WindowsFormsApplication2
{
    class ClsinvlasersevenPURCHS
    {
        ...
        private void SetInvoiceHead(Graphics g)
        {
            ...
            {
                StrTaxinvoiceHeader = "Purchase Order ";//, VerdanaBold, BlackBrush, 480, CurrentY);//142
            }
            if (FormType == "Purchase Return")
            {
                StrTaxinvoiceHeader = " Purchase Return ";//, VerdanaBold, BlackBrush, 550, CurrentY);//142
            }
            if (FormType == "Purchase")
            {
                StrTaxinvoiceHeader = "Purchase Invoice"; //StrTaxinvoiceHeader;// "فاتورة ضريبية مبسطة" + "  " + "Simplified Tax Invoice";
            }
            ...
            g.DrawString("Supplier VAT", Verdananormal, BlackBrush, ( leftlase+381), CurrentY);
           ...
           // g.DrawString(_Gen.FuReturnArabic("Mobile"), Verdananormal, BlackBrush, 381, 182);
            ...
            g.DrawString("Supplier " + _Gen.FuReturnArabic("Supplier") + " : ", Verdananormal, BlackBrush, leftlase, CurrentY);
                    ...
                    if (TempRowcounting <RecordsPerPage)
                    {
                            ...
                            if (Plangwise == 1 || Plangwise == 0)
                            {
                                ...
                                if (Plangwise == 1)
                                {
                                    ...
                                    if (FieldValue != "")
                                    {
                                        ...
                                        g.DrawString(FieldValue, Verdananormal, BlackBrush, (leftlase + 390), CurrentY + 10, Str);
                                    }
                                }
                        ...
                        if (InvSubTitle5 != "DELIVERY NOTE INVOICE")
                        {
                            if (isarbicdotprint == true)
                            {
                                ...
                                if (ratechange == true)
                                {
                                    realrate = CommonClass._Dbtask.znlldoubletoobject(MainGrid.Rows[i].Cells["Clnprate"].Value);
           ...
           "خمسون", "ستون", "سبعون", "ثمانون", "تسعين" };
            ...
            public String ConvertAmount(double amount)
            {
                try
                {
                    ...
                    ClsinvlasersevenPURCHS Frms = new ClsinvlasersevenPURCHS();
