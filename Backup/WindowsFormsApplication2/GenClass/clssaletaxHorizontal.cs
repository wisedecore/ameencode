    ...
    class clssaletaxHorizontal
    {
      ...
      int xRate; public string StrNaration = "";
        ...
        private void SetOrderData(Graphics g)
        {
            ...
            g.DrawString("SALES TAX REPORT", VerdanaBoldHeadingMain, BlackBrush, CurrentX, 500, Str);
        }
           ...
           // CurrentY = CurrentY + 20;
            ...
            if (FormType == "Salestax")
            {
                ...
                g.DrawString("Date", LucidaTWO, BlackBrush, CurrentX, 90, Str);
                g.DrawString("Vno", LucidaTWO, BlackBrush, CurrentX, 170, Str);
                g.DrawString("Party", LucidaTWO, BlackBrush, CurrentX, 400, Str);
                g.DrawString("Vat", LucidaTWO, BlackBrush, CurrentX, 550, Str);

                g.DrawString("Tot.Tax", LucidaTWO, BlackBrush, CurrentX, 650, Str);
                g.DrawString("0%Tax", LucidaTWO, BlackBrush, CurrentX, 750, Str);
                g.DrawString("15%Tax", LucidaTWO, BlackBrush, CurrentX, 850, Str);
                ...
                g.DrawString("Taxable", LucidaTWO, BlackBrush, CurrentX, 950, Str);
        ...
        public void RowValidation(DataGridView gridmain)
        {
            try
            {
                if (FormType != "Salestax" && FormType != "Sales A4")
                {
                    ValidRecord = 0;
        ...
        {// Set Invoice Table:
           ...
           // CurrentY = CurrentY+10 ;
            ...
            if (InvSubTitle5 != "      ESTIMATE" && FormType != "Salestax" && FormType != "Sales A4")
                ...
                for (int i = TRowcounting; i <= MainGrid.Rows.Count - 1; i++)
                {
                    if (TempRowcounting < RecordsPerPage)
                    {
                        if (_Dbtask.znllString(MainGrid.Rows[i].Cells["clndate"].Value) != "")
                        {
                            ...
                            e.Graphics.DrawString(FieldValue, Lucida, BlackBrush, CurrentX, 120, Str);
                            }
                            FieldValue = _Dbtask.znllString(MainGrid.Rows[i].Cells["clnvno"].Value);
                            e.Graphics.DrawString(FieldValue, Lucida, BlackBrush, CurrentX, 170, Str);
                            ...
                            {
                                e.Graphics.DrawString(FieldValue, Segoe, BlackBrush, CurrentX, 400, Str);
                            ...
                            else
                            {
                                ...
                                e.Graphics.DrawString(FieldValue, Declarationfont, BlackBrush, CurrentX, 400, Str);
                            }
                            ...
                            FieldValue = String.Format("{0:0.}", _Dbtask.gridnul(MainGrid.Rows[i].Cells["clnttax"].Value));
                            e.Graphics.DrawString(FieldValue, VerdanaArabic, BlackBrush, CurrentX, 650, Str);
                            SUmqty = SUmqty + CommonClass._Dbtask.znlldoubletoobject(FieldValue);
                            ...
                            FieldValue = String.Format("{0:0.00}", _Dbtask.gridnul(MainGrid.Rows[i].Cells["cln15taxableamt"].Value));
           ...
           "Fifty", "Sixty", "Seventy", "Eighty", "Ninety" };
            ...
            public String ConvertAmount(double amount)
            {
                try
                {
                    ...
                    clssaletaxHorizontal Frms = new clssaletaxHorizontal();
