      ...
      int xRate; public string StrNaration = "";
        ...
        private void SetInvoiceHead(Graphics g)
        {
            ...
            if (FormType == "Sales")
            {
                if (InvTitle != "")
                {
                    ...
                    g.DrawString(InvTitle, VerdanaBoldHeadingMain, BlackBrush, 40, CurrentY);
        ...
        private void SetOrderData(Graphics g)
        {
           ...
           CurrentY = CurrentY + 16;
            ...
            g.DrawString("SALES REPORT", VerdanaBoldHeadingMain, BlackBrush, 90, CurrentY);
        }
            if (FormType == "Sales A4")
            {
        ...
        public void RowValidation(DataGridView gridmain)
        {
            try
            {
                if (FormType != "Sales" && FormType != "Sales A4")
                {
                    ValidRecord = 0;
        ...
        {// Set Invoice Table:
           ...
           // CurrentY = CurrentY+10 ;
            ...
            if (InvSubTitle5 != "      ESTIMATE" && FormType != "Sales"   && FormType !="Sales A4")
            ...
            for (int i = TRowcounting; i < MainGrid.Rows.Count - 1; i++)
            {
                ...
                if (_Dbtask.znllString(MainGrid.Rows[i].Cells["vno"].Value) != "")
                {
                    ...
                    e.Graphics.DrawString(FieldValue, VerdanaArabic, BlackBrush, 168, CurrentY);
           ...
           "Fifty", "Sixty", "Seventy", "Eighty", "Ninety" };
            ...
            public String ConvertAmount(double amount)
            {
                try
                {
                    ...
                    ClsIsalesReportThermal Frms = new ClsIsalesReportThermal();
        ...
        {// Set Invoice Total:
            ...
            if (FormType == "Sales")
            {
                ...
                g.DrawString(_Dbtask.SetintoDecimalpoint(SUmqty), VerdanaBold, BlackBrush,90, CurrentY);/*For Qty*///350
