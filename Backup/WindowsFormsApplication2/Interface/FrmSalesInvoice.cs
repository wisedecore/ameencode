        ...
        public void twotypepayment()
       {
        ...
        public void getmaxvnonumber()
            ...
            CommonClass._GenF.checkmaxtableandparamval(CommonClass._Paramlist.GetParamvalue("MaxofSI"), vnoname);
                ...
                txtvno.Tag = CommonClass._Paramlist.GetParamvalue("MaxofSI");
                txtvno.Text = CommonClass._Paramlist.GetParamvalue("MaxofSI");
                _IssueDetails.IssueCodeLng = Convert.ToInt64(txtvno.Tag);
                _BusinessIssue.IssueCodeLng = Convert.ToInt64(txtvno.Tag);
                _Inventory.Vcode = txtvno.Tag.ToString();
            ...
            if (Vtype == "SI" && SalesAccount != "2")
            {
                ...
                CommonClass._GenF.checkmaxtableandparamval(CommonClass._Paramlist.GetParamvalue("MaxofSIwh"), vnoname);

                txtvno.Tag = CommonClass._Paramlist.GetParamvalue("MaxofSIwh");
                txtvno.Text = CommonClass._Paramlist.GetParamvalue("MaxofSIwh");
                _IssueDetails.IssueCodeLng = Convert.ToInt64(txtvno.Tag);
                _BusinessIssue.IssueCodeLng = Convert.ToInt64(txtvno.Tag);
                _Inventory.Vcode = txtvno.Tag.ToString();
            }
            if (Vtype == "SO")
            {
                ...
                CommonClass._GenF.checkmaxtableandparamval(CommonClass._Paramlist.GetParamvalue("MaxofSO"), vnoname);

                txtvno.Tag = CommonClass._Paramlist.GetParamvalue("MaxofSO");
                txtvno.Text = CommonClass._Paramlist.GetParamvalue("MaxofSO");
                _IssueDetails.IssueCodeLng = Convert.ToInt64(txtvno.Tag);
                _BusinessIssue.IssueCodeLng = Convert.ToInt64(txtvno.Tag);
                _Inventory.Vcode = txtvno.Tag.ToString();
            }
            if (Vtype == "SQ")
            {
                ...
                CommonClass._GenF.checkmaxtableandparamval(CommonClass._Paramlist.GetParamvalue("MaxofSQ"), vnoname);

                txtvno.Tag = CommonClass._Paramlist.GetParamvalue("MaxofSQ");
                txtvno.Text = CommonClass._Paramlist.GetParamvalue("MaxofSQ");
                _IssueDetails.IssueCodeLng = Convert.ToInt64(txtvno.Tag);
                _BusinessIssue.IssueCodeLng = Convert.ToInt64(txtvno.Tag);
                _Inventory.Vcode = txtvno.Tag.ToString();
            }
            ...
            if (Vtype == "SR")
            {
                ...
                CommonClass._GenF.checkmaxtableandparamval(CommonClass._Paramlist.GetParamvalue("MaxofSR"), vnoname);

                txtvno.Tag = CommonClass._Paramlist.GetParamvalue("MaxofSR");
                txtvno.Text = CommonClass._Paramlist.GetParamvalue("MaxofSR");
                _ReceiptDetails.RcptCodeLng = Convert.ToInt64(txtvno.Tag);
                _TransactionReceipt.RcptCodeLng = Convert.ToInt64(txtvno.Tag);
                _Batch.Recptcode = Convert.ToString(txtvno.Tag); ;
                _Inventory.Vcode = txtvno.Tag.ToString();
